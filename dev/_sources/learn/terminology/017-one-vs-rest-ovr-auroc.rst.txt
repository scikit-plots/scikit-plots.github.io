...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>One-vs-Rest (OvR) AUROC</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `One-vs-Rest (OvR) AUROC <https://insightful-data-lab.com/2025/08/30/one-vs-rest-ovr-auroc/>`__ (insightful-data-lab.com).
