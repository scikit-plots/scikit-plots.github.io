...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎁&nbsp;&nbsp;<b>Novelty (in Recommender Systems)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Novelty (in Recommender Systems) <https://insightful-data-lab.com/2025/08/19/novelty-in-recommender-systems/>`__ (insightful-data-lab.com).
