...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔗&nbsp;&nbsp;<b>Cumulative Incremental Gain (CIG)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Cumulative Incremental Gain (CIG) <https://insightful-data-lab.com/2025/08/23/cumulative-incremental-gain-cig/>`__ (insightful-data-lab.com).
