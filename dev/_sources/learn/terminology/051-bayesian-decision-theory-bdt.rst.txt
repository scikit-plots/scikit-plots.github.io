...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔁&nbsp;&nbsp;<b>Bayesian Decision Theory (BDT)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Bayesian Decision Theory (BDT) <https://insightful-data-lab.com/2025/08/29/bayesian-decision-theory-bdt/>`__ (insightful-data-lab.com).
