...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔍&nbsp;&nbsp;<b>LIME (Local Interpretable Model-agnostic Explanations)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `LIME (Local Interpretable Model-agnostic Explanations) <https://insightful-data-lab.com/2025/08/20/lime-local-interpretable-model-agnostic-explanations/>`__ (insightful-data-lab.com).
