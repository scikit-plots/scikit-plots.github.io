...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔎&nbsp;&nbsp;<b>Mean Average Precision (MAP)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Mean Average Precision (MAP) <https://insightful-data-lab.com/2025/08/19/mean-average-precision-map/>`__ (insightful-data-lab.com).
