...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💡&nbsp;&nbsp;<b>Target Variable</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Target Variable <https://insightful-data-lab.com/2025/08/22/target-variable/>`__ (insightful-data-lab.com).
