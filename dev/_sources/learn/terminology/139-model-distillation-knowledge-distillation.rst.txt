...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🏋️&nbsp;&nbsp;<b>Model Distillation (Knowledge Distillation)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Model Distillation (Knowledge Distillation) <https://insightful-data-lab.com/2025/08/24/model-distillation-knowledge-distillation/>`__ (insightful-data-lab.com).
