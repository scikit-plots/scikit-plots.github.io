...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧷&nbsp;&nbsp;<b>Time-based splits (a.k.a. Temporal Cross-Validation, Rolling Window Validation)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Time-based splits (a.k.a. Temporal Cross-Validation, Rolling Window Validation) <https://insightful-data-lab.com/2025/08/19/time-based-splits-a-k-a-temporal-cross-validation-rolling-window-validation/>`__ (insightful-data-lab.com).
