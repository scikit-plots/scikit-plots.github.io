...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>Chi-square (χ²) Test</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Chi-square (χ²) Test <https://insightful-data-lab.com/2025/08/20/chi-square-%cf%87%c2%b2-test/>`__ (insightful-data-lab.com).
