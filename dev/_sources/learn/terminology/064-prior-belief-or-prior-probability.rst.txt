...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔁&nbsp;&nbsp;<b>Prior Belief (or Prior Probability)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Prior Belief (or Prior Probability) <https://insightful-data-lab.com/2025/08/28/prior-belief-or-prior-probability/>`__ (insightful-data-lab.com).
