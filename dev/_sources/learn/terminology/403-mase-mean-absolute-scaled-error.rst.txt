...
:raw-html:`<div align="center" style="text-align:center;font-size:1.12rem;margin:0.45rem 0 0.2rem">🔬&nbsp;&nbsp;<b>MASE (Mean Absolute Scaled Error)</b></div>`
...
.. seealso::
   ...
   **Source article** Adapted (context, re-expressed) in our own words from: `MASE (Mean Absolute Scaled Error) <https://insightful-data-lab.com/2025/08/19/mase-mean-absolute-scaled-error/>`__ (insightful-data-lab.com).
