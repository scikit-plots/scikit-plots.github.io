...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Cardinality in Categorical Data</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Cardinality in Categorical Data <https://insightful-data-lab.com/2025/08/23/cardinality-in-categorical-data/>`__ (insightful-data-lab.com).
