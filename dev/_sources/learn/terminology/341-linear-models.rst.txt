...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💡&nbsp;&nbsp;<b>Linear Models</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Linear Models <https://insightful-data-lab.com/2025/08/20/linear-models/>`__ (insightful-data-lab.com).
