...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚙️&nbsp;&nbsp;<b>Inference Cost (Inference $)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Inference Cost (Inference $) <https://insightful-data-lab.com/2025/08/19/inference/>`__ (insightful-data-lab.com).
