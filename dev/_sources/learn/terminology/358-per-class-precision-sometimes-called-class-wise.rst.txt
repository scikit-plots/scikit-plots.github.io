...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Per-class Precision (sometimes called class-wise precision)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Per-class Precision (sometimes called class-wise precision) <https://insightful-data-lab.com/2025/08/20/per-class-precision-sometimes-called-class-wise-precision/>`__ (insightful-data-lab.com).
