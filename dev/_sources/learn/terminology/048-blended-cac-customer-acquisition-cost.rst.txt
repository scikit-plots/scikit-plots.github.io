...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💼&nbsp;&nbsp;<b>Blended CAC (Customer Acquisition Cost)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Blended CAC (Customer Acquisition Cost) <https://insightful-data-lab.com/2025/08/29/blended-cac-customer-acquisition-cost/>`__ (insightful-data-lab.com).
