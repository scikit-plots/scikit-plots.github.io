...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">💡&nbsp;&nbsp;<b>LLMs (Large Language Models)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `LLMs (Large Language Models) <https://insightful-data-lab.com/2025/08/24/llms-large-language-models/>`__ (insightful-data-lab.com).
