...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">📏&nbsp;&nbsp;<b>Single-label Classification</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Single-label Classification <https://insightful-data-lab.com/2025/08/30/single-label-classification/>`__ (insightful-data-lab.com).
