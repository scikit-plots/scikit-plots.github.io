...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🌊&nbsp;&nbsp;<b>Maximum Mean Discrepancy (MMD)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Maximum Mean Discrepancy (MMD) <https://insightful-data-lab.com/2025/08/23/maximum-mean-discrepancy-mmd/>`__ (insightful-data-lab.com).
