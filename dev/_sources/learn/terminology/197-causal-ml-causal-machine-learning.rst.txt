...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔗&nbsp;&nbsp;<b>Causal ML (Causal Machine Learning)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Causal ML (Causal Machine Learning) <https://insightful-data-lab.com/2025/08/23/causal-ml-causal-machine-learning/>`__ (insightful-data-lab.com).
