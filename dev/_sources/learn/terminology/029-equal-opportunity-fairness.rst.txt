...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">⚖️&nbsp;&nbsp;<b>Equal Opportunity (Fairness)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Equal Opportunity (Fairness) <https://insightful-data-lab.com/2025/08/29/equal-opportunity-fairness/>`__ (insightful-data-lab.com).
