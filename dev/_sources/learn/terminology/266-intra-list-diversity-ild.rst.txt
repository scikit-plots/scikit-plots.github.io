...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🎁&nbsp;&nbsp;<b>Intra-List Diversity (ILD)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Intra-List Diversity (ILD) <https://insightful-data-lab.com/2025/08/22/intra-list-diversity-ild/>`__ (insightful-data-lab.com).
