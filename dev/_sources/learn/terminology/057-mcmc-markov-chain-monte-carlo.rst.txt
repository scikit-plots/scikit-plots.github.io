...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔁&nbsp;&nbsp;<b>MCMC (Markov Chain Monte Carlo)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `MCMC (Markov Chain Monte Carlo) <https://insightful-data-lab.com/2025/08/28/mcmc-markov-chain-monte-carlo/>`__ (insightful-data-lab.com).
