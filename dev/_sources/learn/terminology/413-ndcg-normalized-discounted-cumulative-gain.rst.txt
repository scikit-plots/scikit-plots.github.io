...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔎&nbsp;&nbsp;<b>NDCG (Normalized Discounted Cumulative Gain)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `NDCG (Normalized Discounted Cumulative Gain) <https://insightful-data-lab.com/2025/08/19/ndcg-normalized-discounted-cumulative-gain/>`__ (insightful-data-lab.com).
