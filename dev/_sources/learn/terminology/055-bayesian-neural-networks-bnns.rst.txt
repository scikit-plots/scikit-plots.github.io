...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔁&nbsp;&nbsp;<b>Bayesian Neural Networks (BNNs)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Bayesian Neural Networks (BNNs) <https://insightful-data-lab.com/2025/08/29/bayesian-neural-networks-bnns/>`__ (insightful-data-lab.com).
