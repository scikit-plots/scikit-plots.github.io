...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🧮&nbsp;&nbsp;<b>Confidence Intervals (CIs)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Confidence Intervals (CIs) <https://insightful-data-lab.com/2025/08/19/confidence-intervals-cis/>`__ (insightful-data-lab.com).
