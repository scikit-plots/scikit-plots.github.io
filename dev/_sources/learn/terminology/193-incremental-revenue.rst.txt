...
.. hint::
   **Mind map — connected ideas**
   ...
   :doc:`Treatment Cost <192-treatment-cost>` · :doc:`ROI (Return on Investment) <191-roi-return-on-investment>` · :doc:`Conversion Rate Uplift <067-conversion-rate-uplift>` · :doc:`Treatment Effect <072-treatment-effect>` · :doc:`Causal Inference <117-causal-inference>` · :doc:`Revenue per User (RPU / ARPU) <122-revenue-per-user-rpu-arpu>`
