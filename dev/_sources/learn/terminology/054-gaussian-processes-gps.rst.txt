...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔁&nbsp;&nbsp;<b>Gaussian Processes (GPs)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Gaussian Processes (GPs) <https://insightful-data-lab.com/2025/08/29/gaussian-processes-gps/>`__ (insightful-data-lab.com).
