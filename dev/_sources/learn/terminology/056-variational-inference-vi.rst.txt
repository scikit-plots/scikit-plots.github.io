...
:raw-html:`<div align="center" style="font-size:1.12rem;margin:0.45rem 0 0.2rem">🔁&nbsp;&nbsp;<b>Variational Inference (VI)</b></div>`
...
.. seealso::
   ...
   Adapted in our own words from `Variational Inference (VI) <https://insightful-data-lab.com/2025/08/29/variational-inference-vi/>`__ (insightful-data-lab.com).
