...
:bdg-primary:`🎯 Data-Driven Decisions` :bdg-secondary:`🧭 Framing the Problem` :bdg-info:`Lesson 006`

◀ :doc:`Previous <005-the-relationship-between-data-and-decision-making>` · :doc:`Next <007-data-creates-value-only-when-it-is-communicated>` ▶ · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
