...
:bdg-primary:`💼 Job Search` :bdg-secondary:`🧭 Career Identity & Planning` :bdg-info:`Lesson 001`

:doc:`Next <002-career-identity-statement>` ▶ · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
...
.. seealso::
   ...
   **Source article** Adapted (context, re-expressed) in our own words from: `https://insightful-data-lab.com/2023/12/06/transferable-skills/ <https://insightful-data-lab.com/2023/12/06/transferable-skills/>`__ (insightful-data-lab.com).
