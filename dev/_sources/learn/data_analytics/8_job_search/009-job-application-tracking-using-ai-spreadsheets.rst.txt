...
:bdg-primary:`💼 Job Search` :bdg-secondary:`📄 Resume, Brand & Applications` :bdg-info:`Lesson 009`

◀ :doc:`Previous <008-choosing-the-right-job-platforms>` · :doc:`Next <010-networking-for-job-search>` ▶ · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
...
.. seealso::
   ...
   **Source article** Adapted (context, re-expressed) in our own words from: `https://insightful-data-lab.com/2023/12/06/job-application-tracking-using-ai-spreadsheets/ <https://insightful-data-lab.com/2023/12/06/job-application-tracking-using-ai-spreadsheets/>`__ (insightful-data-lab.com).
