...
:bdg-primary:`💼 Job Search` :bdg-secondary:`📄 Resume, Brand & Applications` :bdg-info:`Lesson 008`

◀ :doc:`Previous <007-building-a-professional-online-presence-personal-brand>` · :doc:`Next <009-job-application-tracking-using-ai-spreadsheets>` ▶ · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
...
.. seealso::
   ...
   **Source article** Adapted (context, re-expressed) in our own words from: `https://insightful-data-lab.com/2023/12/06/choosing-the-right-job-platforms/ <https://insightful-data-lab.com/2023/12/06/choosing-the-right-job-platforms/>`__ (insightful-data-lab.com).

.. tags:: purpose: reference, topic: data analytics, topic: jobsearch, topic: apply
