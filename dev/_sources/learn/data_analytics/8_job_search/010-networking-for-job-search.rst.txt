...
:bdg-primary:`💼 Job Search` :bdg-secondary:`📄 Resume, Brand & Applications` :bdg-info:`Lesson 010`

◀ :doc:`Previous <009-job-application-tracking-using-ai-spreadsheets>` · :doc:`Next <011-interview-preparation>` ▶ · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
...
.. seealso::
   ...
   **Source article** Adapted (context, re-expressed) in our own words from: `https://insightful-data-lab.com/2023/12/06/networking-for-job-search/ <https://insightful-data-lab.com/2023/12/06/networking-for-job-search/>`__ (insightful-data-lab.com).
