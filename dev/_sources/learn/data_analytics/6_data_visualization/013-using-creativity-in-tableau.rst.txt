...
:bdg-primary:`🎨 Data Visualization` :bdg-secondary:`📊 Tableau` :bdg-info:`Lesson 013`

◀ :doc:`Previous <012-effective-vs-ineffective-data-visualizations-in-tableau>` · :doc:`Next <014-linking-multiple-datasets-in-tableau-public>` ▶ · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
...
.. seealso::
   ...
   **Source article** Adapted (context, re-expressed) in our own words from: `https://insightful-data-lab.com/2023/11/26/using-creativity-in-tableau/ <https://insightful-data-lab.com/2023/11/26/using-creativity-in-tableau/>`__ (insightful-data-lab.com).
