...
:bdg-primary:`🧽 Data Cleaning & Preparation` :bdg-secondary:`✅ Verification, Documentation & Next Steps` :bdg-info:`Lesson 032`

◀ :doc:`Previous <031-refining-a-resume-for-data-analytics-roles>` · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
...
.. hint::
   ...
   - :doc:`Choosing the Right Job Platforms <../8_job_search/008-choosing-the-right-job-platforms>`
   - :doc:`Refining a Resume for Data Analytics Roles <031-refining-a-resume-for-data-analytics-roles>`
   - :doc:`Networking for Job Search <../8_job_search/010-networking-for-job-search>`
