...
:bdg-primary:`🧽 Data Cleaning & Preparation` :bdg-secondary:`✅ Verification, Documentation & Next Steps` :bdg-info:`Lesson 031`

◀ :doc:`Previous <030-using-feedback-from-data-cleaning-to-improve-data-quality>` · :doc:`Next <032-exploring-data-analyst-job-opportunities>` ▶ · :doc:`↑ Section <index>` · :doc:`↑ Hub <../index>`
...
.. hint::
   ...
   - :doc:`Tailoring Your Resume <../8_job_search/005-tailoring-your-resume>`
   - :doc:`Using AI to Improve and Tailor Your Resume <../8_job_search/006-using-ai-to-improve-and-tailor-your-resume>`
   - :doc:`Key Factors to Consider When Choosing a Data Analytics Role <../1_foundations/027-key-factors-to-consider-when-choosing-a-data-analytics-role>`
