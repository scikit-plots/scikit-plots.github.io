...
.. "auto_examples/metrics/plot_classifier_eval_script.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_metrics_plot_classifier_eval_script.py>`
        to download the full example code. or to run this example in your browser via JupyterLite or Binder

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_metrics_plot_classifier_eval_script.py:
...
.. image-sg:: /auto_examples/metrics/images/sphx_glr_plot_classifier_eval_script_001.png
   :alt: plot classifier eval script
   :srcset: /auto_examples/metrics/images/sphx_glr_plot_classifier_eval_script_001.png
...
.. _sphx_glr_download_auto_examples_metrics_plot_classifier_eval_script.py:
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: binder-badge
      ...
      .. image:: images/binder_badge_logo.svg
        :target: https://mybinder.org/v2/gh/scikit-plots/scikit-plots/0.3.X?urlpath=lab/tree/notebooks/auto_examples/metrics/plot_classifier_eval_script.ipynb
        :alt: Launch binder
        :width: 150 px
    ...
    .. container:: lite-badge
      ...
      .. image:: images/jupyterlite_badge_logo.svg
        :target: ../../lite/lab/index.html?path=auto_examples/metrics/plot_classifier_eval_script.ipynb
