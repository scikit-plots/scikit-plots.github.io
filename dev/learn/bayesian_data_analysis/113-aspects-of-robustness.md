# Aspects of robustness[#](#aspects-of-robustness "Link to this heading")
...
## Why the normal is fragile[#](#why-the-normal-is-fragile "Link to this heading")

The normal distribution has ****light tails****: its density falls off like \(e^{-x^2/2}\), so a value
...
## The Bayesian view of robustness[#](#the-bayesian-view-of-robustness "Link to this heading")
...
## The general principle[#](#the-general-principle "Link to this heading")
...
## One caution[#](#one-caution "Link to this heading")
