# The Place of Model Checking in Applied Bayesian Statistics[#](#the-place-of-model-checking-in-applied-bayesian-statistics "Link to this heading")
...
## Bayes’ rule cannot check itself[#](#bayes-rule-cannot-check-itself "Link to this heading")
...
## Three questions[#](#three-questions "Link to this heading")
...
## A model is a hypothesis, not a truth[#](#a-model-is-a-hypothesis-not-a-truth "Link to this heading")
...
## Not hypothesis testing[#](#not-hypothesis-testing "Link to this heading")
