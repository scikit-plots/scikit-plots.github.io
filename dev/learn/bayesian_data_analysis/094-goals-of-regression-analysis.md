# Goals of regression analysis[#](#goals-of-regression-analysis "Link to this heading")
...
## Prediction[#](#prediction "Link to this heading")

You want \(p(\tilde{y} \mid \tilde{x}, y)\) to be accurate for new cases. Nothing else matters:
...
## Description and explanation[#](#description-and-explanation "Link to this heading")
...
## Choices that depend on the goal[#](#choices-that-depend-on-the-goal "Link to this heading")
