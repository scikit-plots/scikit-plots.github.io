# Frequency Evaluations of Bayesian Inferences[#](#frequency-evaluations-of-bayesian-inferences "Link to this heading")
...
average error than an unbiased estimator, particularly in the many-parameter, small-\(n\) settings
(the cancer-rate map) where classical methods flounder.

## Simulate to check[#](#simulate-to-check "Link to this heading")
...
## Bias, variance, and honesty[#](#bias-variance-and-honesty "Link to this heading")
