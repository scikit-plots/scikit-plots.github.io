# Debugging Bayesian computing[#](#debugging-bayesian-computing "Link to this heading")
...
## Fake-data simulation[#](#fake-data-simulation "Link to this heading")
...
## Read the diagnostics, always[#](#read-the-diagnostics-always "Link to this heading")

Then check what the sampler is telling you. \(\hat{R}\) near 1.00 (chains agree), adequate
...
## The folk theorem[#](#the-folk-theorem "Link to this heading")
