# Bayesian Data Analysis — course guide[#](#bayesian-data-analysis-course-guide "Link to this heading")
...
## Curriculum: 5 parts, 16 stages, 144 lessons[#](#curriculum-5-parts-16-stages-144-lessons "Link to this heading")
...
### Each lesson page[#](#each-lesson-page "Link to this heading")
...
### Anchors and the `bda-` prefix[#](#anchors-and-the-bda-prefix "Link to this heading")
...
## The v2 filterable browser (`index.rst`)[#](#the-v2-filterable-browser-index-rst "Link to this heading")
...
## Legacy anchor compatibility (`COMPAT_ANCHORS`)[#](#legacy-anchor-compatibility-compat-anchors "Link to this heading")
...
## Landmines (exact titles — copy verbatim, never retype)[#](#landmines-exact-titles-copy-verbatim-never-retype "Link to this heading")
...
### Ligatures[#](#ligatures "Link to this heading")
...
### Other special characters[#](#other-special-characters "Link to this heading")
...
### Preserved source typo[#](#preserved-source-typo "Link to this heading")
...
### Disambiguated duplicate[#](#disambiguated-duplicate "Link to this heading")
...
## RST & validation conventions[#](#rst-validation-conventions "Link to this heading")
...
### Validator report[#](#validator-report "Link to this heading")
...
## Rebuilding[#](#rebuilding "Link to this heading")
...
### Environment notes[#](#environment-notes "Link to this heading")
