# Models for multivariate and multinomial responses[#](#models-for-multivariate-and-multinomial-responses "Link to this heading")
...
## Multinomial and categorical[#](#multinomial-and-categorical "Link to this heading")

For an ****unordered**** categorical outcome — choice of transport, party, product — the multinomial
(softmax) logit gives each category \(k\) its own linear predictor and normalises:

\[\Pr(y\_i = k) = \frac{e^{X\_i \beta\_k}}{\sum\_{k'} e^{X\_i \beta\_{k'}}},\]
...
## Multivariate responses[#](#multivariate-responses "Link to this heading")
...
\[y\_i \sim \mathrm{N}(X\_i B, \; \Sigma), \qquad
...
## Why model the joint structure[#](#why-model-the-joint-structure "Link to this heading")
