# Do the Inferences from the Model Make Sense?[#](#do-the-inferences-from-the-model-make-sense "Link to this heading")
...
Before any simulation, before any \(p\)-value, look at the answer and ask whether it is ****possible****.
...
* ****Physical constraints.**** Probabilities in \([0,1]\), variances positive, rates non-negative,
...
## External validation[#](#external-validation "Link to this heading")
...
## Being wrong usefully[#](#being-wrong-usefully "Link to this heading")
