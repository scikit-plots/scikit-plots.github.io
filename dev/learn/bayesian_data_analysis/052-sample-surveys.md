# Sample surveys[#](#sample-surveys "Link to this heading")

****Part 2 · Stage 7 · 🗳️ Data Collection & Decisions**** · Lesson 052 of 144 · **intermediate**

[◀ Previous · Data-collection models and ignorability](051-data-collection-models-and-ignorability.html) · [Next · Designed experiments ▶](053-designed-experiments.html)

## Inference for a finite population[#](#inference-for-a-finite-population "Link to this heading")

Survey inference has an unusual target. You do not want a parameter of an infinite superpopulation; you
want a ****finite-population quantity**** — the mean income of **these** \(N\) households, of whom you
sampled \(n\). The Bayesian formulation is disarmingly direct: the unsampled values
\(y\_{\text{mis}}\) are simply ****unknowns****, and the population mean is a function of them.

\[\bar{Y} = \frac{1}{N}\left( \sum\_{i \in \text{sample}} y\_i
+ \sum\_{i \notin \text{sample}} y\_i \right).\]

Draw \(y\_{\text{mis}}\) from its posterior predictive distribution, compute \(\bar{Y}\) for each
draw, and you have the posterior for the population mean — uncertainty about the unsampled units
included, and the \(n/N\) finite-population correction appearing automatically rather than being
bolted on.

## Designs, and what they demand[#](#designs-and-what-they-demand "Link to this heading")
...
rare populations. Under each, \(I\) depends on design variables — and by the ignorability lesson the
...
## Multilevel regression and poststratification[#](#multilevel-regression-and-poststratification "Link to this heading")
...
## The limits[#](#the-limits "Link to this heading")
...
> **See also**
> ****Related lessons:**** [Data-collection models and ignorability](051-data-collection-models-and-ignorability.html) · [Designed experiments](053-designed-experiments.html) · [State-level opinons from national polls](110-state-level-opinons-from-national-polls.html) · [Exchangeability and hierarchical models](034-exchangeability-and-hierarchical-models.html)

****Source**** (context, re-expressed in our own words): <https://insightful-data-lab.com/2025/11/11/sample-surveys/>
