# Supervised Learning and Neural Networks[#](#supervised-learning-and-neural-networks "Link to this heading")
...
labelled examples — inputs \(x\) paired with correct outputs \(y\) — and you learn the
****function that maps**** \(x \to y\). House features → price, an ad and a user → click-or-not, an
image → the object it contains: each is the same problem, **learn** \(x \to y\) **from examples**.

## Matching the architecture[#](#matching-the-architecture "Link to this heading")
...
## Structured vs unstructured[#](#structured-vs-unstructured "Link to this heading")
