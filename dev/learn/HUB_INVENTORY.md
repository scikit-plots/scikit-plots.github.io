# Hub inventory — one tracker for the whole `learn/` hub[#](#hub-inventory-one-tracker-for-the-whole-learn-hub "Link to this heading")
...
## Where it sits — a tracker, not a generator[#](#where-it-sits-a-tracker-not-a-generator "Link to this heading")
...
## The two halves of `hub_inventory.json`[#](#the-two-halves-of-hub-inventory-json "Link to this heading")
...
### Course kinds[#](#course-kinds "Link to this heading")
...
A `sectioned` section maps to a tsv `section` key and/or a `dir`. `"whole_course": true` means the section **is** the whole flat course (used for Deep Learning
...
## Guarantees[#](#guarantees "Link to this heading")
...
## Adding a new course[#](#adding-a-new-course "Link to this heading")
