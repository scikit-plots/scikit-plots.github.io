...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: [Mann–Whitney U Test (also called the Wilcoxon rank-sum test)](https://insightful-data-lab.com/2025/08/30/mann-whitney-u-test-also-called-the-wilcoxon-rank-sum-test/) (insightful-data-lab.com).
