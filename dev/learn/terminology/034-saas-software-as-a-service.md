...
# SaaS (Software as a Service)[#](#saas-software-as-a-service "Link to this heading")
...
## Why the model is attractive[#](#why-the-model-is-attractive "Link to this heading")
...
## The metrics that define a SaaS business[#](#the-metrics-that-define-a-saas-business "Link to this heading")
...
[LTV:CAC Ratio](037-ltv-cac-ratio.html) · [Churn](123-churn.html) · [Retention](124-retention.html) · [Gross Margin](043-gross-margin.html) · [Valuation Metric](035-valuation-metric.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: [SaaS (Software as a Service)](https://insightful-data-lab.com/2025/08/29/saas-software-as-a-service/) (insightful-data-lab.com).
