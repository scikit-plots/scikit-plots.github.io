# reStructuredText Cheat Sheet[#](#restructuredtext-cheat-sheet "Link to this heading")

Info:
:   A practical, copy/paste-friendly reStructuredText (reST) cheat sheet.

Sources:
:   John-CD cheatsheet + Docutils quickref/cheatsheet (see links below).
...
## [reST short overview](#id3)[#](#rest-short-overview "Link to this heading")

### [Formatting conventions](#id4)[#](#formatting-conventions "Link to this heading")
...
### [Paragraphs](#id5)[#](#paragraphs "Link to this heading")

Paragraphs are chunks of text separated by one or more blank lines.

### [Section headers](#id6)[#](#section-headers "Link to this heading")
...
### [Inline text styles](#id7)[#](#inline-text-styles "Link to this heading")
...
### [Lists](#id8)[#](#lists "Link to this heading")
...
## [Source code blocks](#id9)[#](#source-code-blocks "Link to this heading")

### [Literal blocks via double colon](#id10)[#](#literal-blocks-via-double-colon "Link to this heading")
...
### [Sphinx-friendly code blocks](#id11)[#](#sphinx-friendly-code-blocks "Link to this heading")
...
## [Links](#id12)[#](#links "Link to this heading")
...
See [reStructuredText](https://docutils.sourceforge.io/rst.html).

Anonymous reference:

[anonymous reference](https://docutils.sourceforge.io/docs/ref/rst/restructuredtext.html)

## [Definitions](#id13)[#](#definitions "Link to this heading")
...
## [Footnotes and citations](#id14)[#](#footnotes-and-citations "Link to this heading")
...
## [Use of reST in Python docstrings](#id15)[#](#use-of-rest-in-python-docstrings "Link to this heading")
...
* Link to other objects with roles like `mymethod`, `myfunc`,
  `myclass`, and `mymodule`.

## [Explicit markup](#id16)[#](#explicit-markup "Link to this heading")
...
## [Inline markup roles](#id17)[#](#inline-markup-roles "Link to this heading")
...
### [Object roles (common)](#id18)[#](#object-roles-common "Link to this heading")
...
## [Official Docutils cheat sheet (excerpt)](#id19)[#](#official-docutils-cheat-sheet-excerpt "Link to this heading")
