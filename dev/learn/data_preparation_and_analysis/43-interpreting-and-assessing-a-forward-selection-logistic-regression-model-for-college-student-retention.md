# Interpreting and Assessing a Forward-Selection Logistic Regression Model for College Student Retention[#](#interpreting-and-assessing-a-forward-selection-logistic-regression-model-for-college-student-retention "Link to this heading")
...
## Reading the odds ratios[#](#reading-the-odds-ratios "Link to this heading")

Interpretation runs through ****odds ratios****, the \(e^{\beta}\) from the logistic lessons. A
...
## Does it fit?[#](#does-it-fit "Link to this heading")

Finally, ****assess**** the fitted model. ****McFadden’s pseudo-****\(R^2\) and the overall
