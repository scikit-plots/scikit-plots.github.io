# Binary Classification Model Evaluation and Threshold Optimization[#](#binary-classification-model-evaluation-and-threshold-optimization "Link to this heading")
...
logistic model’s \(p\). The label comes from a ****threshold****: predict positive when the score
...
## Turning the dial[#](#turning-the-dial "Link to this heading")
...
## Cost decides[#](#cost-decides "Link to this heading")
...
## Choosing it in practice[#](#choosing-it-in-practice "Link to this heading")
