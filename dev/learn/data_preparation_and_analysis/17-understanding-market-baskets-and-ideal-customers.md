# Understanding Market Baskets and Ideal Customers[#](#understanding-market-baskets-and-ideal-customers "Link to this heading")

****Stage 3 · 🛒 Market Basket & Association Rules**** · Lesson 17 of 56 · **intermediate**

[◀ Previous · Eta Squared (η²): Effect Size in ANOVA](16-eta-squared-2-effect-size-in-anova.html) · [Next · What Can Association Rules Tell Us? ▶](18-what-can-association-rules-tell-us.html) · [↑ Section](index.html)
...
## Why baskets matter[#](#why-baskets-matter "Link to this heading")
...
## The ideal customer[#](#the-ideal-customer "Link to this heading")
...
## From baskets to rules[#](#from-baskets-to-rules "Link to this heading")
...
> **Hint**
> ****Related lessons:**** [What Can Association Rules Tell Us?](18-what-can-association-rules-tell-us.html) · [How Association Rules Are Discovered: Concepts, Scale, Measures, and the Apriori Approach](19-how-association-rules-are-discovered-concepts-scale-measures-and-the-apriori-approach.html) · [Cross-Selling](22-cross-selling.html) · [Creating Segments of Observations for Business Reasons (RFM)](30-creating-segments-of-observations-for-business-reasons-rfm.html)
> **See also**
