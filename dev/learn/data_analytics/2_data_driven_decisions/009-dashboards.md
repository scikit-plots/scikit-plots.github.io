# Dashboards[#](#dashboards "Link to this heading")

🎯 Data-Driven Decisions 📐 Metrics & Dashboards Lesson 009

◀ [Previous](008-the-difference-between-data-and-metrics-and-the-role-of-metrics.html) · [Next](010-mathematical-thinking.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Metrics, made ambient[#](#metrics-made-ambient "Link to this heading")
...
## What a dashboard is for[#](#what-a-dashboard-is-for "Link to this heading")
...
## Dashboard or report?[#](#dashboard-or-report "Link to this heading")
...
## Designing one that earns its screen[#](#designing-one-that-earns-its-screen "Link to this heading")
...
* [Data Dashboards: Organizing Insight for Real-Time Decision Making](../6_data_visualization/017-data-dashboards-organizing-insight-for-real-time-decision-making.html)
* [The Role and Importance of Data Visualization](../1_foundations/023-the-role-and-importance-of-data-visualization.html)
* [Mathematical Thinking](010-mathematical-thinking.html)
> **See also**
