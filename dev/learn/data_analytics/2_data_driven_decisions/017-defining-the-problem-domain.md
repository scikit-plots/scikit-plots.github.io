# Defining the Problem Domain[#](#defining-the-problem-domain "Link to this heading")

🎯 Data-Driven Decisions 🗣 Stakeholders, Communication & Execution Lesson 017

◀ [Previous](016-spreadsheet-functions.html) · [Next](018-context-and-bias-in-data-analysis.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Scope before analysis[#](#scope-before-analysis "Link to this heading")
...
## What a scope defines[#](#what-a-scope-defines "Link to this heading")
...
## Why scoping prevents the expensive failures[#](#why-scoping-prevents-the-expensive-failures "Link to this heading")
...
## The timeline reality check[#](#the-timeline-reality-check "Link to this heading")
