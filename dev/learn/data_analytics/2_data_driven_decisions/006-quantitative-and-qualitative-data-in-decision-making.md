# Quantitative and Qualitative Data in Decision-Making[#](#quantitative-and-qualitative-data-in-decision-making "Link to this heading")

🎯 Data-Driven Decisions 🧭 Framing the Problem Lesson 006

◀ [Previous](005-the-relationship-between-data-and-decision-making.html) · [Next](007-data-creates-value-only-when-it-is-communicated.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Two kinds of evidence[#](#two-kinds-of-evidence "Link to this heading")
...
## Why each needs the other[#](#why-each-needs-the-other "Link to this heading")
...
## A worked pairing[#](#a-worked-pairing "Link to this heading")
...
## Collecting them[#](#collecting-them "Link to this heading")
