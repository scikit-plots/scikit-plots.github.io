# Staying Focused on the Project Objective[#](#staying-focused-on-the-project-objective "Link to this heading")

🎯 Data-Driven Decisions 🗣 Stakeholders, Communication & Execution Lesson 020

◀ [Previous](019-stakeholder-expectations-in-data-analysis.html) · [Next](021-clear-communication-with-stakeholders-and-teams.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The objective is the compass[#](#the-objective-is-the-compass "Link to this heading")
...
## How projects lose focus[#](#how-projects-lose-focus "Link to this heading")
...
## The discipline of focus[#](#the-discipline-of-focus "Link to this heading")
...
## Focus versus discovery[#](#focus-versus-discovery "Link to this heading")
...
* [Stakeholder Expectations in Data Analysis](019-stakeholder-expectations-in-data-analysis.html)
...
* [Balancing Speed and Accuracy in Data Analysis](024-balancing-speed-and-accuracy-in-data-analysis.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/08/31/staying-focused-on-the-project-objective/> (insightful-data-lab.com).
