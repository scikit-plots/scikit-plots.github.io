# Adapting to Communication Expectations at Work[#](#adapting-to-communication-expectations-at-work "Link to this heading")

🎯 Data-Driven Decisions 🗣 Stakeholders, Communication & Execution Lesson 022

◀ [Previous](021-clear-communication-with-stakeholders-and-teams.html) · [Next](023-managing-stakeholder-expectations-and-project-constraints.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## One message, many audiences[#](#one-message-many-audiences "Link to this heading")
...
## The dimensions to adapt[#](#the-dimensions-to-adapt "Link to this heading")
...
## Reading expectations[#](#reading-expectations "Link to this heading")
...
## Adapting is not diluting[#](#adapting-is-not-diluting "Link to this heading")
...
* [Sharing Data to Drive Impact](025-sharing-data-to-drive-impact.html)
* [Effective Meetings](026-effective-meetings.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/08/31/adapting-to-communication-expectations-at-work/> (insightful-data-lab.com).
