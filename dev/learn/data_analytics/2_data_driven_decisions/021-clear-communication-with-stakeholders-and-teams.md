# Clear Communication with Stakeholders and Teams[#](#clear-communication-with-stakeholders-and-teams "Link to this heading")

🎯 Data-Driven Decisions 🗣 Stakeholders, Communication & Execution Lesson 021

◀ [Previous](020-staying-focused-on-the-project-objective.html) · [Next](022-adapting-to-communication-expectations-at-work.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Clarity is a skill, not a gift[#](#clarity-is-a-skill-not-a-gift "Link to this heading")
...
## Five properties of clear communication[#](#five-properties-of-clear-communication "Link to this heading")
...
## Translating for the audience[#](#translating-for-the-audience "Link to this heading")
...
## Communication runs both ways[#](#communication-runs-both-ways "Link to this heading")
...
* [Adapting to Communication Expectations at Work](022-adapting-to-communication-expectations-at-work.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/08/31/clear-communication-with-stakeholders-and-teams/> (insightful-data-lab.com).
