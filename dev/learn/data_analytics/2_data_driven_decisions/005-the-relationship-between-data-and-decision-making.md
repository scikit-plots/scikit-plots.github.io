# The Relationship Between Data and Decision-Making[#](#the-relationship-between-data-and-decision-making "Link to this heading")

🎯 Data-Driven Decisions 🧭 Framing the Problem Lesson 005

◀ [Previous](004-why-asking-the-right-questions-matters-in-data-analytics.html) · [Next](006-quantitative-and-qualitative-data-in-decision-making.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Two ways evidence enters a decision[#](#two-ways-evidence-enters-a-decision "Link to this heading")
...
## Where each belongs[#](#where-each-belongs "Link to this heading")
...
## The joints where it fails[#](#the-joints-where-it-fails "Link to this heading")
...
## Judgement stays in the loop[#](#judgement-stays-in-the-loop "Link to this heading")
...
* [Quantitative and Qualitative Data in Decision-Making](006-quantitative-and-qualitative-data-in-decision-making.html)
...
* [Using Data Analysis to Choose the Right Advertising Strategy](001-using-data-analysis-to-choose-the-right-advertising-strategy.html)
> **See also**
