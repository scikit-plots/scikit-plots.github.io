# Conflict Resolution in the Workplace[#](#conflict-resolution-in-the-workplace "Link to this heading")

🎯 Data-Driven Decisions 🗣 Stakeholders, Communication & Execution Lesson 027

◀ [Previous](026-effective-meetings.html) · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## When data meets disagreement[#](#when-data-meets-disagreement "Link to this heading")
...
## Where analytical conflict comes from[#](#where-analytical-conflict-comes-from "Link to this heading")
...
## Resolving productively[#](#resolving-productively "Link to this heading")
...
## The analyst’s particular obligation[#](#the-analyst-s-particular-obligation "Link to this heading")
...
## The caveat and the close[#](#the-caveat-and-the-close "Link to this heading")
...
* [Context and Bias in Data Analysis](018-context-and-bias-in-data-analysis.html)
* [Clear Communication with Stakeholders and Teams](021-clear-communication-with-stakeholders-and-teams.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/08/31/conflict-resolution-in-the-workplace/> (insightful-data-lab.com).
