# Data Creates Value Only When It Is Communicated[#](#data-creates-value-only-when-it-is-communicated "Link to this heading")

🎯 Data-Driven Decisions 🧭 Framing the Problem Lesson 007

◀ [Previous](006-quantitative-and-qualitative-data-in-decision-making.html) · [Next](008-the-difference-between-data-and-metrics-and-the-role-of-metrics.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The last mile is the value[#](#the-last-mile-is-the-value "Link to this heading")
...
## Why good analysis dies in transit[#](#why-good-analysis-dies-in-transit "Link to this heading")
...
## Communicating so it lands[#](#communicating-so-it-lands "Link to this heading")
...
## The two-way street[#](#the-two-way-street "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/08/31/data-creates-value-only-when-it-is-communicated/> (insightful-data-lab.com).
