# The Difference Between Data and Metrics, and the Role of Metrics[#](#the-difference-between-data-and-metrics-and-the-role-of-metrics "Link to this heading")

🎯 Data-Driven Decisions 📐 Metrics & Dashboards Lesson 008

◀ [Previous](007-data-creates-value-only-when-it-is-communicated.html) · [Next](009-dashboards.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## From facts to yardsticks[#](#from-facts-to-yardsticks "Link to this heading")
...
## What turning data into a metric involves[#](#what-turning-data-into-a-metric-involves "Link to this heading")
...
## Why metrics matter[#](#why-metrics-matter "Link to this heading")
...
## Choosing them well[#](#choosing-them-well "Link to this heading")
