# Building and Organizing a Spreadsheet[#](#building-and-organizing-a-spreadsheet "Link to this heading")

🎯 Data-Driven Decisions 📗 Spreadsheets for Analysis Lesson 012

◀ [Previous](011-spreadsheets-in-data-analysis.html) · [Next](013-how-data-analysts-use-spreadsheets.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Layout is destiny[#](#layout-is-destiny "Link to this heading")
...
## The rules of a workable sheet[#](#the-rules-of-a-workable-sheet "Link to this heading")
...
## Why these rules are the rules[#](#why-these-rules-are-the-rules "Link to this heading")
...
## A worked contrast[#](#a-worked-contrast "Link to this heading")
