# Mathematical Thinking[#](#mathematical-thinking "Link to this heading")

🎯 Data-Driven Decisions 📐 Metrics & Dashboards Lesson 010

◀ [Previous](009-dashboards.html) · [Next](011-spreadsheets-in-data-analysis.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Thinking in structure and size[#](#thinking-in-structure-and-size "Link to this heading")
...
## Decomposition: the arithmetic of questions[#](#decomposition-the-arithmetic-of-questions "Link to this heading")
...
## Orders of magnitude: the sanity check[#](#orders-of-magnitude-the-sanity-check "Link to this heading")
...
## Matching data size to decision size[#](#matching-data-size-to-decision-size "Link to this heading")
...
> **Hint**
> * [Analytical Thinking and Its Core Components](../1_foundations/015-analytical-thinking-and-its-core-components.html)
* [The Difference Between Data and Metrics, and the Role of Metrics](008-the-difference-between-data-and-metrics-and-the-role-of-metrics.html)
* [Dashboards](009-dashboards.html)
* [Spreadsheets in Data Analysis](011-spreadsheets-in-data-analysis.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/08/31/mathematical-thinking/> (insightful-data-lab.com).
