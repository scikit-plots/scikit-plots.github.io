# Why Asking the Right Questions Matters in Data Analytics[#](#why-asking-the-right-questions-matters-in-data-analytics "Link to this heading")

🎯 Data-Driven Decisions 🧭 Framing the Problem Lesson 004

◀ [Previous](003-applying-data-analytics-problem-types-in-real-business-scenarios.html) · [Next](005-the-relationship-between-data-and-decision-making.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## The question is the steering wheel[#](#the-question-is-the-steering-wheel "Link to this heading")
...
## SMART questions[#](#smart-questions "Link to this heading")
...
## The questions to avoid[#](#the-questions-to-avoid "Link to this heading")
...
## A worked sharpening[#](#a-worked-sharpening "Link to this heading")
...
> **Hint**
> * [Applying Data Analytics Problem Types in Real Business Scenarios](003-applying-data-analytics-problem-types-in-real-business-scenarios.html)
* [The Role of Business Tasks in Data Analysis](../1_foundations/025-the-role-of-business-tasks-in-data-analysis.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/08/31/why-asking-the-right-questions-matters-in-data-analytics/> (insightful-data-lab.com).
