# Choosing the Right Data to Collect[#](#choosing-the-right-data-to-collect "Link to this heading")

📦 Data Preparation 🧬 Data Types & Structure Lesson 002
...
## What “the right data” means[#](#what-the-right-data-means "Link to this heading")
...
## Sample versus census[#](#sample-versus-census "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/09/04/choosing-the-right-data-to-collect/> (insightful-data-lab.com).
