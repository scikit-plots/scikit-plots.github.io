# Data Security in Spreadsheets[#](#data-security-in-spreadsheets "Link to this heading")

📦 Data Preparation 🔢 Spreadsheets, SQL & Organization Lesson 025

◀ [Previous](024-organizing-data-for-personal-and-work-projects.html) · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Protecting the data you hold[#](#protecting-the-data-you-hold "Link to this heading")
...
## Why spreadsheet security matters[#](#why-spreadsheet-security-matters "Link to this heading")
...
## The core protections[#](#the-core-protections "Link to this heading")
...
## Security as part of preparation[#](#security-as-part-of-preparation "Link to this heading")
...
* [Organizing Data for Personal and Work Projects](024-organizing-data-for-personal-and-work-projects.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/09/04/15236/> (insightful-data-lab.com).
