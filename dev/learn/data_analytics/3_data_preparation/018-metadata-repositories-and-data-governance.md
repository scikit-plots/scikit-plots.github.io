# Metadata Repositories and Data Governance[#](#metadata-repositories-and-data-governance "Link to this heading")

📦 Data Preparation 🗄️ Databases & Data Sources Lesson 018

◀ [Previous](017-metadata-in-databases.html) · [Next](019-accessing-data-internal-and-external-sources.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Managing metadata at scale[#](#managing-metadata-at-scale "Link to this heading")
...
## Metadata repositories[#](#metadata-repositories "Link to this heading")
...
## Data governance[#](#data-governance "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/09/04/metadata-repositories-and-data-governance/> (insightful-data-lab.com).
