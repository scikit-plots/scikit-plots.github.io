# Open Data and Openness in Data Ethics[#](#open-data-and-openness-in-data-ethics "Link to this heading")

📦 Data Preparation ⚖️ Bias & Data Ethics Lesson 015

◀ [Previous](014-data-privacy-in-data-ethics.html) · [Next](016-databases-and-relational-database-concepts.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## The case for openness[#](#the-case-for-openness "Link to this heading")
...
## What open data enables[#](#what-open-data-enables "Link to this heading")
...
## The tension with privacy[#](#the-tension-with-privacy "Link to this heading")
...
## Open data in the analyst’s work[#](#open-data-in-the-analyst-s-work "Link to this heading")
