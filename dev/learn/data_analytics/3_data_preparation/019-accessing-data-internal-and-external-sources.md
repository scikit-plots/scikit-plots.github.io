# Accessing Data: Internal and External Sources[#](#accessing-data-internal-and-external-sources "Link to this heading")

📦 Data Preparation 🗄️ Databases & Data Sources Lesson 019

◀ [Previous](018-metadata-repositories-and-data-governance.html) · [Next](020-importing-data-into-spreadsheets.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Getting to the data[#](#getting-to-the-data "Link to this heading")
...
## Internal (first-party) data[#](#internal-first-party-data "Link to this heading")
...
## External (second- and third-party) data[#](#external-second-and-third-party-data "Link to this heading")
...
## Choosing and combining sources[#](#choosing-and-combining-sources "Link to this heading")
