# BigQuery Account Types[#](#bigquery-account-types "Link to this heading")

📦 Data Preparation 🔢 Spreadsheets, SQL & Organization Lesson 022

◀ [Previous](021-sorting-and-filtering-data-in-spreadsheets.html) · [Next](023-querying-data-with-sql.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## A place to practise SQL at scale[#](#a-place-to-practise-sql-at-scale "Link to this heading")
...
## The account types[#](#the-account-types "Link to this heading")
...
## Which to use, and why it matters[#](#which-to-use-and-why-it-matters "Link to this heading")
...
## Why a cloud warehouse at all[#](#why-a-cloud-warehouse-at-all "Link to this heading")
