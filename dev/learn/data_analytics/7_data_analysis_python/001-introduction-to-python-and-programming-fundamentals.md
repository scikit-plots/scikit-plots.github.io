# Introduction to Python and Programming Fundamentals[#](#introduction-to-python-and-programming-fundamentals "Link to this heading")

🐍 Data Analysis Using Python 🐍 Python Fundamentals Lesson 001

[Next](002-python-fundamentals.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Why Python[#](#why-python "Link to this heading")
...
## Why Python for data analysis[#](#why-python-for-data-analysis "Link to this heading")
...
## Programming fundamentals[#](#programming-fundamentals "Link to this heading")
...
## Python in the analyst’s toolkit[#](#python-in-the-analyst-s-toolkit "Link to this heading")
...
> **Hint**
> * [Choosing the Right Tool in Data Analysis](../5_analyze_data/013-choosing-the-right-tool-in-data-analysis.html)
