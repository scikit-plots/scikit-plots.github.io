# Object-Oriented Programming (OOP) in Python[#](#object-oriented-programming-oop-in-python "Link to this heading")

🐍 Data Analysis Using Python 🐍 Python Fundamentals Lesson 004

◀ [Previous](003-jupyter-notebook-and-coding-environments.html) · [Next](005-variables-in-python.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Everything is an object[#](#everything-is-an-object "Link to this heading")
...
## Objects and methods[#](#objects-and-methods "Link to this heading")
...
## Classes: the blueprint[#](#classes-the-blueprint "Link to this heading")
...
## Why OOP matters for analysis[#](#why-oop-matters-for-analysis "Link to this heading")
...
* [Introduction to Python and Programming Fundamentals](001-introduction-to-python-and-programming-fundamentals.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/12/06/object-oriented-programming-oop-in-python/> (insightful-data-lab.com).
