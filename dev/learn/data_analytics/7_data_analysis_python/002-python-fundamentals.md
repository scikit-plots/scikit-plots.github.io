# Python Fundamentals[#](#python-fundamentals "Link to this heading")

🐍 Data Analysis Using Python 🐍 Python Fundamentals Lesson 002

◀ [Previous](001-introduction-to-python-and-programming-fundamentals.html) · [Next](003-jupyter-notebook-and-coding-environments.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The building blocks[#](#the-building-blocks "Link to this heading")
...
## Values and expressions[#](#values-and-expressions "Link to this heading")
...
## Statements and printing[#](#statements-and-printing "Link to this heading")
...
## Variables: naming values[#](#variables-naming-values "Link to this heading")
...
## Python’s readability[#](#python-s-readability "Link to this heading")
...
* [Jupyter Notebook and Coding Environments](003-jupyter-notebook-and-coding-environments.html)
> **See also**
