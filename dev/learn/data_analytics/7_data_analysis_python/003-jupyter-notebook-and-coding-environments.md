# Jupyter Notebook and Coding Environments[#](#jupyter-notebook-and-coding-environments "Link to this heading")

🐍 Data Analysis Using Python 🐍 Python Fundamentals Lesson 003

◀ [Previous](002-python-fundamentals.html) · [Next](004-object-oriented-programming-oop-in-python.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Where analysts write Python[#](#where-analysts-write-python "Link to this heading")
...
## What a coding environment provides[#](#what-a-coding-environment-provides "Link to this heading")
...
## The Jupyter Notebook[#](#the-jupyter-notebook "Link to this heading")
...
## Why the environment matters for analysis[#](#why-the-environment-matters-for-analysis "Link to this heading")
