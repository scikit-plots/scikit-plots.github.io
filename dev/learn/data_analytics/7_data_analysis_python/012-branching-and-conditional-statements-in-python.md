# Branching and Conditional Statements in Python[#](#branching-and-conditional-statements-in-python "Link to this heading")

🐍 Data Analysis Using Python 🔀 Control Flow Lesson 012

◀ [Previous](011-boolean-data-comparators-and-logical-operators-in-python.html) · [Next](013-while-loops-and-iteration-in-python.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Making code decide[#](#making-code-decide "Link to this heading")
...
## else and elif[#](#else-and-elif "Link to this heading")
...
## Branching on compound conditions[#](#branching-on-compound-conditions "Link to this heading")
...
## Why branching matters[#](#why-branching-matters "Link to this heading")
