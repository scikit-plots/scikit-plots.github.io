# Data-Driven Decision-Making[#](#data-driven-decision-making "Link to this heading")

🌱 Foundations 🌟 Why Data Analytics Lesson 003

◀ [Previous](002-how-data-analytics-improves-the-workplace.html) · [Next](004-detectives-and-data-analysts.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## The loop, not the buzzword[#](#the-loop-not-the-buzzword "Link to this heading")
...
## Intuition versus evidence[#](#intuition-versus-evidence "Link to this heading")
...
## Does it work? The evidence[#](#does-it-work-the-evidence "Link to this heading")
...
## A small worked contrast[#](#a-small-worked-contrast "Link to this heading")
...
[Source article](https://insightful-data-lab.com/2023/07/30/data-driven-decision-making/)
