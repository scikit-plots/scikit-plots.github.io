# The Role and Importance of Data Visualization[#](#the-role-and-importance-of-data-visualization "Link to this heading")

🌱 Foundations 🧰 Tools, Applications & Ethics Lesson 023

◀ [Previous](022-the-concept-and-basic-use-of-sql-query-language.html) · [Next](024-industries-where-data-analysts-work-and-how-data-is-used.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Seeing what summaries hide[#](#seeing-what-summaries-hide "Link to this heading")
...
## The classic demonstration[#](#the-classic-demonstration "Link to this heading")
...
## Two jobs: exploring and explaining[#](#two-jobs-exploring-and-explaining "Link to this heading")
...
## The basic repertoire[#](#the-basic-repertoire "Link to this heading")
...
* [Data Visualization](../6_data_visualization/001-data-visualization.html)
* [Choosing the Right Visualization: Audience-Centered Design and Chart Selection](../6_data_visualization/006-choosing-the-right-visualization-audience-centered-design-and-chart-selection.html)
