# Understanding the Data Analysis Process and the Data Life Cycle[#](#understanding-the-data-analysis-process-and-the-data-life-cycle "Link to this heading")

🌱 Foundations 🔄 The Analysis Process & Data Life Cycle Lesson 008

◀ [Previous](007-understanding-the-data-ecosystem.html) · [Next](009-understanding-the-data-life-cycle.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Two journeys, often confused[#](#two-journeys-often-confused "Link to this heading")
...
## The data life cycle[#](#the-data-life-cycle "Link to this heading")
...
## How the two interlock[#](#how-the-two-interlock "Link to this heading")
...
## Why analysts should care about the whole cycle[#](#why-analysts-should-care-about-the-whole-cycle "Link to this heading")
