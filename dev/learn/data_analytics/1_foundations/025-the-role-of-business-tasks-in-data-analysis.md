# The Role of Business Tasks in Data Analysis[#](#the-role-of-business-tasks-in-data-analysis "Link to this heading")

🌱 Foundations 🧰 Tools, Applications & Ethics Lesson 025

◀ [Previous](024-industries-where-data-analysts-work-and-how-data-is-used.html) · [Next](026-fairness-in-data-analysis.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The question behind the work[#](#the-question-behind-the-work "Link to this heading")
...
## From situation to task[#](#from-situation-to-task "Link to this heading")
...
## Why the task governs everything[#](#why-the-task-governs-everything "Link to this heading")
...
* [Defining the Problem Domain](../2_data_driven_decisions/017-defining-the-problem-domain.html)
