# Detectives and Data Analysts[#](#detectives-and-data-analysts "Link to this heading")

🌱 Foundations 🌟 Why Data Analytics Lesson 004

◀ [Previous](003-data-driven-decision-making.html) · [Next](005-the-six-phases-of-the-data-analysis-process.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Two jobs, one method[#](#two-jobs-one-method "Link to this heading")
...
## What transfers[#](#what-transfers "Link to this heading")
...
## Where the analogy bends[#](#where-the-analogy-bends "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/07/30/detectives-and-data-analysts/> (insightful-data-lab.com).
