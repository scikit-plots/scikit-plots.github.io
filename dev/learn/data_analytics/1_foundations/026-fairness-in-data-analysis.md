# Fairness in Data Analysis[#](#fairness-in-data-analysis "Link to this heading")

🌱 Foundations 🧰 Tools, Applications & Ethics Lesson 026

◀ [Previous](025-the-role-of-business-tasks-in-data-analysis.html) · [Next](027-key-factors-to-consider-when-choosing-a-data-analytics-role.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## What fairness means here[#](#what-fairness-means-here "Link to this heading")
...
## A famous failure, instructive in every detail[#](#a-famous-failure-instructive-in-every-detail "Link to this heading")
...
## Where unfairness enters ordinary analysis[#](#where-unfairness-enters-ordinary-analysis "Link to this heading")
...
## The analyst’s fairness habits[#](#the-analyst-s-fairness-habits "Link to this heading")
