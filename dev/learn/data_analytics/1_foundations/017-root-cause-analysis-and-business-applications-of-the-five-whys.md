# Root Cause Analysis and Business Applications of the Five Whys[#](#root-cause-analysis-and-business-applications-of-the-five-whys "Link to this heading")

🌱 Foundations 🧠 Analytical Skills & Thinking Lesson 017

◀ [Previous](016-analytical-thinking-and-questions-for-problem-solving.html) · [Next](018-data-driven-decision-making-and-the-role-of-analytical-skills.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Fix causes, not symptoms[#](#fix-causes-not-symptoms "Link to this heading")
...
## Business applications[#](#business-applications "Link to this heading")
...
* [Detectives and Data Analysts](004-detectives-and-data-analysts.html)
* [Data-Driven Decision-Making](003-data-driven-decision-making.html)
* [Applying Data Analytics Problem Types in Real Business Scenarios](../2_data_driven_decisions/003-applying-data-analytics-problem-types-in-real-business-scenarios.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/07/30/root-cause-analysis-and-business-applications-of-the-five-whys/> (insightful-data-lab.com).
