# Practical Application of the Data Analysis Process[#](#practical-application-of-the-data-analysis-process "Link to this heading")

🌱 Foundations 🔄 The Analysis Process & Data Life Cycle Lesson 012

◀ [Previous](011-the-stages-of-the-data-analysis-process-and-their-roles.html) · [Next](013-analytical-skills-and-their-core-components.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The process, end to end[#](#the-process-end-to-end "Link to this heading")
...
## The case[#](#the-case "Link to this heading")
...
## Running the phases[#](#running-the-phases "Link to this heading")
...
## What the walkthrough teaches[#](#what-the-walkthrough-teaches "Link to this heading")
...
* [Using Data Analysis to Choose the Right Advertising Strategy](../2_data_driven_decisions/001-using-data-analysis-to-choose-the-right-advertising-strategy.html)
* [Understanding Data Analysis](../5_analyze_data/001-understanding-data-analysis.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/07/30/practical-application-of-the-data-analysis-process/> (insightful-data-lab.com).
