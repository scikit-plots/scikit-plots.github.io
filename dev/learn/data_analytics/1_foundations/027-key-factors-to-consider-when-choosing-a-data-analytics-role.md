# Key Factors to Consider When Choosing a Data Analytics Role[#](#key-factors-to-consider-when-choosing-a-data-analytics-role "Link to this heading")

🌱 Foundations 🧰 Tools, Applications & Ethics Lesson 027

◀ [Previous](026-fairness-in-data-analysis.html) · [↑ Section](index.html) · [↑ Hub](../index.html)

## The same title, very different jobs[#](#the-same-title-very-different-jobs "Link to this heading")
...
## The factors that matter[#](#the-factors-that-matter "Link to this heading")
...
## Reading a posting with the factors[#](#reading-a-posting-with-the-factors "Link to this heading")
...
## Closing the foundations[#](#closing-the-foundations "Link to this heading")
...
> **Hint**
> * [Industries Where Data Analysts Work and How Data Is Used](024-industries-where-data-analysts-work-and-how-data-is-used.html)
* [Analytical Skills and Their Core Components](013-analytical-skills-and-their-core-components.html)
* [Exploring Data Analyst Job Opportunities](../4_data_cleaning_preparation/032-exploring-data-analyst-job-opportunities.html)
* [Transferable Skills](../8_job_search/001-transferable-skills.html)
> **See also**
