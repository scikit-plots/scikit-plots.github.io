# Applying Analytical Skills in a Business Context[#](#applying-analytical-skills-in-a-business-context "Link to this heading")

🌱 Foundations 🧠 Analytical Skills & Thinking Lesson 014

◀ [Previous](013-analytical-skills-and-their-core-components.html) · [Next](015-analytical-thinking-and-its-core-components.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## From list to practice[#](#from-list-to-practice "Link to this heading")
...
## The situation[#](#the-situation "Link to this heading")
...
## Each skill, doing work[#](#each-skill-doing-work "Link to this heading")
...
## What the skills produced[#](#what-the-skills-produced "Link to this heading")
