# Introduction to Tableau[#](#introduction-to-tableau "Link to this heading")

🎨 Data Visualization 📊 Tableau Lesson 009

◀ [Previous](008-accessibility-in-data-visualization-designing-for-everyone.html) · [Next](010-getting-started-with-tableau-public.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## A tool built for visualization[#](#a-tool-built-for-visualization "Link to this heading")
...
## What Tableau is[#](#what-tableau-is "Link to this heading")
...
## What Tableau does well[#](#what-tableau-does-well "Link to this heading")
...
## Where Tableau fits[#](#where-tableau-fits "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/introduction-to-tableau/> (insightful-data-lab.com).
