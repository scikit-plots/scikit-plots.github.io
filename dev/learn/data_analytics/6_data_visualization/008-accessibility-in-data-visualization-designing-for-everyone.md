# Accessibility in Data Visualization: Designing for Everyone[#](#accessibility-in-data-visualization-designing-for-everyone "Link to this heading")

🎨 Data Visualization 🎨 Visualization Principles & Design Lesson 008

◀ [Previous](007-design-thinking-in-data-visualization-a-user-centered-framework.html) · [Next](009-introduction-to-tableau.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Visualizations for everyone[#](#visualizations-for-everyone "Link to this heading")
...
## Why accessibility matters[#](#why-accessibility-matters "Link to this heading")
...
## Practices for accessible visualization[#](#practices-for-accessible-visualization "Link to this heading")
...
## Accessibility as good design[#](#accessibility-as-good-design "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/accessibility-in-data-visualization-designing-for-everyone/> (insightful-data-lab.com).
