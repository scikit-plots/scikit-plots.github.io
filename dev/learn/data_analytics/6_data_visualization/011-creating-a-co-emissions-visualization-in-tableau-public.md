# Creating a CO₂ Emissions Visualization in Tableau Public[#](#creating-a-co2-emissions-visualization-in-tableau-public "Link to this heading")

🎨 Data Visualization 📊 Tableau Lesson 011

◀ [Previous](010-getting-started-with-tableau-public.html) · [Next](012-effective-vs-ineffective-data-visualizations-in-tableau.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
creating a visualization of ****COu2082 emissions**** data in Tableau Public — a
...
## The data and the question[#](#the-data-and-the-question "Link to this heading")

An emissions dataset typically holds, per row, a place and time and an emissions
figure — for example country, year, and COu2082 emissions (in tonnes or per capita).
...
## Building the visualization[#](#building-the-visualization "Link to this heading")
...
## Principles in the concrete[#](#principles-in-the-concrete "Link to this heading")
...
message. A COu2082 visualization built this way communicates a real environmental
