# Elements of Art in Data Visualization: Line, Shape, Color, Space, and Movement[#](#elements-of-art-in-data-visualization-line-shape-color-space-and-movement "Link to this heading")

🎨 Data Visualization 🎨 Visualization Principles & Design Lesson 005
...
## The elements and their roles[#](#the-elements-and-their-roles "Link to this heading")
...
## Using the elements deliberately[#](#using-the-elements-deliberately "Link to this heading")
...
## Colour, the element to handle with care[#](#colour-the-element-to-handle-with-care "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/elements-of-art-in-data-visualization-line-shape-color-space-and-movement/> (insightful-data-lab.com).
