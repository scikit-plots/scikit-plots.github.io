# Engaging Your Audience in Data Storytelling: Identifying the Key Message[#](#engaging-your-audience-in-data-storytelling-identifying-the-key-message "Link to this heading")

🎨 Data Visualization 📖 Storytelling & Dashboards Lesson 016
...
## The one thing they should remember[#](#the-one-thing-they-should-remember "Link to this heading")
...
## Why one key message[#](#why-one-key-message "Link to this heading")
...
## Finding the key message[#](#finding-the-key-message "Link to this heading")
...
## Building the story around the message[#](#building-the-story-around-the-message "Link to this heading")
...
## Engaging the audience[#](#engaging-the-audience "Link to this heading")
...
* [Data Dashboards: Organizing Insight for Real-Time Decision Making](017-data-dashboards-organizing-insight-for-real-time-decision-making.html)
* [Using Filters to Create Compelling and Focused Visuals](018-using-filters-to-create-compelling-and-focused-visuals.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/engaging-your-audience-in-data-storytelling-identifying-the-key-message/> (insightful-data-lab.com).

Tags: [purpose: reference](../../../_tags/purpose-reference.html) [topic: data analytics](../../../_tags/topic-data-analytics.html) [topic: viz](../../../_tags/topic-viz.html) [topic: story](../../../_tags/topic-story.html)