# Using Creativity in Tableau[#](#using-creativity-in-tableau "Link to this heading")

🎨 Data Visualization 📊 Tableau Lesson 013

◀ [Previous](012-effective-vs-ineffective-data-visualizations-in-tableau.html) · [Next](014-linking-multiple-datasets-in-tableau-public.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Beyond the defaults[#](#beyond-the-defaults "Link to this heading")
...
## Where creativity fits[#](#where-creativity-fits "Link to this heading")
...
## Creativity in service of communication[#](#creativity-in-service-of-communication "Link to this heading")
...
## Balancing engagement and clarity[#](#balancing-engagement-and-clarity "Link to this heading")
...
* [Linking Multiple Datasets in Tableau Public](014-linking-multiple-datasets-in-tableau-public.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/using-creativity-in-tableau/> (insightful-data-lab.com).
