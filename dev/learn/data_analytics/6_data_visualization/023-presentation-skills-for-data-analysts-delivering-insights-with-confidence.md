# Presentation Skills for Data Analysts: Delivering Insights with Confidence[#](#presentation-skills-for-data-analysts-delivering-insights-with-confidence "Link to this heading")

🎨 Data Visualization 🎤 Presentations & Q&A Lesson 023

◀ [Previous](022-weaving-data-into-presentations-hypotheses-context-and-the-mccandless-method.html) · [Next](024-presenting-like-a-pro-best-practices-for-data-analysts.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The delivery half[#](#the-delivery-half "Link to this heading")
...
## The core delivery skills[#](#the-core-delivery-skills "Link to this heading")
...
## Confidence and how it is built[#](#confidence-and-how-it-is-built "Link to this heading")
...
## Managing nervousness[#](#managing-nervousness "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/presentation-skills-for-data-analysts-delivering-insights-with-confidence/> (insightful-data-lab.com).
