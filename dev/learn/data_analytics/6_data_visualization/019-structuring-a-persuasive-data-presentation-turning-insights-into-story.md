# Structuring a Persuasive Data Presentation: Turning Insights into Story[#](#structuring-a-persuasive-data-presentation-turning-insights-into-story "Link to this heading")

🎨 Data Visualization 🎤 Presentations & Q&A Lesson 019

◀ [Previous](018-using-filters-to-create-compelling-and-focused-visuals.html) · [Next](020-designing-effective-data-presentation-slides-structure-visuals-and-professional-impact.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## From findings to presentation[#](#from-findings-to-presentation "Link to this heading")
...
## The presentation as a story[#](#the-presentation-as-a-story "Link to this heading")
...
## A structure for data presentations[#](#a-structure-for-data-presentations "Link to this heading")
...
## Structuring around the audience[#](#structuring-around-the-audience "Link to this heading")
...
* [Using a Strategic Framework to Structure Data Presentations](021-using-a-strategic-framework-to-structure-data-presentations.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/structuring-a-persuasive-data-presentation-turning-insights-into-story/> (insightful-data-lab.com).
