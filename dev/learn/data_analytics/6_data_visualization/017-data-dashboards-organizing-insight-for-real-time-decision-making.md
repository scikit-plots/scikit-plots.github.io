# Data Dashboards: Organizing Insight for Real-Time Decision Making[#](#data-dashboards-organizing-insight-for-real-time-decision-making "Link to this heading")

🎨 Data Visualization 📖 Storytelling & Dashboards Lesson 017

◀ [Previous](016-engaging-your-audience-in-data-storytelling-identifying-the-key-message.html) · [Next](018-using-filters-to-create-compelling-and-focused-visuals.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Many views, one screen[#](#many-views-one-screen "Link to this heading")
...
## What a dashboard is[#](#what-a-dashboard-is "Link to this heading")
...
## When dashboards fit[#](#when-dashboards-fit "Link to this heading")
...
## Designing effective dashboards[#](#designing-effective-dashboards "Link to this heading")
...
## Why dashboards matter[#](#why-dashboards-matter "Link to this heading")
