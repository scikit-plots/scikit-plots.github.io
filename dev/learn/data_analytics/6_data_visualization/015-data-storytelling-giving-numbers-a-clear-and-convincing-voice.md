# Data Storytelling: Giving Numbers a Clear and Convincing Voice[#](#data-storytelling-giving-numbers-a-clear-and-convincing-voice "Link to this heading")

🎨 Data Visualization 📖 Storytelling & Dashboards Lesson 015

◀ [Previous](014-linking-multiple-datasets-in-tableau-public.html) · [Next](016-engaging-your-audience-in-data-storytelling-identifying-the-key-message.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## From charts to story[#](#from-charts-to-story "Link to this heading")
...
## Why storytelling matters[#](#why-storytelling-matters "Link to this heading")
...
## The elements of data storytelling[#](#the-elements-of-data-storytelling "Link to this heading")
...
## The narrative arc[#](#the-narrative-arc "Link to this heading")
