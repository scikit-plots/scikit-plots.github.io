# Refining a Resume for Data Analytics Roles[#](#refining-a-resume-for-data-analytics-roles "Link to this heading")

🧽 Data Cleaning & Preparation ✅ Verification, Documentation & Next Steps Lesson 031

◀ [Previous](030-using-feedback-from-data-cleaning-to-improve-data-quality.html) · [Next](032-exploring-data-analyst-job-opportunities.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Cleaning your own professional data[#](#cleaning-your-own-professional-data "Link to this heading")
...
## What a data analytics resume must show[#](#what-a-data-analytics-resume-must-show "Link to this heading")
...
## Applying the course’s own principles[#](#applying-the-course-s-own-principles "Link to this heading")
...
## Refining as iteration[#](#refining-as-iteration "Link to this heading")
...
> **Hint**
> * [Tailoring Your Resume](../8_job_search/005-tailoring-your-resume.html)
* [Using AI to Improve and Tailor Your Resume](../8_job_search/006-using-ai-to-improve-and-tailor-your-resume.html)
* [Key Factors to Consider When Choosing a Data Analytics Role](../1_foundations/027-key-factors-to-consider-when-choosing-a-data-analytics-role.html)
* [Exploring Data Analyst Job Opportunities](032-exploring-data-analyst-job-opportunities.html)
> **See also**
