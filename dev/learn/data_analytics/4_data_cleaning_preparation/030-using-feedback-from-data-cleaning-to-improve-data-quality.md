# Using Feedback from Data Cleaning to Improve Data Quality[#](#using-feedback-from-data-cleaning-to-improve-data-quality "Link to this heading")

🧽 Data Cleaning & Preparation ✅ Verification, Documentation & Next Steps Lesson 030

◀ [Previous](029-reporting-data-cleaning-results.html) · [Next](031-refining-a-resume-for-data-analytics-roles.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Closing the loop[#](#closing-the-loop "Link to this heading")
...
## From symptom to source[#](#from-symptom-to-source "Link to this heading")
...
## How feedback improves quality at the source[#](#how-feedback-improves-quality-at-the-source "Link to this heading")
...
## Why this is the analyst’s contribution to quality[#](#why-this-is-the-analyst-s-contribution-to-quality "Link to this heading")
...
> **Hint**
> * [Reporting Data-Cleaning Results](029-reporting-data-cleaning-results.html)
* [Verifying Data-Cleaning Efforts](026-verifying-data-cleaning-efforts.html)
