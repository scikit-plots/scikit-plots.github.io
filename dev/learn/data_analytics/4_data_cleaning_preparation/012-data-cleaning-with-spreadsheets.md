# Data Cleaning with Spreadsheets[#](#data-cleaning-with-spreadsheets "Link to this heading")

🧽 Data Cleaning & Preparation 🧹 Dirty Data & Spreadsheet Cleaning Lesson 012

◀ [Previous](011-common-issues-in-dirty-data.html) · [Next](013-cleaning-and-merging-multiple-datasets.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Cleaning, hands on[#](#cleaning-hands-on "Link to this heading")
...
## Spreadsheet cleaning, defect by defect[#](#spreadsheet-cleaning-defect-by-defect "Link to this heading")
...
## The disciplined workflow[#](#the-disciplined-workflow "Link to this heading")
...
* [Cleaning and Merging Multiple Datasets](013-cleaning-and-merging-multiple-datasets.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/01/data-cleaning-with-spreadsheets/> (insightful-data-lab.com).
