# Documenting Data-Cleaning Changes[#](#documenting-data-cleaning-changes "Link to this heading")

🧽 Data Cleaning & Preparation ✅ Verification, Documentation & Next Steps Lesson 028

◀ [Previous](027-verification-techniques-using-spreadsheets-and-sql-to-catch-repeated-errors.html) · [Next](029-reporting-data-cleaning-results.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## The record that makes cleaning real[#](#the-record-that-makes-cleaning-real "Link to this heading")
...
## What to document[#](#what-to-document "Link to this heading")
...
## Documentation as reproducibility[#](#documentation-as-reproducibility "Link to this heading")
