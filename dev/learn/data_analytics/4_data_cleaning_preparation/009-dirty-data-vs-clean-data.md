# Dirty Data vs. Clean Data[#](#dirty-data-vs-clean-data "Link to this heading")

🧽 Data Cleaning & Preparation 🧹 Dirty Data & Spreadsheet Cleaning Lesson 009

◀ [Previous](008-margin-of-error.html) · [Next](010-the-importance-of-clean-data-revisited.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Two states of the same table[#](#two-states-of-the-same-table "Link to this heading")
...
## The contrast, defect by defect[#](#the-contrast-defect-by-defect "Link to this heading")
...
## Why the distinction is the whole job[#](#why-the-distinction-is-the-whole-job "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/01/dirty-data-vs-clean-data/> (insightful-data-lab.com).
