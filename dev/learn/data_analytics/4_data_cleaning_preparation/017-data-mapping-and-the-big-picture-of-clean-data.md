# Data Mapping and the Big Picture of Clean Data[#](#data-mapping-and-the-big-picture-of-clean-data "Link to this heading")

🧽 Data Cleaning & Preparation 🧹 Dirty Data & Spreadsheet Cleaning Lesson 017

◀ [Previous](016-viewing-data-differently-for-more-effective-data-cleaning.html) · [Next](018-introduction-to-sql.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Making sources speak the same language[#](#making-sources-speak-the-same-language "Link to this heading")
...
## What data mapping does[#](#what-data-mapping-does "Link to this heading")
...
## Why the big picture matters[#](#why-the-big-picture-matters "Link to this heading")
...
## Mapping and documentation[#](#mapping-and-documentation "Link to this heading")
...
* [Structured Data and Data Models](../3_data_preparation/004-structured-data-and-data-models.html)
