# Verification Techniques: Using Spreadsheets and SQL to Catch Repeated Errors[#](#verification-techniques-using-spreadsheets-and-sql-to-catch-repeated-errors "Link to this heading")

🧽 Data Cleaning & Preparation ✅ Verification, Documentation & Next Steps Lesson 027

◀ [Previous](026-verifying-data-cleaning-efforts.html) · [Next](028-documenting-data-cleaning-changes.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Concrete checks in both tools[#](#concrete-checks-in-both-tools "Link to this heading")
...
## Spreadsheet verification techniques[#](#spreadsheet-verification-techniques "Link to this heading")
...
## SQL verification techniques[#](#sql-verification-techniques "Link to this heading")
...
## Catching **repeated** errors specifically[#](#catching-repeated-errors-specifically "Link to this heading")
