# Cleaning and Merging Multiple Datasets[#](#cleaning-and-merging-multiple-datasets "Link to this heading")

🧽 Data Cleaning & Preparation 🧹 Dirty Data & Spreadsheet Cleaning Lesson 013

◀ [Previous](012-data-cleaning-with-spreadsheets.html) · [Next](014-spreadsheet-tools-for-data-cleaning.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## When cleaning means combining[#](#when-cleaning-means-combining "Link to this heading")
...
## The merge and its prerequisite[#](#the-merge-and-its-prerequisite "Link to this heading")
...
## The cross-dataset cleaning problems[#](#the-cross-dataset-cleaning-problems "Link to this heading")
...
## The disciplined merge[#](#the-disciplined-merge "Link to this heading")
...
* [Using VLOOKUP to Combine Data Across Spreadsheets](../5_analyze_data/015-using-vlookup-to-combine-data-across-spreadsheets.html)
