# Advanced SQL Functions for Data Cleaning[#](#advanced-sql-functions-for-data-cleaning "Link to this heading")

🧽 Data Cleaning & Preparation 🐬 Cleaning with SQL Lesson 023

◀ [Previous](022-using-cast-to-clean-and-format-data-in-sql.html) · [Next](024-coalesce.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Conditional cleaning with CASE[#](#conditional-cleaning-with-case "Link to this heading")
...
## Extracting parts of a field[#](#extracting-parts-of-a-field "Link to this heading")
...
## Pattern-based cleaning[#](#pattern-based-cleaning "Link to this heading")
...
## Composing the advanced tools[#](#composing-the-advanced-tools "Link to this heading")
