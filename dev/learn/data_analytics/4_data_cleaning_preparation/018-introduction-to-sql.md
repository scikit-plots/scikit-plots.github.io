# Introduction to SQL[#](#introduction-to-sql "Link to this heading")

🧽 Data Cleaning & Preparation 🐬 Cleaning with SQL Lesson 018

◀ [Previous](017-data-mapping-and-the-big-picture-of-clean-data.html) · [Next](019-spreadsheets-vs-sql.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Cleaning at database scale[#](#cleaning-at-database-scale "Link to this heading")
...
## Why SQL for cleaning[#](#why-sql-for-cleaning "Link to this heading")
...
## The same operations, in query form[#](#the-same-operations-in-query-form "Link to this heading")
...
## What makes SQL cleaning powerful[#](#what-makes-sql-cleaning-powerful "Link to this heading")
...
* [Spreadsheets vs. SQL](019-spreadsheets-vs-sql.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/01/introduction-to-sql/> (insightful-data-lab.com).
