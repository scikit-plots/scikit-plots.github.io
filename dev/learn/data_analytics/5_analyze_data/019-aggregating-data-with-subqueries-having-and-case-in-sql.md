# Aggregating Data with Subqueries, HAVING, and CASE in SQL[#](#aggregating-data-with-subqueries-having-and-case-in-sql "Link to this heading")

📊 Analyze Data 🔗 Problem-Solving & Combining Data Lesson 019

◀ [Previous](018-subqueries-in-sql.html) · [Next](020-using-spreadsheet-formulas-for-sales-trend-analysis.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Bringing the pieces together[#](#bringing-the-pieces-together "Link to this heading")
...
## Filtering groups with HAVING[#](#filtering-groups-with-having "Link to this heading")
...
## Conditional aggregation with CASE[#](#conditional-aggregation-with-case "Link to this heading")
...
## Layering with subqueries[#](#layering-with-subqueries "Link to this heading")
...
## The analytical payoff[#](#the-analytical-payoff "Link to this heading")
