# Using JOIN in SQL to Combine Tables[#](#using-join-in-sql-to-combine-tables "Link to this heading")

📊 Analyze Data 🔗 Problem-Solving & Combining Data Lesson 017

◀ [Previous](016-troubleshooting-vlookup-and-building-a-problem-solving-framework.html) · [Next](018-subqueries-in-sql.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## The SQL way to combine tables[#](#the-sql-way-to-combine-tables "Link to this heading")
...
## How a JOIN works[#](#how-a-join-works "Link to this heading")
...
## The types of JOIN[#](#the-types-of-join "Link to this heading")
...
## JOIN versus VLOOKUP[#](#join-versus-vlookup "Link to this heading")
...
* [Databases and Relational Database Concepts](../3_data_preparation/016-databases-and-relational-database-concepts.html)
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/using-join-in-sql-to-combine-tables/> (insightful-data-lab.com).
