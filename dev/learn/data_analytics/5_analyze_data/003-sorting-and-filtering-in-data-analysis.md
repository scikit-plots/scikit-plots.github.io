# Sorting and Filtering in Data Analysis[#](#sorting-and-filtering-in-data-analysis "Link to this heading")

📊 Analyze Data 🗂️ Organizing & Formatting Data Lesson 003

◀ [Previous](002-data-organization-in-analysis.html) · [Next](004-sorting-data-in-spreadsheets.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The two foundational moves[#](#the-two-foundational-moves "Link to this heading")
...
## Sorting for analysis[#](#sorting-for-analysis "Link to this heading")
...
## Filtering for analysis[#](#filtering-for-analysis "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/sorting-and-filtering-in-data-analysis/> (insightful-data-lab.com).
