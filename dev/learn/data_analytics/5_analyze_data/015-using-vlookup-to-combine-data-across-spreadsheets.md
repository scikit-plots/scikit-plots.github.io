# Using VLOOKUP to Combine Data Across Spreadsheets[#](#using-vlookup-to-combine-data-across-spreadsheets "Link to this heading")

📊 Analyze Data 🔗 Problem-Solving & Combining Data Lesson 015

◀ [Previous](014-preparing-data-for-vlookup-in-spreadsheets.html) · [Next](016-troubleshooting-vlookup-and-building-a-problem-solving-framework.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Performing the lookup[#](#performing-the-lookup "Link to this heading")
...
## The VLOOKUP formula[#](#the-vlookup-formula "Link to this heading")
...
* ****lookup\_value**** — the value to search for (the key), e.g. this row’s product
  code.
* ****table\_range**** — the table to search, whose **first column** holds the keys and
  whose other columns hold the values to return.
* ****column\_index**** — **which column** of that range to return, counted from the left
...
## Combining across sheets[#](#combining-across-sheets "Link to this heading")
...
## VLOOKUP and the always-FALSE rule[#](#vlookup-and-the-always-false-rule "Link to this heading")
...
> **Hint**
> * [Preparing Data for VLOOKUP in Spreadsheets](014-preparing-data-for-vlookup-in-spreadsheets.html)
* [Troubleshooting VLOOKUP and Building a Problem-Solving Framework](016-troubleshooting-vlookup-and-building-a-problem-solving-framework.html)
