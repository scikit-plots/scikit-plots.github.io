# Understanding Data Analysis[#](#understanding-data-analysis "Link to this heading")

📊 Analyze Data 🗂️ Organizing & Formatting Data Lesson 001

[Next](002-data-organization-in-analysis.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## The heart of the craft[#](#the-heart-of-the-craft "Link to this heading")
...
## What analysis is[#](#what-analysis-is "Link to this heading")
...
## Analysis versus the phases around it[#](#analysis-versus-the-phases-around-it "Link to this heading")
...
## What analysis produces[#](#what-analysis-produces "Link to this heading")
...
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/02/understanding-data-analysis/> (insightful-data-lab.com).
