# Preparing Data for VLOOKUP in Spreadsheets[#](#preparing-data-for-vlookup-in-spreadsheets "Link to this heading")

📊 Analyze Data 🔗 Problem-Solving & Combining Data Lesson 014

◀ [Previous](013-choosing-the-right-tool-in-data-analysis.html) · [Next](015-using-vlookup-to-combine-data-across-spreadsheets.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)

## Setup before lookup[#](#setup-before-lookup "Link to this heading")
...
## What VLOOKUP does, briefly[#](#what-vlookup-does-briefly "Link to this heading")
...
## The preparation VLOOKUP requires[#](#the-preparation-vlookup-requires "Link to this heading")
...
## Preparation as the real work[#](#preparation-as-the-real-work "Link to this heading")
...
* [Cleaning and Merging Multiple Datasets](../4_data_cleaning_preparation/013-cleaning-and-merging-multiple-datasets.html)
* [Data Mapping and the Big Picture of Clean Data](../4_data_cleaning_preparation/017-data-mapping-and-the-big-picture-of-clean-data.html)
* [Choosing the Right Tool in Data Analysis](013-choosing-the-right-tool-in-data-analysis.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/preparing-data-for-vlookup-in-spreadsheets/> (insightful-data-lab.com).
