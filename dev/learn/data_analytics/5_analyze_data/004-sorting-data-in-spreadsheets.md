# Sorting Data in Spreadsheets[#](#sorting-data-in-spreadsheets "Link to this heading")

📊 Analyze Data 🗂️ Organizing & Formatting Data Lesson 004

◀ [Previous](003-sorting-and-filtering-in-data-analysis.html) · [Next](005-sorting-and-filtering-data-in-sql-using-order-by-and-where.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Sorting, in practice[#](#sorting-in-practice "Link to this heading")
...
## Single-column sorting[#](#single-column-sorting "Link to this heading")
...
## Multi-column sorting[#](#multi-column-sorting "Link to this heading")
...
## The critical safety rule[#](#the-critical-safety-rule "Link to this heading")
...
## Sorting as an analytical tool[#](#sorting-as-an-analytical-tool "Link to this heading")
...
* [Data Organization in Analysis](002-data-organization-in-analysis.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/sorting-data-in-spreadsheets/> (insightful-data-lab.com).
