# Data Validation as an Ongoing Analytical Process[#](#data-validation-as-an-ongoing-analytical-process "Link to this heading")

📊 Analyze Data 🚀 Validation & Temporary Tables Lesson 028
...
## Why validation must be continuous[#](#why-validation-must-be-continuous "Link to this heading")
...
## What ongoing validation looks like[#](#what-ongoing-validation-looks-like "Link to this heading")
...
## Validation and trustworthy analysis[#](#validation-and-trustworthy-analysis "Link to this heading")
...
* [Temporary Tables and the WITH Clause in SQL](029-temporary-tables-and-the-with-clause-in-sql.html)
> **See also**
> ****Source article**** Adapted (context, re-expressed) in our own words from: <https://insightful-data-lab.com/2023/11/26/data-validation-as-an-ongoing-analytical-process/> (insightful-data-lab.com).
