# Using Spreadsheet Formulas for Sales Trend Analysis[#](#using-spreadsheet-formulas-for-sales-trend-analysis "Link to this heading")

📊 Analyze Data 🧮 Calculations & Aggregation Lesson 020

◀ [Previous](019-aggregating-data-with-subqueries-having-and-case-in-sql.html) · [Next](021-using-countif-and-sumif-for-conditional-aggregation-in-spreadsheets.html) ▶ · [↑ Section](index.html) · [↑ Hub](../index.html)
...
## Calculating change over time[#](#calculating-change-over-time "Link to this heading")
...
## The core trend calculations[#](#the-core-trend-calculations "Link to this heading")
...
## Reading the trend[#](#reading-the-trend "Link to this heading")
...
## The absolute/relative reference connection[#](#the-absolute-relative-reference-connection "Link to this heading")
