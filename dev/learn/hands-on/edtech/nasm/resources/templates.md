...
## NASM Template[#](#nasm-template "Link to this heading")

> **Note**
> Please see [Task 1: POSIX Environment Setup](../1/index.html#posix-env-setup) to install the required packages
and libraries.
```
; include directives
global asm_main
...
## Makefile 32-bit Template[#](#makefile-32-bit-template "Link to this heading")
