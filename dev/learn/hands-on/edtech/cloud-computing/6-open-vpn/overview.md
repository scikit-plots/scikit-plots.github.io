# [Lab 6: Overview](#id1)[#](#lab-6-overview "Link to this heading")
...
## [Platform Services](#id2)[#](#platform-services "Link to this heading")
...
code. [PaaS or platform as a service](https://www.cloudflare.com/learning/serverless/glossary/platform-as-a-service-paas/) is a service that automates the process
...
You can [explore PaaS tools](../references/paas.html#paas-tools) on your own.

****PaaS is for developers to host the software****

## [Infrastructure Services](#id3)[#](#infrastructure-services "Link to this heading")

Now, we’ll shift our focus from software to ****infrastructure services****.
[IaaS](https://www.interoute.com/what-iaas) or infrastructure as a service provides hardware and virtualized
infrastructure.
...
[OpenVPN](https://openvpn.net/) is a company that provides the open-source version of OpenVPN
software. Like many other organizations that produce open-source software,
they provide paid services and they release the [community edition](https://openvpn.net/community-downloads/) of that
...
1. The websites that you visit assume that you are at the location.
2. Your data is encrypted from your OpenVPN client to that endpoint.
...
## [Goals for Lab 6](#id4)[#](#goals-for-lab-6 "Link to this heading")
...
> 1. ****configure**** OpenVPN in a Docker container.
> 2. ****modify**** the server and client configurations.
> 3. ****connect**** to the OpenVPN server using the client config to access the
>    internet.
