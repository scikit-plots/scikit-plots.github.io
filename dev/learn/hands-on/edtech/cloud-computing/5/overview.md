# [Lab 5: Overview](#id1)[#](#lab-5-overview "Link to this heading")
...
application using the [Flask](http://flask.pocoo.org/) microframework. This method allows us to bundle
...
## [Goals for Lab 5](#id2)[#](#goals-for-lab-5 "Link to this heading")
...
> 2. ****daemonize**** a container to run in the background
> 3. ****package**** a web application or internet service in a Docker image
