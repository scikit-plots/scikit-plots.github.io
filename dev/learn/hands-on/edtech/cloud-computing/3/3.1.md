# [Step 1: Clean Up](#id1)[#](#step-1-clean-up "Link to this heading")

## [Remove Previous Wordpress Containers](#id2)[#](#remove-previous-wordpress-containers "Link to this heading")

We need to stop the Wordpress project and remove the containers before
we rebuild the project. As you will learn, Docker containers are
disposable when using volumes because the data and configurations reside
outside of the containers. The containers load that data so users can
interact with it.
...
3. Remove any stopped containers or containers that you no longer want running.
   ...
   * Remove a stopped container using the CONTAINER ID:
     `docker rm 1234567890`![../../../../../_images/container-id.png](../../../../../_images/container-id.png)
   ```
   ...
   ```
4. Clean up any dangling volumes using
   `docker volume prune`
5. Physically remove any data stored in the volume directory or
   `db_data` using command `rm -r db_data`
...
Source page:
<https://labs.bilimedtech.com/cloud-computing/3/3.1.html>
