# NEW\_COURSE\_PLAYBOOK.md — building a new `learn/` course[#](#new-course-playbook-md-building-a-new-learn-course "Link to this heading")
...
## 1. Pick the mode first[#](#pick-the-mode-first "Link to this heading")
...
## 2. Folder layout (both modes)[#](#folder-layout-both-modes "Link to this heading")
...
## 3. The generator contract (both modes)[#](#the-generator-contract-both-modes "Link to this heading")
...
## 4. Shared six-phase workflow[#](#shared-six-phase-workflow "Link to this heading")
...
3. ****Fill content in small batches**** (Mode A) or ****fetch pages**** (Mode B). Every
   ...
   `web_search`; append; rebuild; run `_buildcheck.py`; confirm `doc 0 | ref 0 | underline 0` and `idem OK`.
...
## 5. Mode A — Rewrite (the six existing courses)[#](#mode-a-rewrite-the-six-existing-courses "Link to this heading")
...
## 6. The AI-generated-content admonition (both modes, required)[#](#the-ai-generated-content-admonition-both-modes-required "Link to this heading")
...
## 7. Mode B — Verbatim mirror under CC BY (the `hands-on/edtech/` build)[#](#mode-b-verbatim-mirror-under-cc-by-the-hands-on-edtech-build "Link to this heading")
...
### 7.1 Fetch strategy (proven)[#](#fetch-strategy-proven "Link to this heading")
...
### 7.2 Reproduce verbatim[#](#reproduce-verbatim "Link to this heading")
...
### 7.3 Attribution + license on every page[#](#attribution-license-on-every-page "Link to this heading")
...
### 7.4 The LICENSE file[#](#the-license-file "Link to this heading")
...
Reference it from every page’s notice via `:doc:`LICENSE <LICENSE\_edtech>``. Add a
...
### 7.5 Canonical URL / duplicate-content (SEO)[#](#canonical-url-duplicate-content-seo "Link to this heading")
...
Sphinx build, set this per page — e.g. a raw-HTML `<link rel="canonical" href="<source page URL>">` in the page head via a `.. meta::`/`html_baseurl` mechanism, or the
theme’s canonical option. Document the exact hook in the `EDTECH.md` guide when built.

### 7.6 Structure recap[#](#structure-recap "Link to this heading")
...
## 8. Validation with `_buildcheck.py` (both modes)[#](#validation-with-buildcheck-py-both-modes "Link to this heading")
...
## 9. Extending or editing a course later[#](#extending-or-editing-a-course-later "Link to this heading")
...
## 10. Quick-start checklist for the new chat[#](#quick-start-checklist-for-the-new-chat "Link to this heading")
