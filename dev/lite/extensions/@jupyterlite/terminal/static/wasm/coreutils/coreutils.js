...
function findWasmBinary() {
  return locateFile("coreutils.wasm");
}
...
var wasmImports = {
  ...
  /** @export */ z: ___syscall__newselect,
  /** @export */ t: ___syscall_chdir,
  /** @export */ s: ___syscall_chmod,
  /** @export */ r: ___syscall_dup3,
  /** @export */ Z: ___syscall_faccessat,
  /** @export */ F: ___syscall_fadvise64,
  /** @export */ Y: ___syscall_fchdir,
  /** @export */ X: ___syscall_fchmod,
  /** @export */ q: ___syscall_fchmodat2,
  /** @export */ W: ___syscall_fchown32,
  /** @export */ i: ___syscall_fchownat,
  /** @export */ c: ___syscall_fcntl64,
  /** @export */ V: ___syscall_fdatasync,
  /** @export */ U: ___syscall_fstat64,
  /** @export */ O: ___syscall_ftruncate64,
  /** @export */ N: ___syscall_getcwd,
  /** @export */ B: ___syscall_getdents64,
  /** @export */ g: ___syscall_ioctl,
  /** @export */ Q: ___syscall_lstat64,
  /** @export */ n: ___syscall_mkdirat,
  /** @export */ m: ___syscall_mknodat,
  /** @export */ S: ___syscall_newfstatat,
  /** @export */ e: ___syscall_openat,
  /** @export */ G: ___syscall_pipe,
  /** @export */ l: ___syscall_readlinkat,
  /** @export */ A: ___syscall_renameat,
  /** @export */ k: ___syscall_rmdir,
  /** @export */ T: ___syscall_stat64,
  /** @export */ y: ___syscall_statfs64,
  /** @export */ x: ___syscall_symlinkat,
  /** @export */ h: ___syscall_unlinkat,
  /** @export */ v: ___syscall_utimensat,
  /** @export */ ca: __abort_js,
  /** @export */ E: __emscripten_get_progname,
  /** @export */ D: __emscripten_runtime_keepalive_clear,
  /** @export */ H: __gmtime_js,
  /** @export */ I: __localtime_js,
  /** @export */ J: __mktime_js,
  /** @export */ L: __timegm_js,
  /** @export */ ea: __tzset_js,
  /** @export */ ba: _clock_res_get,
  /** @export */ aa: _clock_time_get,
  /** @export */ $: _emscripten_date_now,
...
var ___wasm_call_ctors = wasmExports["ga"];

var _main = Module["_main"] = wasmExports["ha"];

var _malloc = wasmExports["ja"];

var _fflush = wasmExports["ka"];

var ___funcs_on_exit = wasmExports["la"];

var _htonl = wasmExports["ma"];

var _htons = wasmExports["na"];

var _ntohs = wasmExports["oa"];

var ___trap = wasmExports["pa"];

var __emscripten_stack_alloc = wasmExports["qa"];
