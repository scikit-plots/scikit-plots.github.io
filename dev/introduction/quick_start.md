...
5. ****Display the Plot****:
   Optionally, use [`show`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.pyplot.show.html#matplotlib.pyplot.show "(in Matplotlib v3.12.0.dev272+gfe7830972)") to display the plot.
