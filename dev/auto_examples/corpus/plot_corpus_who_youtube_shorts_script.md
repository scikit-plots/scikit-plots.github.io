...
```
```
2026-04-09 03:43:34.900999: W scikitplot.corpus._base 125265763236736 _base.py:2052:__init_subclass__] DocumentReader: extension '.zip' already registered to ALTOReader; overriding with ZipReader.
...
```
```
<scikitplot.corpus._pipeline.CorpusPipeline object at 0x71ed9114a6d0>
...
corpus WHO European Region local or url per file with examples![](../../_images/sphx_glr_plot_misc_script_thumb.png)
