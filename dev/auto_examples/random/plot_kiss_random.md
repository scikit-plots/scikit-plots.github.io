> **Note**
> [Go to the end](#sphx-glr-download-auto-examples-random-plot-kiss-random-py)
to download the full example code or to run this example in your browser via JupyterLite or Binder.

# Enhanced KISS Random Generator - Complete Usage Examples[#](#enhanced-kiss-random-generator-complete-usage-examples "Link to this heading")
...
{'n': 1000000,
 'repeat': 5,
 'time_min': 0.0037100529998497223,
 'time_mean': 0.0037475135995919118,
 'time_max': 0.0037819539993506623,
 'time_std': 3.163873877068029e-05,
 'output_mean': 0.5000264761740889,
 'output_std': 0.2886354529025341}
Kiss Customized 64
{'n': 1000000,
 'repeat': 5,
 'time_min': 0.010067313000035938,
 'time_mean': 0.010377148600127839,
 'time_max': 0.010882858000513806,
 'time_std': 0.00030515049565478676,
 'output_mean': 0.4994983951235816,
 'output_std': 0.28868033687878636}
Numpy
{'n': 1000000,
 'repeat': 5,
 'time_min': 0.00487961099952372,
 'time_mean': 0.004917783000018971,
 'time_max': 0.004964251999808766,
 'time_std': 3.690191123238498e-05,
 'output_mean': 0.5000264761740889,
 'output_std': 0.2886354529025341}
Kiss Customized 64
{'n': 1000000,
 'repeat': 5,
 'time_min': 0.012658729000577296,
 'time_mean': 0.012786568400224496,
 'time_max': 0.012939535999976215,
 'time_std': 0.00011158259285906482,
 'output_mean': 0.4994983951235816,
 'output_std': 0.28868033687878636}
...
✅ Generator Integration:
  ...
  Normal:   [-0.4538932   0.09784759  0.98530244 -1.20625406  0.38458092]
  Uniform:  [0.12790767 0.28756121 0.40054907 0.37500545 0.80963298]
...
Generator methods:
  random(5):         [0.96284491 0.8110016  0.70639802 0.88591028 0.47916189]
  integers(0, 100):  [64 31 83 58 30]
  normal(0, 1):      [-1.21583301 -0.59701222 -2.54557358 -1.82856164  0.72187619]
  uniform(10, 20):   [14.05897975 10.703745   19.22080962 13.15018803 13.04670269]
  choice(['A','B','C']): ['B' 'B' 'C' 'A' 'A' 'B' 'A' 'A' 'A' 'B']
  Weighted choice A: 48% (✅ expected ~50%)
  shuffle([0..9]):   [0 2 3 4 1 9 7 8 6 5]
...
Usage:
  ...
  Normal:        [ 1.65105291  0.42244439 -0.27256396  0.16929254 -1.41358956]
...
Saved state: {'seed_sequence': 'KissSeedSequence', 'seed_sequence_state': {'seed': 42, 'seed_seq': {'entropy': 42, 'spawn_key': [], 'pool_size': 4, 'n_children_spawned': 0, '__version__': '0.0.0'}}, '__version__': '0.0.0', 'rng_state': {'bit_width': 64, 'x': 14237502790078125302, 'y': 14888234454274755805, 'z': 1970989587196887829, 'c': 231532126746823208}}
Continued:  [1851205573436742921, 1609824349404455259, 16565782244898480756]

Restored sequence: [1851205573436742921, 1609824349404455259, 16565782244898480756, 16994184917449673914, 2016129216417097342]
...
======================================================================
Exponential(scale=2): [0.15015771 1.12341492 2.22110178 0.06438117 0.98857824]
Beta(2, 5):           [0.43373215 0.17951702 0.62230324 0.01899823 0.25648692]
...
```
![Enhanced KISS Random Generator - Statistical Validation, Uniform Distribution, Normal Distribution, Integer Distribution [0, 20), Q-Q Plot (Uniform), Autocorrelation, Serial Independence Test](../../_images/sphx_glr_plot_kiss_random_001.png)
```
======================================================================
12. VISUALIZATION
======================================================================
...
[`Download Jupyter notebook: plot_kiss_random.ipynb`](../../_downloads/ce3f634011a2324c237757c468b6c928/plot_kiss_random.ipynb)

[`Download Python source code: plot_kiss_random.py`](../../_downloads/2117d7c9103999425b903c0e48303995/plot_kiss_random.py)

[`Download zipped: plot_kiss_random.zip`](../../_downloads/f56e2644431a7e13312c23f4103d5489/plot_kiss_random.zip)
...
Memory-Mapping Showcase – Basic / Medium / Advanced![](../../_images/sphx_glr_plot_dummy_code_encoder_thumb.png)
...
Gaussian Mixture Models — AIC, AICc, and BIC Model Selection![](../../_images/sphx_glr_plot_07_cpp_mode_basics_thumb.png)
