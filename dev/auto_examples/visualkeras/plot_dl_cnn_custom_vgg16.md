...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x741d2024dad0>
...
```
<matplotlib.image.AxesImage object at 0x741ccc306610>
...
```
<matplotlib.image.AxesImage object at 0x741ccc7f0650>
...
```
<matplotlib.image.AxesImage object at 0x741ccc23d150>
...
```
<matplotlib.image.AxesImage object at 0x741ccc269450>
...
```
<matplotlib.image.AxesImage object at 0x741ccc131450>
...
```
<matplotlib.image.AxesImage object at 0x741ccc173bd0>
...
****Total running time of the script:**** (0 minutes 14.561 seconds)
