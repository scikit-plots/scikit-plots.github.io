...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x77692cfe0710>
...
```
<matplotlib.image.AxesImage object at 0x776888212780>
...
```
<matplotlib.image.AxesImage object at 0x776888275280>
...
```
<matplotlib.image.AxesImage object at 0x7768882bede0>
...
```
<matplotlib.image.AxesImage object at 0x776888145040>
...
```
<matplotlib.image.AxesImage object at 0x77688816e6f0>
...
```
<matplotlib.image.AxesImage object at 0x7768881f1700>
...
****Total running time of the script:**** (0 minutes 32.653 seconds)
