...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x74f60485f4a0>
...
```
<matplotlib.image.AxesImage object at 0x74f5b8107440>
...
```
<matplotlib.image.AxesImage object at 0x74f5b81570e0>
...
```
<matplotlib.image.AxesImage object at 0x74f5b81ca810>
...
```
<matplotlib.image.AxesImage object at 0x74f5b800aff0>
...
```
<matplotlib.image.AxesImage object at 0x74f5b8098260>
...
```
<matplotlib.image.AxesImage object at 0x74f5b80f03e0>
...
****Total running time of the script:**** (0 minutes 29.787 seconds)
