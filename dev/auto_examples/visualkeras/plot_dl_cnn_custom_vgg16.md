...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x7e4dc013f3d0>
...
```
<matplotlib.image.AxesImage object at 0x7e4db8534ed0>
...
```
<matplotlib.image.AxesImage object at 0x7e4db8546410>
...
```
<matplotlib.image.AxesImage object at 0x7e4dc969b810>
...
```
<matplotlib.image.AxesImage object at 0x7e4db8184b50>
...
```
<matplotlib.image.AxesImage object at 0x7e4db81f9450>
...
```
<matplotlib.image.AxesImage object at 0x7e4db8052ad0>
...
****Total running time of the script:**** (0 minutes 15.647 seconds)
