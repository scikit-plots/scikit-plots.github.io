...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x74db64635950>
...
```
<matplotlib.image.AxesImage object at 0x74db643791d0>
...
```
<matplotlib.image.AxesImage object at 0x74db644211d0>
...
```
<matplotlib.image.AxesImage object at 0x74db5c310950>
...
```
<matplotlib.image.AxesImage object at 0x74db5c3211d0>
...
```
<matplotlib.image.AxesImage object at 0x74db5c1f4cd0>
...
```
<matplotlib.image.AxesImage object at 0x74db5c238810>
...
****Total running time of the script:**** (0 minutes 14.586 seconds)
