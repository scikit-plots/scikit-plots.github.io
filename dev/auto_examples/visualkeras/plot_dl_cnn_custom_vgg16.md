...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x735061dab4d0>
...
```
<matplotlib.image.AxesImage object at 0x734fbc20cfe0>
...
```
<matplotlib.image.AxesImage object at 0x734fbc266c30>
...
```
<matplotlib.image.AxesImage object at 0x734fbc2c0a70>
...
```
<matplotlib.image.AxesImage object at 0x734fbc1394c0>
...
```
<matplotlib.image.AxesImage object at 0x734fbc1894c0>
...
```
<matplotlib.image.AxesImage object at 0x734fbc1e8290>
...
****Total running time of the script:**** (0 minutes 27.005 seconds)
