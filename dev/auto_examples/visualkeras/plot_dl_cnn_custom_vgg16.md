...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x7351644e5210>
...
```
<matplotlib.image.AxesImage object at 0x735154483fd0>
...
```
<matplotlib.image.AxesImage object at 0x7351544f7710>
...
```
<matplotlib.image.AxesImage object at 0x73515453f290>
...
```
<matplotlib.image.AxesImage object at 0x7351540b4690>
...
```
<matplotlib.image.AxesImage object at 0x7351540ef210>
...
```
<matplotlib.image.AxesImage object at 0x73514c2cb550>
...
****Total running time of the script:**** (0 minutes 16.869 seconds)
