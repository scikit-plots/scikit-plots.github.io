...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x7660d014a4e0>
...
```
<matplotlib.image.AxesImage object at 0x76627d649340>
...
```
<matplotlib.image.AxesImage object at 0x7660d03b04a0>
...
```
<matplotlib.image.AxesImage object at 0x7661842a0110>
...
```
<matplotlib.image.AxesImage object at 0x7660d01161e0>
...
```
<matplotlib.image.AxesImage object at 0x7660d03bea50>
...
```
<matplotlib.image.AxesImage object at 0x76618411bfe0>
...
```
<matplotlib.image.AxesImage object at 0x76618409b500>
...
****Total running time of the script:**** (0 minutes 21.553 seconds)
