...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x73927004eab0>
...
```
<matplotlib.image.AxesImage object at 0x7393181e1520>
...
```
<matplotlib.image.AxesImage object at 0x7392702b8fb0>
...
```
<matplotlib.image.AxesImage object at 0x739270222de0>
...
```
<matplotlib.image.AxesImage object at 0x73927029a840>
...
```
<matplotlib.image.AxesImage object at 0x73927016ef60>
...
```
<matplotlib.image.AxesImage object at 0x7392701ed5e0>
...
```
<matplotlib.image.AxesImage object at 0x7393041ca090>
...
****Total running time of the script:**** (0 minutes 23.050 seconds)
