...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x7b3bde713e90>
...
```
<matplotlib.image.AxesImage object at 0x7b3a2c24e9d0>
...
```
<matplotlib.image.AxesImage object at 0x7b3ab40e5fd0>
...
```
<matplotlib.image.AxesImage object at 0x7b3a2c2474d0>
...
```
<matplotlib.image.AxesImage object at 0x7b3a2c177210>
...
```
<matplotlib.image.AxesImage object at 0x7b3a2c707150>
...
```
<matplotlib.image.AxesImage object at 0x7b3a2c70f210>
...
```
<matplotlib.image.AxesImage object at 0x7b3a9c777150>
...
****Total running time of the script:**** (0 minutes 23.948 seconds)
