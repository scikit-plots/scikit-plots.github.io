...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x734fbc1ae030>
...
```
<matplotlib.image.AxesImage object at 0x734fbc2c0500>
...
```
<matplotlib.image.AxesImage object at 0x734fbc3fa420>
...
```
<matplotlib.image.AxesImage object at 0x734fbc2e33e0>
...
```
<matplotlib.image.AxesImage object at 0x735060424b60>
...
```
<matplotlib.image.AxesImage object at 0x734fbc0082c0>
...
```
<matplotlib.image.AxesImage object at 0x7350602775c0>
...
```
<matplotlib.image.AxesImage object at 0x73506022dcd0>
...
****Total running time of the script:**** (0 minutes 21.586 seconds)
