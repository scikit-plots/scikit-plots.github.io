...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x70cac074fe90>
...
```
<matplotlib.image.AxesImage object at 0x70cac028ca10>
...
```
<matplotlib.image.AxesImage object at 0x70cac018ca10>
...
```
<matplotlib.image.AxesImage object at 0x70caa4393350>
...
```
<matplotlib.image.AxesImage object at 0x70caa426f9d0>
...
```
<matplotlib.image.AxesImage object at 0x70caa42b3990>
...
```
<matplotlib.image.AxesImage object at 0x70caa4133f50>
...
```
<matplotlib.image.AxesImage object at 0x70caa41a6450>
...
****Total running time of the script:**** (0 minutes 13.589 seconds)
