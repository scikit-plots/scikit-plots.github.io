...
```
[INFO] Saving path to: /home/circleci/repo/galleries/examples/visualkeras/result_images/vgg19_20260823_185220Z.png

<matplotlib.image.AxesImage object at 0x7768882591c0>
...
****Total running time of the script:**** (0 minutes 30.229 seconds)
...
visualkeras: EfficientNetV2 example![](../../_images/sphx_glr_plot_dl_nlp_vector_index_db_thumb.png)

[visualkeras: Vector Index DB](plot_dl_nlp_vector_index_db.html)

visualkeras: Vector Index DB![](../../_images/sphx_glr_plot_dl_ann_dense_thumb.png)
