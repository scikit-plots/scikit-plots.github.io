...
```
```
2026/08/23 18:49:03 INFO mlflow.tracking.fluent: Experiment with name 'my-first-project' does not exist. Creating a new experiment.
🏃 View run train at: http://127.0.0.1:8891/#/experiments/1/runs/68632e56465943aaba17110438d97744
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
🏃 View run predict at: http://127.0.0.1:8891/#/experiments/1/runs/8365846dafbb473eb46bc7f5ea134aea
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
...
```
```
🏃 View run train at: http://127.0.0.1:8891/#/experiments/1/runs/5a8453d597ff4efabd30714a4eafaf5f
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
Open MLflow UI: http://127.0.0.1:8891
🏃 View run predict at: http://127.0.0.1:8891/#/experiments/1/runs/a07383dac13f4366af03bf701341cdea
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
...
Cython: Realtime compile\_and\_load (.pyx)![](../../_images/sphx_glr_plot_corpus_fluent_corpus_script_thumb.png)
