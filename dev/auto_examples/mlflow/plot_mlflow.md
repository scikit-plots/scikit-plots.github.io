...
```
```
2026/07/30 02:41:13 INFO mlflow.tracking.fluent: Experiment with name 'my-first-project' does not exist. Creating a new experiment.
🏃 View run train at: http://127.0.0.1:8891/#/experiments/1/runs/353e8ae8135f4f9d8e659e64574a8919
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
🏃 View run predict at: http://127.0.0.1:8891/#/experiments/1/runs/cac4e6a7d6df4e3494e379d647d19293
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
...
```
```
🏃 View run train at: http://127.0.0.1:8891/#/experiments/1/runs/4f29683dbc704c41933d9f5a0478895d
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
Open MLflow UI: http://127.0.0.1:8891
🏃 View run predict at: http://127.0.0.1:8891/#/experiments/1/runs/a05c025f5e5a4e8d85406a5700f60c9d
🧪 View experiment at: http://127.0.0.1:8891/#/experiments/1
...
****Total running time of the script:**** (1 minutes 20.464 seconds)
