...
Copied workflow to: tmpjp1jzqhb/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmpjp1jzqhb/workflow_copy/cli.py train --help
  python tmpjp1jzqhb/workflow_copy/cli.py hpo --help
  python tmpjp1jzqhb/workflow_copy/cli.py predict --help
