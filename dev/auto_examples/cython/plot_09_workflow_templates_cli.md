...
Copied workflow to: tmpulvka7bf/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmpulvka7bf/workflow_copy/cli.py train --help
  python tmpulvka7bf/workflow_copy/cli.py hpo --help
  python tmpulvka7bf/workflow_copy/cli.py predict --help
