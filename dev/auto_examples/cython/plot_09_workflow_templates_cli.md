...
Copied workflow to: tmphulhxtnq/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmphulhxtnq/workflow_copy/cli.py train --help
  python tmphulhxtnq/workflow_copy/cli.py hpo --help
  python tmphulhxtnq/workflow_copy/cli.py predict --help
