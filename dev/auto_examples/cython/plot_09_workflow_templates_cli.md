...
Copied workflow to: tmplov6eiqt/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmplov6eiqt/workflow_copy/cli.py train --help
  python tmplov6eiqt/workflow_copy/cli.py hpo --help
  python tmplov6eiqt/workflow_copy/cli.py predict --help
