...
Copied workflow to: tmphi6u_kvn/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmphi6u_kvn/workflow_copy/cli.py train --help
  python tmphi6u_kvn/workflow_copy/cli.py hpo --help
  python tmphi6u_kvn/workflow_copy/cli.py predict --help
