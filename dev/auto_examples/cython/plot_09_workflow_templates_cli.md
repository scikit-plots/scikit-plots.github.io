...
Copied workflow to: tmpyf8jl1r1/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmpyf8jl1r1/workflow_copy/cli.py train --help
  python tmpyf8jl1r1/workflow_copy/cli.py hpo --help
  python tmpyf8jl1r1/workflow_copy/cli.py predict --help
