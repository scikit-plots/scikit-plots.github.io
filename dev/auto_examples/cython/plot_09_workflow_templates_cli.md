...
Copied workflow to: tmp20bk_g_x/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmp20bk_g_x/workflow_copy/cli.py train --help
  python tmp20bk_g_x/workflow_copy/cli.py hpo --help
  python tmp20bk_g_x/workflow_copy/cli.py predict --help
