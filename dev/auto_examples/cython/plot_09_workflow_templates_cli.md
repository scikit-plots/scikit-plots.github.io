...
Copied workflow to: tmpt5t8yo5s/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmpt5t8yo5s/workflow_copy/cli.py train --help
  python tmpt5t8yo5s/workflow_copy/cli.py hpo --help
  python tmpt5t8yo5s/workflow_copy/cli.py predict --help
