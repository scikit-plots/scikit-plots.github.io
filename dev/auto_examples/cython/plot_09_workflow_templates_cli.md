...
Copied workflow to: tmpuha6yeaq/workflow_copy
Files: ['cli.py', 'hpo.py', 'predict.py', 'train.py']

Run:
  python tmpuha6yeaq/workflow_copy/cli.py train --help
  python tmpuha6yeaq/workflow_copy/cli.py hpo --help
  python tmpuha6yeaq/workflow_copy/cli.py predict --help
