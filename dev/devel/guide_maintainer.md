# Maintainer Guidelines[#](#maintainer-guidelines "Link to this heading")
...
bug-fix release. We follow [PEP440](https://www.python.org/dev/peps/pep-0440/) for
...
### Reference Steps[#](#reference-steps "Link to this heading")
...
* Trigger the wheel builder with the `[cd build]` commit marker. See also the
  [workflow runs of the wheel builder](https://github.com/scikit-learn/scikit-learn/actions/workflows/wheels.yml).
  ...
  ```
  > **Note**
  > The acronym CD in `[cd build]` stands for [Continuous Delivery](https://en.wikipedia.org/wiki/Continuous_delivery) and refers to the
...
* Once all the CD jobs have completed successfully in the PR, merge it with the
  ...
  workflow” form for the [PyPI publishing workflow](https://github.com/scikit-learn/scikit-learn/actions/workflows/publish_pypi.yml).
...
* Trigger the [PyPI publishing workflow](https://github.com/scikit-learn/scikit-learn/actions/workflows/publish_pypi.yml)
  ...
  ****Alternatively****, it is possible to collect locally the generated binary wheel
  ...
  Uploading artifacts from local[#](#uploading-artifacts-from-local "Link to this dropdown")
  ...
  area on the anaconda.org hosting service](https://anaconda.org/scikit-learn-wheels-staging/scikit-learn/files) and put
...
* Trigger the [PyPI publishing workflow](https://github.com/scikit-learn/scikit-learn/actions/workflows/publish_pypi.yml)
  ...
  ****Alternatively****, it is possible to collect locally the generated binary wheel
  ...
  Uploading artifacts from local[#](#uploading-artifacts-from-local-2 "Link to this dropdown")
...
* Trigger the [PyPI publishing workflow](https://github.com/scikit-learn/scikit-learn/actions/workflows/publish_pypi.yml)
  ...
  ****Alternatively****, it is possible to collect locally the generated binary wheel
  ...
  Uploading artifacts from local[#](#uploading-artifacts-from-local-3 "Link to this dropdown")
...
## Merging Pull Requests[#](#merging-pull-requests "Link to this heading")
...
* For PRs with multiple code contributors, care must be taken to keep the
  ...
  mark the PR as having [multiple co-authors](https://help.github.com/en/github/committing-changes-to-your-project/creating-a-commit-with-multiple-authors).
...
## The `scikit-plots.github.io` Website[#](#the-scikit-plots-github-io-website "Link to this heading")
...
To create an experimental module, refer to the contents of [enable\_halving\_search\_cv.py](https://github.com/scikit-learn/scikit-learn/blob/362cb92bb2f5b878229ea4f59519ad31c2fcee76/sklearn/experimental/enable_halving_search_cv.py),
or [enable\_iterative\_imputer.py](https://github.com/scikit-learn/scikit-learn/blob/c9c89cfc85dd8dfefd7921c16c87327d03140a06/sklearn/experimental/enable_iterative_imputer.py).
...
See [sklearn/ensemble/\_\_init\_\_.py](https://github.com/scikit-learn/scikit-learn/blob/c9c89cfc85dd8dfefd7921c16c87327d03140a06/sklearn/ensemble/__init__.py),
or [sklearn/impute/\_\_init\_\_.py](https://github.com/scikit-learn/scikit-learn/blob/c9c89cfc85dd8dfefd7921c16c87327d03140a06/sklearn/impute/__init__.py)
for an example. Please also write basic tests following those in
[test\_enable\_hist\_gradient\_boosting.py](https://github.com/scikit-learn/scikit-learn/blob/c9c89cfc85dd8dfefd7921c16c87327d03140a06/sklearn/experimental/tests/test_enable_hist_gradient_boosting.py).
...
[enable\_hist\_gradient\_boosting.py](https://github.com/scikit-learn/scikit-learn/blob/main/sklearn/experimental/enable_hist_gradient_boosting.py).
...
tests accordingly, see [test\_enable\_hist\_gradient\_boosting.py](https://github.com/scikit-learn/scikit-learn/blob/main/sklearn/experimental/tests/test_enable_hist_gradient_boosting.py).