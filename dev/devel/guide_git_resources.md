# Git Resources Guidelines[#](#git-resources-guidelines "Link to this heading")
...
minutes to look at Git Basics, part of a much longer [git book](https://git-scm.com/book/).

## Essential [git](https://git-scm.com/) commands[#](#essential-git-commands "Link to this heading")

Here are a few `git` commands you are likely to encounter in contributing
to Astropy. In general if you google “git <command>” you will get the appropriate documentation page from [git-scm.com](https://git-scm.com/docs).
...
* `git add` stages files you have changed or created for addition to [git](https://git-scm.com/).
...
easier.
You might find this
[list of GUI Clients](https://git-scm.com/downloads/guis/) to be helpful.
You may also consider using an Interactive Development
Environment (IDE) like [PyCharm](https://www.jetbrains.com/pycharm/) or [Visual Studio Code](https://code.visualstudio.com/). Both of these IDEs have
built-in Git support.

## If something goes wrong[#](#if-something-goes-wrong "Link to this heading")

[git](https://git-scm.com/) provides a number of ways to recover from errors. If you end up making a
[git](https://git-scm.com/) mistake, do not hesitate to ask for help. An additional resource that
walks you through recovering from [git](https://git-scm.com/) mistakes is the
[git choose-your-own-adventure](http://sethrobertson.github.io/GitFixUm/fixup.html).

## Tutorials and summaries[#](#tutorials-and-summaries "Link to this heading")

* [GitHub Help](https://help.github.com/) has an excellent series of how-to guides.
* [learn.github](https://services.github.com/) has an excellent series of tutorials
* The [pro git book](https://git-scm.com/book) is a good in-depth book on git.
* A [git cheat sheet](https://www.atlassian.com/git/tutorials/atlassian-git-cheatsheet) is a page giving summaries of common commands.
* The [git user manual](http://schacon.github.io/git/user-manual.html)
* The [git tutorial](http://schacon.github.io/git/gittutorial.html)
* The [git community book](https://book.git-scm.com/)
* [git casts](https://services.github.com/) — video snippets giving git how-tos.
* The [git parable](https://tom.preston-werner.com/2009/05/19/the-git-parable.html) is an easy read explaining the concepts behind git.
* [git foundation](http://matthew-brett.github.io/pydagogue/foundation.html) expands on the [git parable](https://tom.preston-werner.com/2009/05/19/the-git-parable.html).
* Fernando Perez’s [ipython notebook on using git in science](https://nbviewer.jupyter.org/github/fperez/reprosw/blob/master/Version%20Control.ipynb)
* A good but technical page on [git concepts](https://www.sbf5.com/~cduan/technical/git/)

## Additional Tips and Tricks[#](#additional-tips-and-tricks "Link to this heading")

### About Names in [git](https://git-scm.com/)[#](#about-names-in-git "Link to this heading")

> **Important**
> tl;dr: Never work in your main branch, always work in a feature branch.

[git](https://git-scm.com/) is a **distributed** version control system. Each clone of
...
The naming scheme used by [git](https://git-scm.com/) will also be used here. A plain branch name,
...
### Delete a branch on GitHub[#](#delete-a-branch-on-github "Link to this heading")

[git](https://git-scm.com/) strongly encourages making a new branch each time you make a change in the
...
deleting a branch](https://help.github.com/en/articles/creating-and-deleting-branches-within-your-repository)
if you want to delete the GitHub copy through GitHub.

### Several people sharing a single repository[#](#several-people-sharing-a-single-repository "Link to this heading")

If you want to work on some stuff with other people, where you are all
committing into the same repository, or even the same branch, then just
share it via GitHub.

First fork Astropy into your account, as from [Create a fork of pandas](https://pandas.pydata.org/docs/dev/development/contributing.html#contributing-forking "(in pandas v3.1.0.dev0+1654.g328bd893b5)").
...
### Explore your repository[#](#explore-your-repository "Link to this heading")
...
You can also look at the [network graph visualizer](https://github.blog/2008-04-10-say-hello-to-the-network-graph-visualizer/) for your GitHub
repo.

### Rebasing on main[#](#rebasing-on-main "Link to this heading")

Let’s say you thought of some work you’d like to do. You
`git fetch upstream --tags` and [Make a new feature branch](guide_devel_workflow.html#make-feature-branch) called
...
See [rebase without tears](http://matthew-brett.github.io/pydagogue/rebase_without_tears.html) for more detail.
...
merge](http://schacon.github.io/git/user-manual.html#resolving-a-merge).
...
### Recovering from mess-ups[#](#recovering-from-mess-ups "Link to this heading")
...
### Rewriting commit history[#](#rewriting-commit-history "Link to this heading")
...
### Git mailmap[#](#git-mailmap "Link to this heading")

If you need to edit [.mailmap](https://git-scm.com/docs/gitmailmap) and know how to do
it then you can open a pull request for that. Please run [git shortlog -es](https://git-scm.com/docs/git-shortlog) locally first with your changes to make sure
