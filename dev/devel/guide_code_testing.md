# Code Testing Guidelines[#](#code-testing-guidelines "Link to this heading")
...
testing infrastructure are in [`matplotlib.testing`](https://matplotlib.org/devdocs/api/testing_api.html#module-matplotlib.testing "(in Matplotlib v3.11.0.dev2354+gea362ab57)").
...
particular the [additional dependencies](../install/dependencies.html#test-dependencies) for testing.
...
[additional dependencies](../install/dependencies.html#test-dependencies) for testing.
...
`pytest` can be configured via many [command-line parameters](https://pytest.org/en/stable/how-to/usage.html "(in pytest v9.0.3)").
...
* On more recent Python, you may [`disable "unsafe import paths"`](https://docs.python.org/3/using/cmdline.html#cmdoption-P "(in Python v3.14)")
  ...
  ```
* On older Python, you may enable [`isolated mode`](https://docs.python.org/3/using/cmdline.html#cmdoption-I "(in Python v3.14)")
  ...
  ```
* On any Python, set `pytest`’s [import mode](https://pytest.org/en/stable/explanation/pythonpath.html "(in pytest v9.0.3)")
...
### Viewing image test output[#](#viewing-image-test-output "Link to this heading")

The output of [image-based](#image-comparison) tests is stored in a
...
[QT](../install/dependencies.html#backend-dependencies) is installed.

## Writing a simple test[#](#writing-a-simple-test "Link to this heading")

Many elements of Matplotlib can be tested using standard tests. For
example, here is a test from `matplotlib/tests/test_basic.py`:
...
## Random data in tests[#](#random-data-in-tests "Link to this heading")
...
The seed is [John Hunter’s](../project/history.html#project-history) birthday.

## Writing an image comparison test[#](#writing-an-image-comparison-test "Link to this heading")
...
subdirectory of `baseline_images` tree in the source directory (in this
case `lib/matplotlib/tests/baseline_images/test_lines`). Put this new
...
### Compare two methods of creating an image[#](#compare-two-methods-of-creating-an-image "Link to this heading")
...
## Creating a new module in matplotlib.tests[#](#creating-a-new-module-in-matplotlib-tests "Link to this heading")
...
## Using GitHub Actions for CI[#](#using-github-actions-for-ci "Link to this heading")

[GitHub Actions](https://docs.github.com/en/actions) is a hosted CI system
“in the cloud”.
...
GitHub Actions is already enabled for the [main Matplotlib GitHub repository](https://github.com/matplotlib/matplotlib/) – for example, see [the Tests
...
Configuration Specification](https://tox.readthedocs.io/en/latest/config.html).

## Building old versions of Matplotlib[#](#building-old-versions-of-matplotlib "Link to this heading")
...
## Testing released versions of Matplotlib[#](#testing-released-versions-of-matplotlib "Link to this heading")
...
### Install additional dependencies[#](#install-additional-dependencies "Link to this heading")

Install the [additional dependencies for testing](../install/dependencies.html#test-dependencies).

### Obtain the reference images[#](#obtain-the-reference-images "Link to this heading")
...
`matplotlib-X.Y.Z.tar.gz` from [PyPI](https://pypi.org/project/matplotlib/)
or alternatively, clone the git repository and `git checkout vX.Y.Z`. Copy
the folder `lib/matplotlib/tests/baseline_images` to the folder
...
### Run the tests[#](#run-the-tests "Link to this heading")
