...
* [API guidelines](https://matplotlib.org/devdocs/devel/api_changes.html#api-changes "(in Matplotlib v3.11.0.dev2342+g106899233)")
...
* Fix a typo
* Clarify a docstring
* Write or update an [example plot](https://matplotlib.org/devdocs/gallery/index.html#gallery "(in Matplotlib v3.11.0.dev2342+g106899233)")
* Write or update a comprehensive [tutorial](https://matplotlib.org/devdocs/tutorials/index.html#tutorials "(in Matplotlib v3.11.0.dev2342+g106899233)")
...
* matplotlib.org homepage: [matplotlib/mpl-brochure-site](https://github.com/matplotlib/mpl-brochure-site)
* cheat sheets: [matplotlib/cheatsheets](https://github.com/matplotlib/cheatsheets)
* third party packages: [matplotlib/mpl-third-party](https://github.com/matplotlib/mpl-third-party)
...
see our [Community management guide](https://matplotlib.org/devdocs/devel/communication_guide.html#communications-guidelines "(in Matplotlib v3.11.0.dev2342+g106899233)").
...
where things are. You can reach out on any of our [Official project platforms](https://matplotlib.org/devdocs/devel/communication_guide.html#communication-channels "(in Matplotlib v3.11.0.dev2342+g106899233)").
