...
> **See also**
> * For more information about contributing, see the [Write documentation](https://matplotlib.org/devdocs/devel/document.html#documenting-matplotlib "(in Matplotlib v3.11.0.dev2332+gb07211fda)") section.
...
| --- | --- | --- | --- |
| [`Figure`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.figure.Figure.html#matplotlib.figure.Figure "(in Matplotlib v3.11.0.dev2332+gb07211fda)") | Matplotlib working space for programming. | * **For   Matplotlib   objects**:   Figure,   “The Figure   is the   working   space for   the visual. * **Referring   to class**:   [`Figure`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.figure.Figure.html#matplotlib.figure.Figure "(in Matplotlib v3.11.0.dev2332+gb07211fda)"),   “Methods   within the   [`Figure`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.figure.Figure.html#matplotlib.figure.Figure "(in Matplotlib v3.11.0.dev2332+gb07211fda)")   provide the   visuals.” * **General   language**:   figure,   “Michelle   Kwan is a   famous   figure   skater.” | * “The figure   is the   working   space for   visuals.” * “Methods in   the figure   provide the   visuals.” * “The   [`Figure`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.figure.Figure.html#matplotlib.figure.Figure "(in Matplotlib v3.11.0.dev2332+gb07211fda)")   Four   leglock is   a wrestling   move.” |
| [`Axes`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.axes.Axes.html#matplotlib.axes.Axes "(in Matplotlib v3.11.0.dev2332+gb07211fda)") | Subplots within Figure. Contains plot elements and is responsible for plotting and configuring additional details. | * **For   Matplotlib   objects**:   Axes, “An   Axes is a   subplot   within the   Figure.” * **Referring   to class**:   [`Axes`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.axes.Axes.html#matplotlib.axes.Axes "(in Matplotlib v3.11.0.dev2332+gb07211fda)"),   “Each   [`Axes`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.axes.Axes.html#matplotlib.axes.Axes "(in Matplotlib v3.11.0.dev2332+gb07211fda)") is   specific to   one   Figure.” * **General   language**:   axes, “Both   loggers and   lumberjacks   use axes to   chop wood.”   OR “There   are no   standard   names for   the   coordinates   in the   three   axes.”   (Plural of   axis) | * “The axes   methods   transform   the data.” * “Each   [`Axes`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.axes.Axes.html#matplotlib.axes.Axes "(in Matplotlib v3.11.0.dev2332+gb07211fda)") is   specific to   a Figure.” * “The   musicians   on stage   call their   guitars   Axes.” * “The point   where the   Axes meet   is the   origin of   the   coordinate   system.” |
| [`Artist`](https://matplotlib.org/devdocs/api/artist_api.html#matplotlib.artist.Artist "(in Matplotlib v3.11.0.dev2332+gb07211fda)") | Broad variety of Matplotlib objects that display visuals. | * **For   Matplotlib   objects**:   Artist,   “Artists   display   visuals and   are the   visible   elements   when   rendering a   Figure.” * **Referring   to class**:   [`Artist`](https://matplotlib.org/devdocs/api/artist_api.html#matplotlib.artist.Artist "(in Matplotlib v3.11.0.dev2332+gb07211fda)") ,   “Each   [`Artist`](https://matplotlib.org/devdocs/api/artist_api.html#matplotlib.artist.Artist "(in Matplotlib v3.11.0.dev2332+gb07211fda)")   has   respective   methods and   functions.” * **General   language**:   artist,   “The   artist in   the museum   is from   France.” | * “Configure   the legend   artist with   its   respective   method.” * “There is   an   [`Artist`](https://matplotlib.org/devdocs/api/artist_api.html#matplotlib.artist.Artist "(in Matplotlib v3.11.0.dev2332+gb07211fda)")   for that   visual in   the graph.” * “Some   Artists   became   famous only   by   accident.” |
| [`Axis`](https://matplotlib.org/devdocs/api/axis_api.html#matplotlib.axis.Axis "(in Matplotlib v3.11.0.dev2332+gb07211fda)") | Human-readable single dimensional object of reference marks containing ticks, tick labels, spines, and edges. | * **For   Matplotlib   objects**:   Axis, “The   Axis for   the bar   chart is a   separate   Artist.”   (plural,   Axis   objects) * **Referring   to class**:   [`Axis`](https://matplotlib.org/devdocs/api/axis_api.html#matplotlib.axis.Axis "(in Matplotlib v3.11.0.dev2332+gb07211fda)"),   “The   [`Axis`](https://matplotlib.org/devdocs/api/axis_api.html#matplotlib.axis.Axis "(in Matplotlib v3.11.0.dev2332+gb07211fda)")   contains   respective   XAxis and   YAxis   objects.” * **General   language**:   axis,   “Rotation   around a   fixed axis   is a   special   case of   rotational   motion.” | * “Plot the   graph onto   the axis.” * “Each Axis   is usually   named after   the   coordinate   which is   measured   along it.” * “In some   computer   graphics   contexts,   the   ordinate   [`Axis`](https://matplotlib.org/devdocs/api/axis_api.html#matplotlib.axis.Axis "(in Matplotlib v3.11.0.dev2332+gb07211fda)") may   be oriented   downwards.” |
