...
Matplotilb [MEP’s](https://matplotlib.org/devdocs/devel/MEP/index.html)
and cpython’s [PEP’s](https://www.python.org/dev/peps/) but less formal,
...
[the template](template.html#spep-template) to this the SPEP directory. For the
...
* [SPEP Template](template.html)

Accepted

* [SPEP000: SPEP and its workflow](spep000/proposal.html)
