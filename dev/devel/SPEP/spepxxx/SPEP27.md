# SEP27: Decouple pyplot from backends[#](#sep27-decouple-pyplot-from-backends "Link to this heading")
...
* [https://github.com/OceanWolf/matplotlib/compare/backend-refactor…OceanWolf:backend-refactor-tkagg](https://github.com/OceanWolf/matplotlib/compare/backend-refactor...OceanWolf:backend-refactor-tkagg)
* [https://github.com/OceanWolf/matplotlib/compare/backend-refactor…OceanWolf:backend-refactor-qt](https://github.com/OceanWolf/matplotlib/compare/backend-refactor...OceanWolf:backend-refactor-qt)
* [https://github.com/OceanWolf/matplotlib/compare/backend-refactor…backend-refactor-wx](https://github.com/OceanWolf/matplotlib/compare/backend-refactor...backend-refactor-wx)
...
1. To remove the windowing aspect out of `FigureManagerBase` letting
   ...
   functionality, with pass-through methods (:arrow\_right:) to
...
## [Future compatibility](#id6)[#](#future-compatibility "Link to this heading")
...
## [Questions](#id9)[#](#questions "Link to this heading")
