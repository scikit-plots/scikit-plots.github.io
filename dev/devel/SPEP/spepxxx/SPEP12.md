# SEP12: Improve Gallery and Examples[#](#sep12-improve-gallery-and-examples "Link to this heading")

> **Template**
> Template for further usage, template belong to matplotlib MEPs.

## [Status](#id7)[#](#status "Link to this heading")
...
been converted over to use [`matplotlib.pyplot`](https://matplotlib.org/devdocs/api/pyplot_summary.html#module-matplotlib.pyplot "(in Matplotlib v3.11.0.dev2342+g106899233)") and `numpy`.
...
## [Abstract](#id9)[#](#abstract "Link to this heading")
...
## [Detailed description](#id10)[#](#detailed-description "Link to this heading")

The matplotlib gallery was recently set up to split examples up into
sections. As discussed in that PR [[1]](#id6), the current example sections
...
## [Implementation](#id11)[#](#implementation "Link to this heading")
...
### [Gallery sections](#id12)[#](#gallery-sections "Link to this heading")
...
* [sphinx-gallery docstrings](https://sphinx-gallery.readthedocs.io/en/latest/):
  ...
  ```
* [PEP8](https://peps.python.org/pep-0008/) clean-ups (running [flake8](https://pypi.org/project/flake8/), or a similar checker, is
  highly recommended)
* Commented-out code should be removed.
* Replace uses of `pylab` interface with `.pyplot` (+ `numpy`,
  etc.). See [c25ef1e](https://github.com/tonysyu/matplotlib/commit/c25ef1e02b3a0ecb279492409dac0de9b3d2c0e2)
...
* Each example should focus on a specific feature (excluding
  ...
  and [1458aa8](https://github.com/tonysyu/matplotlib/commit/1458aa87c5eae9dd99e141956a6adf7a0f3c6707)
...
plots. Use your favorite search tool (e.g., grep, ack, [grin](https://pypi.org/project/grin/), [pss](https://pypi.org/project/pss/)) to search the matplotlib
package. See [2dc9a46](https://github.com/tonysyu/matplotlib/commit/2dc9a4651e5e566afc0866c603aa8d06aaf32b71)
and [aa6b410](https://github.com/tonysyu/matplotlib/commit/aa6b410f9fa085ccf5f4f962a6f26af5beeae7af)

#### [Additional suggestions](#id14)[#](#additional-suggestions "Link to this heading")

* Provide links (both ways) between examples and API docs for the
  methods/objects used. (issue [#2222](https://github.com/matplotlib/matplotlib/issues/2222))
...
* Split up examples that try to do too much. See [5099675](https://github.com/tonysyu/matplotlib/commit/509967518ce5ce5ba31edf12486ffaa344e748f2)
  and [fc2ab07](https://github.com/tonysyu/matplotlib/commit/fc2ab07cc586abba4c024d8c0d841c4357a3936f)
...
## [Backward compatibility](#id15)[#](#backward-compatibility "Link to this heading")

The website for each Matplotlib version is readily accessible, so
users who want to refer to old examples can still do so.

## [Alternatives](#id16)[#](#alternatives "Link to this heading")

### [Tags](#id17)[#](#tags "Link to this heading")
...
[matplotlib/matplotlib#714](https://github.com/matplotlib/matplotlib/pull/714)