...
been converted over to use [`matplotlib.pyplot`](https://matplotlib.org/devdocs/api/pyplot_summary.html#module-matplotlib.pyplot "(in Matplotlib v3.12.0.dev348+gbde111fb4)") and `numpy`.
