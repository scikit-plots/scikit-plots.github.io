...
been converted over to use [`matplotlib.pyplot`](https://matplotlib.org/devdocs/api/pyplot_summary.html#module-matplotlib.pyplot "(in Matplotlib v3.12.0.dev324+g9cc14f1ab)") and `numpy`.
