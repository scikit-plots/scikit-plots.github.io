# Community Management Guidelines[#](#community-management-guidelines "Link to this heading")
...
Our approach to community engagement is foremost guided by our [Mission Statement](../project/mission.html#mission-statement):
...
## Official communication channels[#](#official-communication-channels "Link to this heading")
...
### Social media[#](#social-media "Link to this heading")

#### Active social media[#](#active-social-media "Link to this heading")

* <https://twitter.com/matplotlib>
* <https://instagram.com/matplotart/>

#### Official accounts[#](#official-accounts "Link to this heading")
...
### Mailing lists[#](#mailing-lists "Link to this heading")
...
### Social media coordination[#](#social-media-coordination "Link to this heading")

* Team mailing list: [matplotlib-social@numfocus.org](mailto:matplotlib-social%40numfocus.org)
* Public chat room: <https://matrix.to/#/#matplotlib_community:gitter.im>

### Maintenance[#](#maintenance "Link to this heading")

If you are interested in moderating the chat or forum or accessing the social
media accounts:

* Matplotlib maintainers should reach out to the [community\_manager](https://matplotlib.org/governance/people.html#deputy-project-leads).
* Everyone else should send an email to [matplotlib-social-admin@numfocus.org](mailto:matplotlib-social-admin%40numfocus.org):
...
## Content guidelines[#](#content-guidelines "Link to this heading")
...
guidelines, ask on the [Social media coordination](#social-media-coordination) channels before posting.

### General guidelines[#](#general-guidelines "Link to this heading")
...
### Visual media guidelines[#](#visual-media-guidelines "Link to this heading")

Visual media, such as images and videos, must not violate the
[code of conduct](../project/code_of_conduct.html#code-of-conduct), nor any platform’s rules.
Specifically:
...
#### Accessibility[#](#accessibility "Link to this heading")
...
## Social media[#](#social-media-brand "Link to this heading")
...
While the [brand identity](#social-media-brand) is casual, the showcased
...
### Persona[#](#persona "Link to this heading")
...
### Behavior[#](#behavior "Link to this heading")

When acting as a representative of the library, keep responses polite and assume
user statements are in good faith unless they violate the [code of conduct](../project/code_of_conduct.html#code-of-conduct).

### Social graph[#](#social-graph "Link to this heading")
...
### Recurring campaigns[#](#recurring-campaigns "Link to this heading")
...
#### Retired campaigns[#](#retired-campaigns "Link to this heading")

* John Hunter Excellence in Plotting, submission and winners

## Changing the guidelines[#](#changing-the-guidelines "Link to this heading")

As the person tasked with implementing these guidelines, the [community\_manager](https://matplotlib.org/governance/people.html#deputy-project-leads)
