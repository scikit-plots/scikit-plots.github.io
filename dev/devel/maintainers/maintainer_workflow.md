# Workflow for Maintainers[#](#workflow-for-maintainers "Link to this heading")
...
in [Development Details Guidelines](../guide_devel_details.html#development-details).

## Integrating changes via the web interface[#](#integrating-changes-via-the-web-interface "Link to this heading")
...
If this is the case and a simple [Github ‘Squash and merge’](#github-squash-and-merge) would do and
you are comfortable with it, use it. Otherwise, you can work with the author,
following instructions at [Squash if necessary](../guide_devel_details.html#squash-if-necessary). If the author is not
responsive or gives consent, you can also [take over the pull request](#maintainer-pr-takeover).
If necessary, you may also [request a rebase](../guide_devel_details.html#rebase).

### Github ‘Squash and merge’[#](#github-squash-and-merge "Link to this heading")
...
Use of the [GitHub ‘Squash and merge’ button](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/incorporating-changes-from-a-pull-request/about-pull-request-merges#squash-and-merge-your-commits)
...
You may use ‘Squash and merge’ in conjunction with [Auto-merge](#maintainer-pr-auto-merge).

### Auto-merge[#](#auto-merge "Link to this heading")
...
## Taking over a pull request[#](#taking-over-a-pull-request "Link to this heading")
...
First, [Create a fork of pandas](https://pandas.pydata.org/docs/dev/development/contributing.html#contributing-forking "(in pandas v3.1.0.dev0+1159.gd7b577e035)").
...
including [How to rebase](../guide_devel_details.html#howto-rebase) and [How to squash](../guide_devel_details.html#howto-squash).

### Check the history[#](#check-the-history "Link to this heading")
...
### Push to back pull request[#](#push-to-back-pull-request "Link to this heading")
...
## Fixing coding style issues[#](#fixing-coding-style-issues "Link to this heading")

Astropy now uses the [pre-commit.ci bot](https://pre-commit.ci/) to assist
with maintaining the astropy coding style and fixing code style
issues. The bot makes use of the pre-commit hook described in detail in [Pre-commit](../guide_devel_details.html#pre-commit).
...
## Using Milestones and Labels[#](#using-milestones-and-labels "Link to this heading")
...
* We have [Rolling reminder: update wcslib and cfitsio and leap second/IERS B table to the latest version](https://github.com/astropy/astropy/issues/9018).
...
## Updating and Maintaining the Changelog[#](#updating-and-maintaining-the-changelog "Link to this heading")

The Astropy “changelog” is managed with
[towncrier](https://pypi.org/project/towncrier/), which is used to generate
...
[docs/changes/README.rst](https://github.com/astropy/astropy/blob/main/docs/changes/README.rst).
...
## Stale Policies[#](#stale-policies "Link to this heading")

The `astropy` GitHub repository has the following stale policies, which are
enforced by [action-astropy-stalebot](https://github.com/pllim/action-astropy-stalebot/)
in [.github/workflows/stalebot.yml](https://github.com/astropy/astropy/blob/main/.github/workflows/stalebot.yml)
