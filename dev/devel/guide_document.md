# Documentation Guidelines[#](#documentation-guidelines "Link to this heading")
...
## Astropy Documentation Overview[#](#astropy-documentation-overview "Link to this heading")

The documentation is written in ****reStructuredText****, which is almost like writing in
plain English, and built using [Sphinx](https://pypi.org/project/Sphinx/). The
Sphinx Documentation has an excellent [introduction to reST](https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html) that you should read.
...
The [OpenAstronomy Packaging Guide](https://packaging-guide.openastronomy.org/en/latest) provides a recommended general structure for
documentation.

## Astropy Documentation Guidelines[#](#astropy-documentation-guidelines "Link to this heading")
...
* References in docstrings, ****including internal Astropy links****, should use the
  [intersphinx format](https://www.sphinx-doc.org/en/master/usage/extensions/intersphinx.html).
...
working in an isolated development environment as described in [Creating a development environment](guide_qu_contribute.html#contributing-environment). The benefit of this method is that often you can
...
The [sphinx-astropy](https://github.com/astropy/sphinx-astropy) package provides
...
* [Sphinx](http://www.sphinx-doc.org) - the main package we use to build
  the documentation
* [astropy-sphinx-theme](https://github.com/astropy/astropy-sphinx-theme) -
  the default ‘bootstrap’ theme used by `astropy` and a number of affiliated
  packages
* [sphinx-automodapi](https://github.com/astropy/sphinx-automodapi) - an extension
  that makes it easy to automatically generate API documentation
* [numpydoc](https://numpydoc.readthedocs.io/en/latest/) - an extension to parse
  docstrings in NumPyDoc format
* [Graphviz](http://www.graphviz.org) - generate inheritance graphs (available
  as a conda package or a system install but not in pip)

> **Note**
> Both of the `pip` install methods above do not include [Graphviz](http://www.graphviz.org). If you do not install this package separately
...
### Reporting Issues/Requesting Features[#](#reporting-issues-requesting-features "Link to this heading")
...
tracker](https://github.com/astropy/astropy/issues). However, if you wish, you
...
* For requests/issues related to the appearance of the docs (e.g. related to
  the CSS), you can open an issue in the [astropy-sphinx-theme issue tracker](https://github.com/astropy/astropy-sphinx-theme/issues).
* For requests/issues related to the auto-generated API docs which appear to
  ...
  the [sphinx-automodapi issue tracker](https://github.com/astropy/sphinx-automodapi/issues).
* For issues related to the default configuration (e.g which extensions are
  enabled by default), you can use the [sphinx-astropy issue tracker](https://github.com/astropy/sphinx-astropy/issues).

## Details for Package Maintainers[#](#details-for-package-maintainers "Link to this heading")
...
### Sphinx Documentation Themes[#](#sphinx-documentation-themes "Link to this heading")

An Astropy Project Sphinx HTML theme is included in the [astropy-sphinx-theme](https://github.com/astropy/astropy-sphinx-theme)
...
sphinx configuration in [sphinx-astropy](https://github.com/astropy/sphinx-astropy), which is imported in the sphinx
...
which are all installed automatically when installing [sphinx-astropy](https://github.com/astropy/sphinx-astropy). These
facilitate easily documenting code in a homogeneous and readable way.

The main extensions used are:

* [sphinx-automodapi](https://github.com/astropy/sphinx-automodapi) - an extension that makes it easy to automatically
  generate API documentation.
* [numpydoc](https://numpydoc.readthedocs.io/en/latest/) - an extension to parse docstrings in NumpyDoc format

In addition, the [sphinx-astropy](https://github.com/astropy/sphinx-astropy) includes a few small extensions:
