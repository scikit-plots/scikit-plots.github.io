...
[What is a backend?](https://matplotlib.org/devdocs/users/explain/figure/backends.html#what-is-a-backend "(in Matplotlib v3.11.0.dev2342+g106899233)") for more details on the optional Matplotlib backends
...
`pip` normally builds packages using [build isolation](https://pip.pypa.io/en/stable/reference/build-system/ "(in pip v26.0)"),
...
[–no-build-isolation](https://pip.pypa.io/en/stable/cli/pip_install/#install-no-build-isolation "(in pip v26.0)") flag
...
[documentation](https://matplotlib.org/devdocs/devel/document.html#documenting-matplotlib "(in Matplotlib v3.11.0.dev2342+g106899233)") are listed in
...
```
# Created at: 2026-04-05 15:41:13.850923
