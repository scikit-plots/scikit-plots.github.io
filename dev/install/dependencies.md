...
[What is a backend?](https://matplotlib.org/devdocs/users/explain/figure/backends.html#what-is-a-backend "(in Matplotlib v3.12.0.dev415+ga888f5e9a)") for more details on the optional Matplotlib backends
...
`pip` normally builds packages using [build isolation](https://pip.pypa.io/en/stable/reference/build-system/ "(in pip v26.2)"),
...
[–no-build-isolation](https://pip.pypa.io/en/stable/cli/pip_install/#install-no-build-isolation "(in pip v26.2)") flag
...
[documentation](https://matplotlib.org/devdocs/devel/document.html#documenting-matplotlib "(in Matplotlib v3.12.0.dev415+ga888f5e9a)") are listed in
...
```
# Created at: 2026-07-29 17:40:28.601458
