# scikitplot.corpus User-Guide Mermaid Diagram Guideline[#](#scikitplot-corpus-user-guide-mermaid-diagram-guideline "Link to this heading")
...
## Core documentation decision[#](#core-documentation-decision "Link to this heading")
...
## Standard fragment template[#](#standard-fragment-template "Link to this heading")
...
## Inclusion pattern[#](#inclusion-pattern "Link to this heading")
...
## Orientation rules[#](#orientation-rules "Link to this heading")
...
## Diagram granularity[#](#diagram-granularity "Link to this heading")
...
## Logical versus physical diagrams[#](#logical-versus-physical-diagrams "Link to this heading")

### Logical diagrams[#](#logical-diagrams "Link to this heading")
...
### Physical diagrams[#](#physical-diagrams "Link to this heading")
...
## Flowchart versus state diagram[#](#flowchart-versus-state-diagram "Link to this heading")
...
## Naming and file layout[#](#naming-and-file-layout "Link to this heading")
...
## Content rules[#](#content-rules "Link to this heading")
...
## Styling and theme safety[#](#styling-and-theme-safety "Link to this heading")
...
## Security and correctness rules[#](#security-and-correctness-rules "Link to this heading")
...
## User-guide page schema[#](#user-guide-page-schema "Link to this heading")
...
## Diagram maintenance contract[#](#diagram-maintenance-contract "Link to this heading")
...
## Included diagram set[#](#included-diagram-set "Link to this heading")
