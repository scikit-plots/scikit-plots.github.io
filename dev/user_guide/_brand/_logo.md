...
> **See also**
> * [`matplotlib.figure.Figure.savefig`](https://matplotlib.org/devdocs/api/_as_gen/matplotlib.figure.Figure.savefig.html#matplotlib.figure.Figure.savefig "(in Matplotlib v3.12.0.dev348+gbde111fb4)")
* `scikitplot._brand._logo.create`
* `scikitplot._brand._logo.save`
* `scikitplot._brand._logo.list_variants`