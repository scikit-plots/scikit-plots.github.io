...
scikitplot.logging.log\_first\_n(**level**, **msg**, **n**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/6d916ad/scikitplot/logging.py#L1656)[#](#scikitplot.logging.log_first_n "Link to this definition")
