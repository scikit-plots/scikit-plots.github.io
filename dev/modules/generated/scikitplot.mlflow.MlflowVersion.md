...
class scikitplot.mlflow.MlflowVersion(**raw=''**, **major=0**, **minor=0**, **patch=0**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/mlflow/_utils.py#L28)[#](#scikitplot.mlflow.MlflowVersion "Link to this definition")
