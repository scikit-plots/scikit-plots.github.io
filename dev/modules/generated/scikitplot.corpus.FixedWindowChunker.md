...
class scikitplot.corpus.FixedWindowChunker(**config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/corpus/_chunkers/_fixed_window.py#L250)[#](#scikitplot.corpus.FixedWindowChunker "Link to this definition")
:   Produce fixed-size sliding-window chunks over a document.
    ...
    chunk(**text**, **doc\_id=None**, **extra\_metadata=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/corpus/_chunkers/_fixed_window.py#L311)[#](#scikitplot.corpus.FixedWindowChunker.chunk "Link to this definition")
    ...
    chunk\_batch(**texts**, **doc\_ids=None**, **extra\_metadata=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/corpus/_chunkers/_fixed_window.py#L390)[#](#scikitplot.corpus.FixedWindowChunker.chunk_batch "Link to this definition")
