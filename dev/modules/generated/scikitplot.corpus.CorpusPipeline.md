...
class scikitplot.corpus.CorpusPipeline(**chunker=None**, **filter\_=None**, **embedding\_engine=None**, **output\_path=None**, **export\_format=ExportFormat.CSV**, **normalizer=None**, **enricher=None**, **default\_language=None**, **progress\_callback=None**, **reader\_kwargs=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_pipeline.py#L147)[#](#scikitplot.corpus.CorpusPipeline "Link to this definition")
:   Orchestrates the full corpus ingestion pipeline.
    ...
    ****Embedding and caching:**** When `embedding_engine` is provided,
    ...
    run(**input\_path**, **\***, **output\_path=None**, **export\_format=None**, **filename\_override=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_pipeline.py#L366)[#](#scikitplot.corpus.CorpusPipeline.run "Link to this definition")
    ...
    run\_batch(**input\_files**, **\***, **stop\_on\_error=False**, **export\_format=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_pipeline.py#L759)[#](#scikitplot.corpus.CorpusPipeline.run_batch "Link to this definition")
    ...
    run\_url(**url**, **\***, **output\_path=None**, **export\_format=None**, **stop\_on\_error=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_pipeline.py#L595)[#](#scikitplot.corpus.CorpusPipeline.run_url "Link to this definition")
