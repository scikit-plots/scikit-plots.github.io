...
class scikitplot.mlflow.ModelsFacade(**mlflow\_module=None**, **client=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/5fb281e/scikitplot/mlflow/_facade.py#L161)[#](#scikitplot.mlflow.ModelsFacade "Link to this definition")
:   Model helper facade bound to a session-bound MLflow client.
    ...
    load\_model(**model\_uri**, **\***, **flavor=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/5fb281e/scikitplot/mlflow/_facade.py#L181)[#](#scikitplot.mlflow.ModelsFacade.load_model "Link to this definition")
    :   Load a model by URI.
    ...
    register\_model(**model\_uri**, **name**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/5fb281e/scikitplot/mlflow/_facade.py#L210)[#](#scikitplot.mlflow.ModelsFacade.register_model "Link to this definition")
