...
scikitplot.corpus.export\_documents(**documents**, **output\_path**, **fmt**, **\***, **include\_embedding=True**, **json\_indent=2**, **parquet\_compression='snappy'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_export/_export.py#L115)[#](#scikitplot.corpus.export_documents "Link to this definition")
