...
scikitplot.mlflow.RELAXED\_SECURITY\_POLICY = SecurityPolicy(allowed\_tracking\_uri\_schemes=frozenset({'mysql', 'http', 'postgresql', 'mssql+pyodbc', 'sqlite', 'postgresql+psycopg2', 'file', 'mysql+pymysql', 'mssql', 'https'}), block\_cloud\_metadata\_hosts=False, allow\_spawn\_server=True, allow\_dev\_mode=True, allow\_disable\_security\_middleware=True, allow\_cors\_wildcard=True, blocked\_env\_key\_prefixes=frozenset(), max\_env\_value\_length=1048576, max\_env\_pairs=1024, block\_path\_traversal=False, block\_shell\_metacharacters\_in\_args=False, block\_header\_injection=False)[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/mlflow/_security.py#L)[#](#scikitplot.mlflow.RELAXED_SECURITY_POLICY "Link to this definition")
