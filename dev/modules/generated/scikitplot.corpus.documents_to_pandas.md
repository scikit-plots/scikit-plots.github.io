...
scikitplot.corpus.documents\_to\_pandas(**docs**, **\***, **include\_embedding=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_schema.py#L2553)[#](#scikitplot.corpus.documents_to_pandas "Link to this definition")
