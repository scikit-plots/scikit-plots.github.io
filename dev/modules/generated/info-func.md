...
scikitplot.logging.info(**msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/ec7d6d7/scikitplot/logging.py#L1521)[#](#scikitplot.logging.info "Link to this definition")
