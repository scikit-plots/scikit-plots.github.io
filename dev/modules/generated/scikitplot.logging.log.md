...
scikitplot.logging.log(**level**, **msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/logging.py#L1553)[#](#scikitplot.logging.log "Link to this definition")
