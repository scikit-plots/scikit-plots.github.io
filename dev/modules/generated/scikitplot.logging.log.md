...
scikitplot.logging.log(**level**, **msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/576badd/scikitplot/logging.py#L1553)[#](#scikitplot.logging.log "Link to this definition")
