...
scikitplot.logging.log(**level**, **msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/logging.py#L1551)[#](#scikitplot.logging.log "Link to this definition")
