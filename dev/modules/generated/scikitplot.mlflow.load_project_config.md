...
scikitplot.mlflow.load\_project\_config(**path**, **\***, **profile='local'**, **project\_root=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/mlflow/_project.py#L857)[#](#scikitplot.mlflow.load_project_config "Link to this definition")
