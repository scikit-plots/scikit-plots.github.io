...
scikitplot.corpus.to\_mcp\_tool\_result(**documents**, **\***, **tool\_name='corpus\_search'**, **is\_error=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/corpus/_adapters.py#L324)[#](#scikitplot.corpus.to_mcp_tool_result "Link to this definition")
