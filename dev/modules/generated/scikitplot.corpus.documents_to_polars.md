...
scikitplot.corpus.documents\_to\_polars(**docs**, **\***, **include\_embedding=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_schema.py#L2626)[#](#scikitplot.corpus.documents_to_polars "Link to this definition")
