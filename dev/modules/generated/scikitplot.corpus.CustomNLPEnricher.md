...
class scikitplot.corpus.CustomNLPEnricher(**config=None**, **\***, **custom\_config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c2567fd/scikitplot/corpus/_custom_hooks.py#L638)[#](#scikitplot.corpus.CustomNLPEnricher "Link to this definition")
:   `NLPEnricher` extended with
    ...
    ****Developer note:**** Delegation order per stage:
    ...
    enrich\_documents(**documents**, **\***, **overwrite=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c2567fd/scikitplot/corpus/_custom_hooks.py#L723)[#](#scikitplot.corpus.CustomNLPEnricher.enrich_documents "Link to this definition")
