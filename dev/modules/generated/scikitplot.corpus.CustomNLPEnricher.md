...
class scikitplot.corpus.CustomNLPEnricher(**config=None**, **\***, **custom\_config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_custom_hooks.py#L617)[#](#scikitplot.corpus.CustomNLPEnricher "Link to this definition")
:   `NLPEnricher` extended with
    ...
    ****Developer note:**** Delegation order per stage:
    ...
    enrich\_documents(**documents**, **\***, **overwrite=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_custom_hooks.py#L702)[#](#scikitplot.corpus.CustomNLPEnricher.enrich_documents "Link to this definition")
