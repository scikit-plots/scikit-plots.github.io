# XMLReader[#](#xmlreader "Link to this heading")

class scikitplot.corpus.XMLReader(**input\_path**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_uri=None**, **source\_provenance=<factory>**, **custom\_extractor=None**, **custom\_extractor\_kwargs=<factory>**, **block\_xpath='.//\*'**, **text\_xpath=None**, **namespaces=None**, **max\_file\_bytes=209715200**, **encoding=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_readers/_xml.py#L438)[#](#scikitplot.corpus.XMLReader "Link to this definition")
:   Generic XML document reader with configurable XPath.
    ...
    :   ****input\_path****pathlib.Path
        ...
        ****text\_xpath****str or None, optional
    ...
    :   * ****input\_path**** ([**Path**](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)"))
        ...
        * ****block\_xpath**** ([**str**](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"))
        * ****text\_xpath**** ([**str**](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") **|** **None**)
        * ****namespaces**** ([**dict**](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")**[**[**str**](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")**,** [**str**](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")**]** **|** **None**)
    ...
    > **See also**
    > `scikitplot.corpus._readers.TEIReader`
    :   Pre-configured TEI subclass.
    ...
    ****lxml vs stdlib:**** lxml supports the full XPath 1.0 specification
    ...
    block\_xpath: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") = './/\*'[#](#scikitplot.corpus.XMLReader.block_xpath "Link to this definition")
    :   all descendants.

        Type:
        :   XPath selecting text-bearing elements. Default

    chunker: [ChunkerBase](scikitplot.corpus.ChunkerBase.html#scikitplot.corpus.ChunkerBase "scikitplot.corpus._base.ChunkerBase") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.chunker "Link to this definition")
    :   Chunker to apply to each raw text block. `None` means each raw chunk
        is used as-is (one CorpusDocument per raw chunk).

    classmethod create(**\*input\_path**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_type=None**, **source\_title=None**, **source\_author=None**, **source\_date=None**, **collection\_id=None**, **doi=None**, **isbn=None**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_base.py#L1531)[#](#scikitplot.corpus.XMLReader.create "Link to this definition")
    :   Instantiate the appropriate reader for one or more sources.
        ...
        detected and routed to [`from_url`](#scikitplot.corpus.XMLReader.from_url "scikitplot.corpus.XMLReader.from_url"); everything else is treated
        ...
        :   ****\*input\_path****str or pathlib.Path
            :   One or more source paths or URL strings. Each element is
                ...
                * `str` matching `^https?://` (case-insensitive) — treated
                  as a URL and routed to [`from_url`](#scikitplot.corpus.XMLReader.from_url "scikitplot.corpus.XMLReader.from_url"). ****Must be passed as
        ...
        ****URL auto-detection:**** A `str` element is treated as a URL when
        ...
        paths. This means you no longer need to call [`from_url`](#scikitplot.corpus.XMLReader.from_url "scikitplot.corpus.XMLReader.from_url")
        explicitly — just pass the URL string to [`create`](#scikitplot.corpus.XMLReader.create "scikitplot.corpus.XMLReader.create").
    ...
    custom\_extractor: [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.custom_extractor "Link to this definition")
    :   User-supplied extraction callable that ****replaces**** [`get_raw_chunks`](#scikitplot.corpus.XMLReader.get_raw_chunks "scikitplot.corpus.XMLReader.get_raw_chunks")
        ...
        The built-in [`get_raw_chunks`](#scikitplot.corpus.XMLReader.get_raw_chunks "scikitplot.corpus.XMLReader.get_raw_chunks") implementation is ****not**** called.
    ...
    custom\_extractor\_kwargs: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)")][[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_readers/_xml.py#L438)[#](#scikitplot.corpus.XMLReader.custom_extractor_kwargs "Link to this definition")
    :   Extra keyword arguments forwarded to [`custom_extractor`](#scikitplot.corpus.XMLReader.custom_extractor "scikitplot.corpus.XMLReader.custom_extractor") on every
    ...
    default\_language: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.default_language "Link to this definition")
    :   ISO 639-1 language code to assign when the source has no language info.

    encoding: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.encoding "Link to this definition")
    :   `None`.

        Type:
        :   Explicit encoding override. `None` uses the XML declaration. Default

    property file\_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")[#](#scikitplot.corpus.XMLReader.file_name "Link to this definition")
    ...
    file\_type: [ClassVar](https://docs.python.org/3/library/typing.html#typing.ClassVar "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")] = '.xml'[#](#scikitplot.corpus.XMLReader.file_type "Link to this definition")
    ...
    filename\_override: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.filename_override "Link to this definition")
    :   Override for the `input_path` label in generated documents.

    filter\_: [FilterBase](scikitplot.corpus.FilterBase.html#scikitplot.corpus.FilterBase "scikitplot.corpus._base.FilterBase") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.filter_ "Link to this definition")
    ...
    classmethod from\_manifest(**manifest\_path**, **\***, **chunker=None**, **filter\_=None**, **default\_language=None**, **source\_type=None**, **source\_title=None**, **source\_author=None**, **source\_date=None**, **collection\_id=None**, **doi=None**, **isbn=None**, **encoding='utf-8'**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_base.py#L1848)[#](#scikitplot.corpus.XMLReader.from_manifest "Link to this definition")
    ...
    :   Instantiate the appropriate reader for a URL source.
        ...
        ****Prefer :meth:`create` for new code.**** Passing a URL string to
        [`create`](#scikitplot.corpus.XMLReader.create "scikitplot.corpus.XMLReader.create") automatically calls [`from_url`](#scikitplot.corpus.XMLReader.from_url "scikitplot.corpus.XMLReader.from_url") — you rarely
        need to call [`from_url`](#scikitplot.corpus.XMLReader.from_url "scikitplot.corpus.XMLReader.from_url") directly.
    ...
    get\_documents()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_base.py#L1116)[#](#scikitplot.corpus.XMLReader.get_documents "Link to this definition")
    :   Yield validated [`CorpusDocument`](scikitplot.corpus.CorpusDocument.html#scikitplot.corpus.CorpusDocument "scikitplot.corpus._schema.CorpusDocument")
        ...
        1. [`validate_input`](#scikitplot.corpus.XMLReader.validate_input "scikitplot.corpus.XMLReader.validate_input") — fail fast if file is missing.
        2. [`get_raw_chunks`](#scikitplot.corpus.XMLReader.get_raw_chunks "scikitplot.corpus.XMLReader.get_raw_chunks") — format-specific text extraction.
    ...
    get\_raw\_chunks()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_readers/_xml.py#L570)[#](#scikitplot.corpus.XMLReader.get_raw_chunks "Link to this definition")
    ...
    input\_path: [Path](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_readers/_xml.py#L438)[#](#scikitplot.corpus.XMLReader.input_path "Link to this definition")
    ...
    max\_file\_bytes: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") = 209715200[#](#scikitplot.corpus.XMLReader.max_file_bytes "Link to this definition")
    :   200 MB.

        Type:
        :   Maximum file size in bytes. Default

    namespaces: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")] | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.namespaces "Link to this definition")
    :   `None`.

        Type:
        :   Namespace prefix-to-URI map for XPath. Default

    source\_provenance: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)")][[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_readers/_xml.py#L438)[#](#scikitplot.corpus.XMLReader.source_provenance "Link to this definition")
    :   Provenance overrides propagated into every yielded `CorpusDocument`.
        ...
        Populated by [`create`](#scikitplot.corpus.XMLReader.create "scikitplot.corpus.XMLReader.create") / [`from_url`](#scikitplot.corpus.XMLReader.from_url "scikitplot.corpus.XMLReader.from_url") from their keyword
        arguments.

    source\_uri: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.source_uri "Link to this definition")
    ...
    classmethod subclass\_by\_type()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_base.py#L1420)[#](#scikitplot.corpus.XMLReader.subclass_by_type "Link to this definition")
    ...
    classmethod supported\_types()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_base.py#L1402)[#](#scikitplot.corpus.XMLReader.supported_types "Link to this definition")
    ...
    text\_xpath: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.XMLReader.text_xpath "Link to this definition")
    :   Secondary XPath applied within each matched element. `None` uses
        `itertext()` directly on the element. Default: `None`.

    validate\_input()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_base.py#L931)[#](#scikitplot.corpus.XMLReader.validate_input "Link to this definition")
    :   Assert that the input file exists and is readable.
        ...
        Called automatically by [`get_documents`](#scikitplot.corpus.XMLReader.get_documents "scikitplot.corpus.XMLReader.get_documents") before iterating.
