...
scikitplot.mlflow.export\_builtin\_config(**\***, **fmt='toml'**, **dest\_path=None**, **project\_root=None**, **overwrite=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/mlflow/_workflow.py#L133)[#](#scikitplot.mlflow.export_builtin_config "Link to this definition")
