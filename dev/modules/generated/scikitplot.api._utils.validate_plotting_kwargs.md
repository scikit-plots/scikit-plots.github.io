...
scikitplot.api.\_utils.validate\_plotting\_kwargs(**\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/api/_utils/validation.py#L198)[#](#scikitplot.api._utils.validate_plotting_kwargs "Link to this definition")
