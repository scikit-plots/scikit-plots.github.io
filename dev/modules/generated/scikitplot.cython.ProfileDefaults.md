...
class scikitplot.cython.ProfileDefaults(**annotate=False**, **compiler\_directives=<factory>**, **extra\_compile\_args=<factory>**, **extra\_link\_args=<factory>**, **language=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/ec7d6d7/scikitplot/cython/_profiles.py#L70)[#](#scikitplot.cython.ProfileDefaults "Link to this definition")
