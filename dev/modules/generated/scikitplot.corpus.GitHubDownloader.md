...
class scikitplot.corpus.GitHubDownloader(**input\_url**, **output\_path=None**, **timeout=30.0**, **max\_bytes=104857600**, **verify\_ssl=True**, **block\_private\_ips=True**, **max\_redirects=5**, **user\_agent='Mozilla/5.0 (compatible; scikitplot-corpus/1.0; +https://github.com/scikit-plots/scikit-plots)'**, **token=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/corpus/_downloader/_github.py#L72)[#](#scikitplot.corpus.GitHubDownloader "Link to this definition")
:   GitHub URL downloader with automatic blob → raw normalisation.
    ...
    ****Private repo access:**** Tokens are passed as HTTP headers, never as
    ...
    cleanup()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/corpus/_downloader/_base.py#L481)[#](#scikitplot.corpus.GitHubDownloader.cleanup "Link to this definition")
    ...
    download()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/corpus/_downloader/_github.py#L254)[#](#scikitplot.corpus.GitHubDownloader.download "Link to this definition")
    ...
    input\_url: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/corpus/_downloader/_github.py#L72)[#](#scikitplot.corpus.GitHubDownloader.input_url "Link to this definition")
    ...
    resolve\_raw\_url()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/corpus/_downloader/_github.py#L216)[#](#scikitplot.corpus.GitHubDownloader.resolve_raw_url "Link to this definition")
