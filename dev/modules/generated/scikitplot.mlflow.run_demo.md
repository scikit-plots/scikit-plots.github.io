...
scikitplot.mlflow.run\_demo(**\***, **profile='local'**, **project\_root=None**, **open\_ui\_seconds=10.0**, **experiment\_name=None**, **fmt='toml'**, **overwrite=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/2eeb508/scikitplot/mlflow/_workflow.py#L211)[#](#scikitplot.mlflow.run_demo "Link to this definition")
