...
class scikitplot.cython.CacheEntry(**key=''**, **build\_dir=PosixPath('.')**, **module\_name=''**, **artifact\_path=PosixPath('.')**, **created\_utc=None**, **fingerprint=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/2e65b07/scikitplot/cython/_cache.py#L94)[#](#scikitplot.cython.CacheEntry "Link to this definition")
