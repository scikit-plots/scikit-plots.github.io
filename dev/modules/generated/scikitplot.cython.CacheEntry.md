...
class scikitplot.cython.CacheEntry(**key=''**, **build\_dir=PosixPath('.')**, **module\_name=''**, **artifact\_path=PosixPath('.')**, **created\_utc=None**, **fingerprint=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/cython/_cache.py#L131)[#](#scikitplot.cython.CacheEntry "Link to this definition")
