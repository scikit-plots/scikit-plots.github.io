...
scikitplot.show\_config(**mode='stdout'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/71eae2e/scikitplot/config/__config__.py#L189)[#](#scikitplot.show_config "Link to this definition")
:   Show libraries and system information on which SciPy was built
    ...
    Machine Information:
      ...
      host:
        ...
        system: linux
    Python Information:
      path: /home/circleci/.pyenv/versions/3.12.14/bin/python
      version: '3.12'
