...
scikitplot.seaborn.aucplot(**data=None**, **\***, **x=None**, **y=None**, **hue=None**, **kind=None**, **weights=None**, **hue\_order=None**, **hue\_norm=None**, **palette=None**, **color=None**, **fill=False**, **baseline=False**, **line\_kws=None**, **log\_scale=None**, **legend=True**, **ax=None**, **annot=None**, **fmt='.4g'**, **annot\_kws=None**, **digits=None**, **common\_norm=None**, **verbose=False**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/seaborn/_auc.py#L1149)[#](#scikitplot.seaborn.aucplot "Link to this definition")
:   Plot PR or ROC curves with a seaborn-like API.
    ...
    > **See also**
    > [`sklearn.metrics.roc_curve`](https://scikit-learn.org/dev/modules/generated/sklearn.metrics.roc_curve.html#sklearn.metrics.roc_curve "(in scikit-learn v1.9)")


    [`sklearn.metrics.precision_recall_curve`](https://scikit-learn.org/dev/modules/generated/sklearn.metrics.precision_recall_curve.html#sklearn.metrics.precision_recall_curve "(in scikit-learn v1.9)")


    [`sklearn.metrics.average_precision_score`](https://scikit-learn.org/dev/modules/generated/sklearn.metrics.average_precision_score.html#sklearn.metrics.average_precision_score "(in scikit-learn v1.9)")
