    ...
    :   ****estimator****object type that implements the “fit” method
        ...
        ****cv****int, cross-validation generator, iterable or None, default=5
        :   Determines the cross-validation splitting strategy.
            ...
            - [CV splitter](https://scikit-learn.org/dev/glossary.html#term-CV-splitter "(in scikit-learn v1.10)"),
        ...
        ****n\_jobs****int, optional, default=None
        :   Number of jobs to run in parallel. Training the estimator and computing
            ...
            `-1` means using all processors. See [Glossary](https://scikit-learn.org/dev/glossary.html#term-n_jobs "(in scikit-learn v1.10)")
            for more details.
