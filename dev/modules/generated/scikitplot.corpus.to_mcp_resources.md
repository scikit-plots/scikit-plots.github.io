...
scikitplot.corpus.to\_mcp\_resources(**documents**, **\***, **uri\_prefix='corpus://'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/829d7a7/scikitplot/corpus/_adapters.py#L271)[#](#scikitplot.corpus.to_mcp_resources "Link to this definition")
