...
class scikitplot.corpus.LemmatizerProtocol(**\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/25a82c5/scikitplot/corpus/_chunkers/_custom_tokenizer.py#L220)[#](#scikitplot.corpus.LemmatizerProtocol "Link to this definition")
:   Structural protocol for word lemmatizers.
    ...
    lemmatize(**word**, **pos=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/25a82c5/scikitplot/corpus/_chunkers/_custom_tokenizer.py#L236)[#](#scikitplot.corpus.LemmatizerProtocol.lemmatize "Link to this definition")
