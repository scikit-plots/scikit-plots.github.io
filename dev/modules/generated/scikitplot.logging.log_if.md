...
scikitplot.logging.log\_if(**level**, **msg**, **condition**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/4094af5/scikitplot/logging.py#L1575)[#](#scikitplot.logging.log_if "Link to this definition")
