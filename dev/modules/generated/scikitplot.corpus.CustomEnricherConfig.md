...
class scikitplot.corpus.CustomEnricherConfig(**custom\_tokenizer=None**, **custom\_lemmatizer=None**, **custom\_stemmer=None**, **custom\_keyword\_extractor=None**, **custom\_stopwords=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/corpus/_custom_hooks.py#L540)[#](#scikitplot.corpus.CustomEnricherConfig "Link to this definition")
