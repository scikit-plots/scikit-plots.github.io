...
scikitplot.cython.gc\_cache(**\***, **cache\_dir=None**, **keep\_n\_newest=None**, **max\_age\_days=None**, **max\_bytes=None**, **dry\_run=False**, **lock\_timeout\_s=60.0**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/829d7a7/scikitplot/cython/_gc.py#L129)[#](#scikitplot.cython.gc_cache "Link to this definition")
