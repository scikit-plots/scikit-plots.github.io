...
class scikitplot.visualkeras.SpacingDummyLayer(**\*args**, **spacing=50**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/576badd/scikitplot/visualkeras/_layer_utils.py#L183)[#](#scikitplot.visualkeras.SpacingDummyLayer "Link to this definition")
