...
class scikitplot.corpus.TextNormalizer(**config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/corpus/_normalizers/_text_normalizer.py#L298)[#](#scikitplot.corpus.TextNormalizer "Link to this definition")
:   Pipeline component that populates `normalized_text` on
    ...
    ****Developer note:**** This class is stateless and thread-safe.
    ...
    normalize(**text**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/corpus/_normalizers/_text_normalizer.py#L345)[#](#scikitplot.corpus.TextNormalizer.normalize "Link to this definition")
    ...
    normalize\_documents(**documents**, **\***, **overwrite=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/corpus/_normalizers/_text_normalizer.py#L408)[#](#scikitplot.corpus.TextNormalizer.normalize_documents "Link to this definition")
