...
class scikitplot.corpus.SQLiteStorage(**db\_path=':memory:'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_storage/_storage.py#L631)[#](#scikitplot.corpus.SQLiteStorage "Link to this definition")
:   SQLite-backed corpus store with FTS5 full-text search.
    ...
    close()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_storage/_storage.py#L882)[#](#scikitplot.corpus.SQLiteStorage.close "Link to this definition")
    :   Close the database connection.

        Return type:
        :   None

    count()[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_storage/_storage.py#L875)[#](#scikitplot.corpus.SQLiteStorage.count "Link to this definition")
    :   Return total stored document count via fast SQL COUNT.

        Return type:
        :   [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")

    get(**doc\_id**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_storage/_storage.py#L795)[#](#scikitplot.corpus.SQLiteStorage.get "Link to this definition")
    ...
    query(**q**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_storage/_storage.py#L813)[#](#scikitplot.corpus.SQLiteStorage.query "Link to this definition")
    ...
    save(**doc**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_storage/_storage.py#L741)[#](#scikitplot.corpus.SQLiteStorage.save "Link to this definition")
    ...
    save\_batch(**docs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/corpus/_storage/_storage.py#L756)[#](#scikitplot.corpus.SQLiteStorage.save_batch "Link to this definition")
