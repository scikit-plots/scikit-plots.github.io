...
scikitplot.cexternals.\_astropy.stats.binned\_binom\_proportion(**x**, **success**, **bins=10**, **range=None**, **confidence\_level=0.68269**, **interval='wilson'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/71eae2e/scikitplot/cexternals/_astropy/stats/funcs.py#L298)[#](#scikitplot.cexternals._astropy.stats.binned_binom_proportion "Link to this definition")
:   Binomial proportion and confidence interval in bins of a continuous
    ...
    :   * ****x**** (**ArrayLike**)
        * ****success**** (**ArrayLike**)
        * ****bins**** ([**int**](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") **|** **ArrayLike**)
    ...
    Return type:
    :   [tuple](https://docs.python.org/3/library/stdtypes.html#tuple "(in Python v3.14)")[**NDArray**, **NDArray**, **NDArray**, **NDArray**]
