...
class scikitplot.stats.FitnessFunc(**p0=0.05**, **gamma=None**, **ncp\_prior=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L189)[#](#scikitplot.stats.FitnessFunc "Link to this definition")
:   Base class for bayesian blocks fitness functions.
    ...
    compute\_ncp\_prior(**N**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L327)[#](#scikitplot.stats.FitnessFunc.compute_ncp_prior "Link to this definition")
    ...
    fit(**t**, **x=None**, **sigma=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L342)[#](#scikitplot.stats.FitnessFunc.fit "Link to this definition")
    ...
    fitness(**\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L307)[#](#scikitplot.stats.FitnessFunc.fitness "Link to this definition")

    p0\_prior(**N**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L310)[#](#scikitplot.stats.FitnessFunc.p0_prior "Link to this definition")
    ...
    validate\_input(**t**, **x=None**, **sigma=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L236)[#](#scikitplot.stats.FitnessFunc.validate_input "Link to this definition")
