...
scikitplot.experimental.\_doremi.save\_waveform(**waveform**, **file\_path='output.wav'**, **ext=None**, **sample\_rate=44100**, **backend=None**, **dtype='float32'**, **normalize=True**, **stereo\_out=True**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/2e65b07/scikitplot/experimental/_doremi/note_io.py#L39)[#](#scikitplot.experimental._doremi.save_waveform "Link to this definition")
