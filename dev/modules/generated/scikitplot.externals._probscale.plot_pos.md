...
scikitplot.externals.\_probscale.plot\_pos(**data**, **postype=None**, **alpha=None**, **beta=None**, **exceedance=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/25a82c5/scikitplot/externals/_probscale/viz.py#L302)[#](#scikitplot.externals._probscale.plot_pos "Link to this definition")
