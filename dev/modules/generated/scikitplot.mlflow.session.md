...
scikitplot.mlflow.session(**\***, **config=None**, **server=None**, **start\_server=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/mlflow/_session.py#L316)[#](#scikitplot.mlflow.session "Link to this definition")
