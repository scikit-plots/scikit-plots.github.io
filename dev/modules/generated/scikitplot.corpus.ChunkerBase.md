...
class scikitplot.corpus.ChunkerBase[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_base.py#L234)[#](#scikitplot.corpus.ChunkerBase "Link to this definition")
:   Abstract base class for all text chunkers.
    ...
    assert\_modality(**doc\_modality**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_base.py#L352)[#](#scikitplot.corpus.ChunkerBase.assert_modality "Link to this definition")
    ...
    abstractmethod chunk(**text**, **metadata=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_base.py#L304)[#](#scikitplot.corpus.ChunkerBase.chunk "Link to this definition")
