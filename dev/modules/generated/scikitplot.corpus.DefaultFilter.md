...
class scikitplot.corpus.DefaultFilter(**min\_words=3**, **min\_chars=10**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_base.py#L335)[#](#scikitplot.corpus.DefaultFilter "Link to this definition")
:   Standard noise filter ported and improved from remarx’s `include_sentence`.
    ...
    include(**doc**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e4af755/scikitplot/corpus/_base.py#L392)[#](#scikitplot.corpus.DefaultFilter.include "Link to this definition")
