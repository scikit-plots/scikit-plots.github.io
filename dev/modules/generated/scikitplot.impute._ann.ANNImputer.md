...
class scikitplot.impute.\_ann.ANNImputer(**\***, **missing\_values=nan**, **backend='annoy'**, **index\_access='external'**, **index\_store\_path=None**, **on\_disk\_build=False**, **n\_trees=-1**, **search\_k=-1**, **n\_neighbors=5**, **weights='uniform'**, **metric='angular'**, **initial\_strategy='mean'**, **fill\_value=None**, **copy=True**, **add\_indicator=False**, **keep\_empty\_features=False**, **n\_jobs=None**, **random\_state=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/impute/_ann.py#L109)[#](#scikitplot.impute._ann.ANNImputer "Link to this definition")
:   Approximate K-nearest-neighbours (KNN) imputer with pluggable ANN backends.
    ...
    * Annoy supports specific metrics; `'euclidean'` (p=2) and `'manhattan'` (p=1)
    ...
    delete\_external\_index()[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/impute/_privacy.py#L318)[#](#scikitplot.impute._ann.ANNImputer.delete_external_index "Link to this definition")
    ...
    fit(**X**, **y=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/impute/_ann.py#L1047)[#](#scikitplot.impute._ann.ANNImputer.fit "Link to this definition")
    ...
    fit\_transform(**X**, **y=None**, **\*\*fit\_params**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/../sklearn/base.py#L851)[#](#scikitplot.impute._ann.ANNImputer.fit_transform "Link to this definition")
    ...
    get\_feature\_names\_out(**input\_features=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/impute/_ann.py#L1693)[#](#scikitplot.impute._ann.ANNImputer.get_feature_names_out "Link to this definition")
    :   Return output feature names, including indicator features if used.

    get\_metadata\_routing()[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/../sklearn/utils/_metadata_requests.py#L1550)[#](#scikitplot.impute._ann.ANNImputer.get_metadata_routing "Link to this definition")
    ...
    get\_params(**deep=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/../sklearn/base.py#L240)[#](#scikitplot.impute._ann.ANNImputer.get_params "Link to this definition")
    ...
    set\_output(**\***, **transform=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/../sklearn/utils/_set_output.py#L389)[#](#scikitplot.impute._ann.ANNImputer.set_output "Link to this definition")
    ...
    set\_params(**\*\*params**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/../sklearn/base.py#L338)[#](#scikitplot.impute._ann.ANNImputer.set_params "Link to this definition")
    ...
    transform(**X**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/dbbf22f/scikitplot/impute/_ann.py#L1622)[#](#scikitplot.impute._ann.ANNImputer.transform "Link to this definition")
