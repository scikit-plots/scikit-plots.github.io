...
class scikitplot.corpus.JSONLStorage(**path**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_storage/_storage.py#L364)[#](#scikitplot.corpus.JSONLStorage "Link to this definition")
:   Append-friendly JSONL (newline-delimited JSON) flat-file store.
    ...
    count()[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_storage/_storage.py#L538)[#](#scikitplot.corpus.JSONLStorage.count "Link to this definition")
    :   Return total stored document count in O(1).

        Return type:
        :   [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")

    get(**doc\_id**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_storage/_storage.py#L494)[#](#scikitplot.corpus.JSONLStorage.get "Link to this definition")
    ...
    query(**q**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_storage/_storage.py#L508)[#](#scikitplot.corpus.JSONLStorage.query "Link to this definition")
    ...
    save(**doc**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_storage/_storage.py#L454)[#](#scikitplot.corpus.JSONLStorage.save "Link to this definition")
    ...
    save\_batch(**docs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/corpus/_storage/_storage.py#L478)[#](#scikitplot.corpus.JSONLStorage.save_batch "Link to this definition")
