...
scikitplot.cexternals.\_astropy.stats.signal\_to\_noise\_oir\_ccd(**t**, **source\_eps**, **sky\_eps**, **dark\_eps**, **rd**, **npix**, **gain=1.0**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/71eae2e/scikitplot/cexternals/_astropy/stats/funcs.py#L947)[#](#scikitplot.cexternals._astropy.stats.signal_to_noise_oir_ccd "Link to this definition")
:   Computes the signal to noise ratio for source being observed in the
    ...
    Parameters:
    :   * ****t**** ([**float**](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)") **|** **NDArray**)
