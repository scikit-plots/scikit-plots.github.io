...
:   Configuration that maps directly to `mlflow server` CLI flags.
    ...
    validate(**\***, **for\_managed\_tracking**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/mlflow/_config.py#L239)[#](#scikitplot.mlflow.ServerConfig.validate "Link to this definition")
