...
scikitplot.cython.generate\_sphinx\_template\_docs(**output\_dir**, **\***, **title='Cython templates'**, **include\_python=True**, **include\_cython=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/ec7d6d7/scikitplot/cython/_templates_api.py#L957)[#](#scikitplot.cython.generate_sphinx_template_docs "Link to this definition")
