...
class scikitplot.mlflow.WorkflowPaths(**\_project\_root**, **\_config\_dir**, **\_toml\_path**, **\_yaml\_path**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/mlflow/_workflow.py#L35)[#](#scikitplot.mlflow.WorkflowPaths "Link to this definition")
