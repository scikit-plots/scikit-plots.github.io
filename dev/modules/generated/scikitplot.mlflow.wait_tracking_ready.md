...
scikitplot.mlflow.wait\_tracking\_ready(**tracking\_uri**, **timeout\_s**, **\***, **server=None**, **poll\_interval\_s=0.2**, **request\_timeout\_s=2.0**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7b27db8/scikitplot/mlflow/_readiness.py#L61)[#](#scikitplot.mlflow.wait_tracking_ready "Link to this definition")
