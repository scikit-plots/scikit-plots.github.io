...
class scikitplot.mlflow.MlflowHandle(**\_mlflow\_module**, **\_tracking\_uri**, **\_registry\_uri**, **\_ui\_url**, **\_client**, **\_artifacts**, **\_models**, **server=None**, **version=None**, **experiment\_name=None**, **default\_run\_name=None**, **default\_run\_tags=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f06fe30/scikitplot/mlflow/_session.py#L157)[#](#scikitplot.mlflow.MlflowHandle "Link to this definition")
:   A handle that proxies the upstream `mlflow` module while adding session context.
    ...
    start\_run(**\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f06fe30/scikitplot/mlflow/_session.py#L270)[#](#scikitplot.mlflow.MlflowHandle.start_run "Link to this definition")
