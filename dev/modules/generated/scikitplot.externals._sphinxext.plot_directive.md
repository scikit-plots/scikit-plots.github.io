...
:   Allow the srcset image option for responsive image resolutions. List of
    ...
    [matplotlib.sphinxext.figmpl\_directive](https://matplotlib.org/devdocs/api/sphinxext_figmpl_directive_api.html "(in Matplotlib v3.12.0.dev80+g7499f38d2)")
...
[matplotlib.sphinxext.plot\_directive](https://matplotlib.org/devdocs/api/sphinxext_plot_directive_api.html "(in Matplotlib v3.12.0.dev80+g7499f38d2)")
