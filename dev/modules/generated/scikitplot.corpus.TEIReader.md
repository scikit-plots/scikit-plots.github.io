# TEIReader[#](#teireader "Link to this heading")

class scikitplot.corpus.TEIReader(**input\_path**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_uri=None**, **source\_provenance=<factory>**, **custom\_extractor=None**, **custom\_extractor\_kwargs=<factory>**, **include\_stage\_directions=True**, **include\_speaker\_tags=True**, **max\_file\_bytes=209715200**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_readers/_xml.py#L571)[#](#scikitplot.corpus.TEIReader "Link to this definition")
:   TEI/XML document reader with dramatic structure extraction.
    ...
    * ****Stage directions**** (`<stage>`) → `section_type=STAGE_DIRECTION`
    ...
    Attributes:
    :   ****file\_type****ClassVar[str]
        :   Not registered (`None`) — [`TEIReader`](#scikitplot.corpus.TEIReader "scikitplot.corpus.TEIReader") is used as an
            instantiated object, not via the `DocumentReader.create()` factory.
            TEI files have `.xml` extension, which is already registered by
            [`XMLReader`](scikitplot.corpus.XMLReader.html#scikitplot.corpus.XMLReader "scikitplot.corpus.XMLReader"). To route `.xml` files to TEIReader instead,
    ...
    :   * ****input\_path**** ([**Path**](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)"))
        ...
        * ****include\_stage\_directions**** ([**bool**](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)"))
        * ****include\_speaker\_tags**** ([**bool**](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)"))
    ...
    * `"line_number"` — one-based verse line number within the scene/act
    ...
    chunker: [ChunkerBase](scikitplot.corpus.ChunkerBase.html#scikitplot.corpus.ChunkerBase "scikitplot.corpus._base.ChunkerBase") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.TEIReader.chunker "Link to this definition")
    :   Chunker to apply to each raw text block. `None` means each raw chunk
        is used as-is (one CorpusDocument per raw chunk).

    classmethod create(**\*input\_path**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_type=None**, **source\_title=None**, **source\_author=None**, **source\_date=None**, **collection\_id=None**, **doi=None**, **isbn=None**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_base.py#L1238)[#](#scikitplot.corpus.TEIReader.create "Link to this definition")
    :   Instantiate the appropriate reader for one or more sources.
        ...
        detected and routed to [`from_url`](#scikitplot.corpus.TEIReader.from_url "scikitplot.corpus.TEIReader.from_url"); everything else is treated
        ...
        :   ****\*input\_path****str or pathlib.Path
            :   One or more source paths or URL strings. Each element is
                ...
                * `str` matching `^https?://` (case-insensitive) — treated
                  as a URL and routed to [`from_url`](#scikitplot.corpus.TEIReader.from_url "scikitplot.corpus.TEIReader.from_url"). ****Must be passed as
        ...
        ****URL auto-detection:**** A `str` element is treated as a URL when
        ...
        paths. This means you no longer need to call [`from_url`](#scikitplot.corpus.TEIReader.from_url "scikitplot.corpus.TEIReader.from_url")
        explicitly — just pass the URL string to [`create`](#scikitplot.corpus.TEIReader.create "scikitplot.corpus.TEIReader.create").
    ...
    custom\_extractor: [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.TEIReader.custom_extractor "Link to this definition")
    :   User-supplied extraction callable that ****replaces**** [`get_raw_chunks`](#scikitplot.corpus.TEIReader.get_raw_chunks "scikitplot.corpus.TEIReader.get_raw_chunks")
        ...
        The built-in [`get_raw_chunks`](#scikitplot.corpus.TEIReader.get_raw_chunks "scikitplot.corpus.TEIReader.get_raw_chunks") implementation is ****not**** called.
    ...
    custom\_extractor\_kwargs: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)")][[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_readers/_xml.py#L571)[#](#scikitplot.corpus.TEIReader.custom_extractor_kwargs "Link to this definition")
    :   Extra keyword arguments forwarded to [`custom_extractor`](#scikitplot.corpus.TEIReader.custom_extractor "scikitplot.corpus.TEIReader.custom_extractor") on every
    ...
    default\_language: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.TEIReader.default_language "Link to this definition")
    :   ISO 639-1 language code to assign when the source has no language info.

    property file\_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")[#](#scikitplot.corpus.TEIReader.file_name "Link to this definition")
    ...
    file\_type: [ClassVar](https://docs.python.org/3/library/typing.html#typing.ClassVar "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")] = ':tei'[#](#scikitplot.corpus.TEIReader.file_type "Link to this definition")
    ...
    filename\_override: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.TEIReader.filename_override "Link to this definition")
    :   Override for the `input_path` label in generated documents.

    filter\_: [FilterBase](scikitplot.corpus.FilterBase.html#scikitplot.corpus.FilterBase "scikitplot.corpus._base.FilterBase") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.TEIReader.filter_ "Link to this definition")
    ...
    classmethod from\_manifest(**manifest\_path**, **\***, **chunker=None**, **filter\_=None**, **default\_language=None**, **source\_type=None**, **source\_title=None**, **source\_author=None**, **source\_date=None**, **collection\_id=None**, **doi=None**, **isbn=None**, **encoding='utf-8'**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_base.py#L1555)[#](#scikitplot.corpus.TEIReader.from_manifest "Link to this definition")
    ...
    :   Instantiate the appropriate reader for a URL source.
        ...
        ****Prefer :meth:`create` for new code.**** Passing a URL string to
        [`create`](#scikitplot.corpus.TEIReader.create "scikitplot.corpus.TEIReader.create") automatically calls [`from_url`](#scikitplot.corpus.TEIReader.from_url "scikitplot.corpus.TEIReader.from_url") — you rarely
        need to call [`from_url`](#scikitplot.corpus.TEIReader.from_url "scikitplot.corpus.TEIReader.from_url") directly.
    ...
    get\_documents()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_base.py#L939)[#](#scikitplot.corpus.TEIReader.get_documents "Link to this definition")
    :   Yield validated [`CorpusDocument`](scikitplot.corpus.CorpusDocument.html#scikitplot.corpus.CorpusDocument "scikitplot.corpus._schema.CorpusDocument")
        ...
        1. [`validate_input`](#scikitplot.corpus.TEIReader.validate_input "scikitplot.corpus.TEIReader.validate_input") — fail fast if file is missing.
        2. [`get_raw_chunks`](#scikitplot.corpus.TEIReader.get_raw_chunks "scikitplot.corpus.TEIReader.get_raw_chunks") — format-specific text extraction.
    ...
    get\_raw\_chunks()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_readers/_xml.py#L720)[#](#scikitplot.corpus.TEIReader.get_raw_chunks "Link to this definition")
    ...
    include\_speaker\_tags: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)") = True[#](#scikitplot.corpus.TEIReader.include_speaker_tags "Link to this definition")
    :   `True`.

        Type:
        :   Prepend speaker name to dialogue chunks. Default

    include\_stage\_directions: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)") = True[#](#scikitplot.corpus.TEIReader.include_stage_directions "Link to this definition")
    :   `True`.

        Type:
        :   Include stage directions as STAGE\_DIRECTION chunks. Default

    input\_path: [Path](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_readers/_xml.py#L571)[#](#scikitplot.corpus.TEIReader.input_path "Link to this definition")
    ...
    max\_file\_bytes: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") = 209715200[#](#scikitplot.corpus.TEIReader.max_file_bytes "Link to this definition")
    :   200 MB.

        Type:
        :   Maximum file size in bytes. Default

    source\_provenance: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)")][[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_readers/_xml.py#L571)[#](#scikitplot.corpus.TEIReader.source_provenance "Link to this definition")
    :   Provenance overrides propagated into every yielded `CorpusDocument`.
        ...
        Populated by [`create`](#scikitplot.corpus.TEIReader.create "scikitplot.corpus.TEIReader.create") / [`from_url`](#scikitplot.corpus.TEIReader.from_url "scikitplot.corpus.TEIReader.from_url") from their keyword
        arguments.

    source\_uri: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.TEIReader.source_uri "Link to this definition")
    ...
    classmethod subclass\_by\_type()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_base.py#L1127)[#](#scikitplot.corpus.TEIReader.subclass_by_type "Link to this definition")
    ...
    classmethod supported\_types()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_base.py#L1109)[#](#scikitplot.corpus.TEIReader.supported_types "Link to this definition")
    ...
    validate\_input()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f4129c4/scikitplot/corpus/_readers/_xml.py#L703)[#](#scikitplot.corpus.TEIReader.validate_input "Link to this definition")
