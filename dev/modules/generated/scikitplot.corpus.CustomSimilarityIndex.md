...
class scikitplot.corpus.CustomSimilarityIndex(**config=None**, **\***, **custom\_scorer\_fn=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/576badd/scikitplot/corpus/_custom_hooks.py#L1669)[#](#scikitplot.corpus.CustomSimilarityIndex "Link to this definition")
:   `SimilarityIndex` extended with a
    ...
    ****Developer note:**** The built-in index (`SimilarityIndex`)
    ...
    build(**documents**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/576badd/scikitplot/corpus/_custom_hooks.py#L1782)[#](#scikitplot.corpus.CustomSimilarityIndex.build "Link to this definition")
    ...
    search(**query**, **\***, **config=None**, **query\_embedding=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/576badd/scikitplot/corpus/_custom_hooks.py#L1802)[#](#scikitplot.corpus.CustomSimilarityIndex.search "Link to this definition")
