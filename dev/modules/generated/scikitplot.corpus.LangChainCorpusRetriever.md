...
class scikitplot.corpus.LangChainCorpusRetriever(**index**, **embedding\_fn=None**, **config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_adapters.py#L519)[#](#scikitplot.corpus.LangChainCorpusRetriever "Link to this definition")
:   LangChain-compatible retriever backed by `RetrievalIndex`.
    ...
    ****User note:**** Plug into any LangChain chain:
    ...
    get\_relevant\_documents(**query**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_adapters.py#L576)[#](#scikitplot.corpus.LangChainCorpusRetriever.get_relevant_documents "Link to this definition")
    ...
    invoke(**query**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_adapters.py#L576)[#](#scikitplot.corpus.LangChainCorpusRetriever.invoke "Link to this definition")
    :   Retrieve documents relevant to **query**.
