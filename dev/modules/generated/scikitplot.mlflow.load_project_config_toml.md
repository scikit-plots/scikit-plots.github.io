...
scikitplot.mlflow.load\_project\_config\_toml(**path**, **\***, **profile='local'**, **project\_root=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/mlflow/_project.py#L761)[#](#scikitplot.mlflow.load_project_config_toml "Link to this definition")
