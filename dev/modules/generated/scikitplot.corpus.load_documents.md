...
scikitplot.corpus.load\_documents(**path**, **fmt=None**, **\***, **trusted=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/corpus/_export/_export.py#L940)[#](#scikitplot.corpus.load_documents "Link to this definition")
