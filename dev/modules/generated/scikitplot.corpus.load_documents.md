...
scikitplot.corpus.load\_documents(**path**, **fmt=None**, **\***, **trusted=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/corpus/_export/_export.py#L878)[#](#scikitplot.corpus.load_documents "Link to this definition")
