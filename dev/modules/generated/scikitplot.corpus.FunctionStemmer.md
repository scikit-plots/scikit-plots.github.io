...
class scikitplot.corpus.FunctionStemmer(**fn**, **name='custom'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/corpus/_chunkers/_custom_tokenizer.py#L425)[#](#scikitplot.corpus.FunctionStemmer "Link to this definition")
:   Wrap any `Callable[[str], str]` as a [`StemmerProtocol`](scikitplot.corpus.StemmerProtocol.html#scikitplot.corpus.StemmerProtocol "scikitplot.corpus.StemmerProtocol").
    ...
    stem(**word**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/corpus/_chunkers/_custom_tokenizer.py#L454)[#](#scikitplot.corpus.FunctionStemmer.stem "Link to this definition")
    :   Stem **word**.
