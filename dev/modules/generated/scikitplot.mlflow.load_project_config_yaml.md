...
scikitplot.mlflow.load\_project\_config\_yaml(**path**, **\***, **profile='local'**, **project\_root=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/mlflow/_project.py#L803)[#](#scikitplot.mlflow.load_project_config_yaml "Link to this definition")
