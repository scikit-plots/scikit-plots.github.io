...
class scikitplot.cython.PybindCompiler[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/cython/_custom_compiler.py#L862)[#](#scikitplot.cython.PybindCompiler "Link to this definition")
:   Built-in custom compiler: pybind11-only projects.
    ...
    ****Master user note****: register and use this compiler when building
    ...
    \_\_call\_\_(**source**, **\***, **build\_dir**, **module\_name**, **include\_dirs=None**, **extra\_compile\_args=None**, **extra\_link\_args=None**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/cython/_custom_compiler.py#L899)[#](#scikitplot.cython.PybindCompiler.__call__ "Link to this definition")
