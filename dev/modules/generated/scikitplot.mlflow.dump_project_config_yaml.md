...
scikitplot.mlflow.dump\_project\_config\_yaml(**cfg=None**, **path=None**, **\***, **profile='local'**, **source\_config\_path=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d6e9440d/scikitplot/mlflow/_project.py#L899)[#](#scikitplot.mlflow.dump_project_config_yaml "Link to this definition")
