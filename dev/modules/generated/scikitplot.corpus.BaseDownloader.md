...
class scikitplot.corpus.BaseDownloader(**input\_url**, **output\_path=None**, **timeout=30.0**, **max\_bytes=104857600**, **verify\_ssl=True**, **block\_private\_ips=True**, **max\_redirects=5**, **user\_agent='Mozilla/5.0 (compatible; scikitplot-corpus/1.0; +https://github.com/scikit-plots/scikit-plots)'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f06fe30/scikitplot/corpus/_downloader/_base.py#L222)[#](#scikitplot.corpus.BaseDownloader "Link to this definition")
:   Abstract base class for all format-specific URL downloaders.
    ...
    * (At download time) hostname is resolved and checked against private
    ...
    cleanup()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f06fe30/scikitplot/corpus/_downloader/_base.py#L481)[#](#scikitplot.corpus.BaseDownloader.cleanup "Link to this definition")
    ...
    abstractmethod download()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f06fe30/scikitplot/corpus/_downloader/_base.py#L392)[#](#scikitplot.corpus.BaseDownloader.download "Link to this definition")
    ...
    input\_url: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/f06fe30/scikitplot/corpus/_downloader/_base.py#L222)[#](#scikitplot.corpus.BaseDownloader.input_url "Link to this definition")
