...
scikitplot.logging.fatal(**msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/logging.py#L1412)[#](#scikitplot.logging.fatal "Link to this definition")
