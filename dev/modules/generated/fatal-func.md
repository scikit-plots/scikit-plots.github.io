...
scikitplot.logging.fatal(**msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7ef1ffb/scikitplot/logging.py#L1414)[#](#scikitplot.logging.fatal "Link to this definition")
