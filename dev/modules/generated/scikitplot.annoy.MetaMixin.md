...
class scikitplot.annoy.MetaMixin[[source]](https://github.com/scikit-plots/scikit-plots/blob/287271b/scikitplot/annoy/_mixins/_meta.py#L128)[#](#scikitplot.annoy.MetaMixin "Link to this definition")
:   Mixin that exports and restores index metadata.
    ...
    * `_META_SCHEMA_VERSION` (int)
    ...
    classmethod from\_json(**path**, **\***, **load=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/287271b/scikitplot/annoy/_mixins/_meta.py#L426)[#](#scikitplot.annoy.MetaMixin.from_json "Link to this definition")
    ...
    classmethod from\_metadata(**metadata**, **\***, **load=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/287271b/scikitplot/annoy/_mixins/_meta.py#L257)[#](#scikitplot.annoy.MetaMixin.from_metadata "Link to this definition")
    ...
    classmethod from\_yaml(**path**, **\***, **load=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/287271b/scikitplot/annoy/_mixins/_meta.py#L460)[#](#scikitplot.annoy.MetaMixin.from_yaml "Link to this definition")
    ...
    to\_json(**path=None**, **\***, **indent=2**, **sort\_keys=True**, **ensure\_ascii=False**, **include\_info=True**, **strict=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/287271b/scikitplot/annoy/_mixins/_meta.py#L377)[#](#scikitplot.annoy.MetaMixin.to_json "Link to this definition")
    ...
    to\_metadata(**\***, **include\_info=True**, **strict=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/287271b/scikitplot/annoy/_mixins/_meta.py#L154)[#](#scikitplot.annoy.MetaMixin.to_metadata "Link to this definition")
    ...
    to\_yaml(**path=None**, **\***, **include\_info=True**, **strict=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/287271b/scikitplot/annoy/_mixins/_meta.py#L439)[#](#scikitplot.annoy.MetaMixin.to_yaml "Link to this definition")
