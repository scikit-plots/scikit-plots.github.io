...
class scikitplot.mlflow.SpawnedServer(**\_process**, **\_command**, **\_started\_at**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/mlflow/_server.py#L202)[#](#scikitplot.mlflow.SpawnedServer "Link to this definition")
:   Spawned MLflow server process state.
    ...
    read\_all\_output()[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/mlflow/_server.py#L234)[#](#scikitplot.mlflow.SpawnedServer.read_all_output "Link to this definition")
    ...
    terminate()[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/mlflow/_server.py#L250)[#](#scikitplot.mlflow.SpawnedServer.terminate "Link to this definition")
