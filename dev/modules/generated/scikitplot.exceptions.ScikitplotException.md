...
exception scikitplot.exceptions.ScikitplotException(**message**, **error\_code=0**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/829d7a7/scikitplot/exceptions.py#L363)[#](#scikitplot.exceptions.ScikitplotException "Link to this definition")
