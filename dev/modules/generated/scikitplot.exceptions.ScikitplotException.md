...
exception scikitplot.exceptions.ScikitplotException(**message**, **error\_code=0**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/e137512/scikitplot/exceptions.py#L363)[#](#scikitplot.exceptions.ScikitplotException "Link to this definition")
