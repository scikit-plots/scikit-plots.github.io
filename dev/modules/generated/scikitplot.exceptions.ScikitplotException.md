...
exception scikitplot.exceptions.ScikitplotException(**message**, **error\_code=0**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/cdecb99/scikitplot/exceptions.py#L369)[#](#scikitplot.exceptions.ScikitplotException "Link to this definition")
