...
class scikitplot.corpus.MCPCorpusServer(**index**, **embedding\_fn=None**, **server\_name='corpus-search'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/corpus/_adapters.py#L620)[#](#scikitplot.corpus.MCPCorpusServer "Link to this definition")
:   MCP server adapter for corpus search.
    ...
    ****User note:**** Use with any MCP server framework:
    ...
    handle\_resource(**doc\_id**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/corpus/_adapters.py#L712)[#](#scikitplot.corpus.MCPCorpusServer.handle_resource "Link to this definition")
    ...
    handle\_search(**query**, **\***, **top\_k=10**, **match\_mode='hybrid'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/corpus/_adapters.py#L684)[#](#scikitplot.corpus.MCPCorpusServer.handle_search "Link to this definition")
    ...
    list\_tools()[[source]](https://github.com/scikit-plots/scikit-plots/blob/db9d710b/scikitplot/corpus/_adapters.py#L726)[#](#scikitplot.corpus.MCPCorpusServer.list_tools "Link to this definition")
