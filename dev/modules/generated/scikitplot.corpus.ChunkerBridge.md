...
class scikitplot.corpus.ChunkerBridge(**inner**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/829d7a7/scikitplot/corpus/_chunkers/_chunker_bridge.py#L121)[#](#scikitplot.corpus.ChunkerBridge "Link to this definition")
:   Adapter that wraps a new-style chunker as a `ChunkerBase`-
    ...
    ****Developer note:**** `_base.py` calls exactly two things on a
    ...
    chunk(**text**, **metadata=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/829d7a7/scikitplot/corpus/_chunkers/_chunker_bridge.py#L160)[#](#scikitplot.corpus.ChunkerBridge.chunk "Link to this definition")
