...
class scikitplot.random.KissGenerator(**bit\_generator=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7ef1ffb/scikitplot/random/__init__.py#L)[#](#scikitplot.random.KissGenerator "Link to this definition")
:   High-level random number generator using KISS algorithm.
    ...
    [`numpy.random.Generator`](https://numpy.org/devdocs/reference/random/generator.html#numpy.random.Generator "(in NumPy v2.5.dev0)")
