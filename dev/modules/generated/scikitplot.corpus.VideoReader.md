...
class scikitplot.corpus.VideoReader(**input\_path**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_uri=None**, **source\_provenance=<factory>**, **custom\_extractor=None**, **custom\_extractor\_kwargs=<factory>**, **transcribe=False**, **whisper\_model='base'**, **subtitle\_frame\_rate=25.0**, **max\_file\_bytes=10737418240**, **yield\_frames=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_readers/_video.py#L481)[#](#scikitplot.corpus.VideoReader "Link to this definition")
:   Text extraction from video files via subtitle parsing and/or
    ...
    * `"transcript_type"` — `"whisper"` for Whisper transcription,
    ...
    classmethod from\_manifest(**manifest\_path**, **\***, **chunker=None**, **filter\_=None**, **default\_language=None**, **source\_type=None**, **source\_title=None**, **source\_author=None**, **source\_date=None**, **collection\_id=None**, **doi=None**, **isbn=None**, **encoding='utf-8'**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_base.py#L1848)[#](#scikitplot.corpus.VideoReader.from_manifest "Link to this definition")
    ...
    get\_documents()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_base.py#L1116)[#](#scikitplot.corpus.VideoReader.get_documents "Link to this definition")
    ...
    get\_raw\_chunks()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_readers/_video.py#L677)[#](#scikitplot.corpus.VideoReader.get_raw_chunks "Link to this definition")
    ...
    input\_path: [Path](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_readers/_video.py#L481)[#](#scikitplot.corpus.VideoReader.input_path "Link to this definition")
    ...
    classmethod subclass\_by\_type()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_base.py#L1420)[#](#scikitplot.corpus.VideoReader.subclass_by_type "Link to this definition")
    ...
    classmethod supported\_types()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_base.py#L1402)[#](#scikitplot.corpus.VideoReader.supported_types "Link to this definition")
    ...
    validate\_input()[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/corpus/_base.py#L931)[#](#scikitplot.corpus.VideoReader.validate_input "Link to this definition")
