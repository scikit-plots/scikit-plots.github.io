...
scikitplot.\_externals.\_sphinx\_ext.\_sphinx\_ai\_assistant.generate\_llms\_txt\_standalone(**md\_root**, **\***, **base\_url=''**, **output\_file=None**, **project\_name='Documentation'**, **max\_entries=None**, **full\_content=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/cdecb99/scikitplot/_externals/_sphinx_ext/_sphinx_ai_assistant/__init__.py#L3022)[#](#scikitplot._externals._sphinx_ext._sphinx_ai_assistant.generate_llms_txt_standalone "Link to this definition")
