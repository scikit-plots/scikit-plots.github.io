...
:   Generate the Decile-wise Lift Plot from labels and probabilities.
    ...
    :   ****y\_true****array-like, shape (n\_samples,)
        ...
        ****title\_fontsize****str or int, optional, default=14
        :   Font size for the plot title. Use e.g., “small”, “medium”, “large” or integer-values
            (8, 10, 12, etc.).

        ****text\_fontsize****str or int, optional, default=10
    ...
    [`plot_lift_decile_wise`](#scikitplot.decile.kds.plot_lift_decile_wise "scikitplot.decile.kds.plot_lift_decile_wise")
