...
class scikitplot.corpus.WordChunker(**config=None**, **gensim\_dictionary=None**, **multilang\_config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/corpus/_chunkers/_word.py#L1055)[#](#scikitplot.corpus.WordChunker "Link to this definition")
:   Process a document at word level, producing normalised token chunks.
    ...
    ****Developer note:**** Inherits `MultilangMixin`. Token-level
    ...
    attach\_embedding(**chunk**, **vector**, **\***, **model\_name=None**, **model\_version=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/corpus/_chunkers/_multilang_mixin.py#L783)[#](#scikitplot.corpus.WordChunker.attach_embedding "Link to this definition")
    ...
    attach\_embedding\_batch(**chunks**, **vectors**, **\***, **model\_name=None**, **model\_version=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/corpus/_chunkers/_multilang_mixin.py#L840)[#](#scikitplot.corpus.WordChunker.attach_embedding_batch "Link to this definition")
    ...
    static build\_gensim\_dictionary(**token\_lists**, **no\_below=2**, **no\_above=0.9**, **keep\_n=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/corpus/_chunkers/_word.py#L1520)[#](#scikitplot.corpus.WordChunker.build_gensim_dictionary "Link to this definition")
    ...
    chunk(**text**, **doc\_id=None**, **extra\_metadata=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/corpus/_chunkers/_word.py#L1384)[#](#scikitplot.corpus.WordChunker.chunk "Link to this definition")
    ...
    chunk\_batch(**texts**, **doc\_ids=None**, **extra\_metadata=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/corpus/_chunkers/_word.py#L1471)[#](#scikitplot.corpus.WordChunker.chunk_batch "Link to this definition")
    ...
    static vocabulary\_stats(**token\_lists**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/corpus/_chunkers/_word.py#L1573)[#](#scikitplot.corpus.WordChunker.vocabulary_stats "Link to this definition")
