...
scikitplot.api.metrics.plot\_roc\_curve(**y\_true**, **y\_probas**, **title='ROC Curves'**, **curves=('micro', 'macro', 'each\_class')**, **ax=None**, **figsize=None**, **cmap='nipy\_spectral'**, **title\_fontsize='large'**, **text\_fontsize='medium'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/829d7a7/scikitplot/api/metrics/_classification/_roc_curve.py#L45)[#](#scikitplot.api.metrics.plot_roc_curve "Link to this definition")
