...
scikitplot.corpus.to\_numpy\_arrays(**documents**, **\***, **include\_text=True**, **include\_raw\_tensor=True**, **include\_embedding=True**, **include\_metadata=True**, **dtype\_map=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/2e65b07/scikitplot/corpus/_adapters.py#L784)[#](#scikitplot.corpus.to_numpy_arrays "Link to this definition")
