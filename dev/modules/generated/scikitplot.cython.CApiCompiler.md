...
class scikitplot.cython.CApiCompiler[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/cython/_custom_compiler.py#L1012)[#](#scikitplot.cython.CApiCompiler "Link to this definition")
:   Built-in custom compiler: NumPy C-API projects.
    ...
    ****Master user note****: register this compiler and pass your C source
    ...
    \_\_call\_\_(**source**, **\***, **build\_dir**, **module\_name**, **extra\_sources=None**, **include\_dirs=None**, **extra\_compile\_args=None**, **extra\_link\_args=None**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/cython/_custom_compiler.py#L1049)[#](#scikitplot.cython.CApiCompiler.__call__ "Link to this definition")
