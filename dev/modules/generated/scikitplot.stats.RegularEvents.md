...
class scikitplot.stats.RegularEvents(**dt**, **p0=0.05**, **gamma=None**, **ncp\_prior=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L498)[#](#scikitplot.stats.RegularEvents "Link to this definition")
:   Bayesian blocks fitness for regular events.
    ...
    compute\_ncp\_prior(**N**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L327)[#](#scikitplot.stats.RegularEvents.compute_ncp_prior "Link to this definition")
    ...
    fit(**t**, **x=None**, **sigma=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L342)[#](#scikitplot.stats.RegularEvents.fit "Link to this definition")
    ...
    fitness(**T\_k**, **N\_k**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L545)[#](#scikitplot.stats.RegularEvents.fitness "Link to this definition")
    :   Parameters:
    ...
    p0\_prior(**N**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L310)[#](#scikitplot.stats.RegularEvents.p0_prior "Link to this definition")
    ...
    validate\_input(**t**, **x=None**, **sigma=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/cexternals/_astropy/stats/bayesian_blocks.py#L534)[#](#scikitplot.stats.RegularEvents.validate_input "Link to this definition")
