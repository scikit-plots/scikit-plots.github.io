...
scikitplot.cython.import\_extension\_from\_path(**artifact\_path**, **\***, **module\_name=None**, **key=None**, **build\_dir=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/cython/_loader.py#L119)[#](#scikitplot.cython.import_extension_from_path "Link to this definition")
