...
class scikitplot.preprocessing.GetDummies(**\***, **columns=None**, **sep='**, **'**, **col\_name\_sep='\_'**, **drop=None**, **sparse\_output=False**, **dtype=<class 'numpy.float64'>**, **handle\_unknown='error'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/preprocessing/_encoders.py#L80)[#](#scikitplot.preprocessing.GetDummies "Link to this definition")
:   Multi-column multi-label string column one-hot encoder [[1]](#rbcee2ffc57f9-1).
    ...
    fit(**X**, **y=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/preprocessing/_encoders.py#L360)[#](#scikitplot.preprocessing.GetDummies.fit "Link to this definition")
    :   Learn dummy categories from training data.

        Stores column order, prefixes, and categories for later alignment.

    fit\_transform(**X**, **y=None**, **\*\*fit\_params**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/../sklearn/base.py#L851)[#](#scikitplot.preprocessing.GetDummies.fit_transform "Link to this definition")
    ...
    get\_feature\_names\_out(**input\_features=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/preprocessing/_encoders.py#L488)[#](#scikitplot.preprocessing.GetDummies.get_feature_names_out "Link to this definition")
    :   Return feature names after transformation.

    get\_metadata\_routing()[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/../sklearn/utils/_metadata_requests.py#L1550)[#](#scikitplot.preprocessing.GetDummies.get_metadata_routing "Link to this definition")
    ...
    get\_params(**deep=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/../sklearn/base.py#L240)[#](#scikitplot.preprocessing.GetDummies.get_params "Link to this definition")
    ...
    set\_output(**\***, **transform=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/../sklearn/utils/_set_output.py#L389)[#](#scikitplot.preprocessing.GetDummies.set_output "Link to this definition")
    ...
    set\_params(**\*\*params**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/../sklearn/base.py#L338)[#](#scikitplot.preprocessing.GetDummies.set_params "Link to this definition")
    ...
    transform(**X**, **y=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/preprocessing/_encoders.py#L430)[#](#scikitplot.preprocessing.GetDummies.transform "Link to this definition")
