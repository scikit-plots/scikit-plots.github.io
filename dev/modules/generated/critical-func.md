...
scikitplot.logging.critical(**msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/71eae2e/scikitplot/logging.py#L1406)[#](#scikitplot.logging.critical "Link to this definition")
