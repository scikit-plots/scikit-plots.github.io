...
scikitplot.visualkeras.graph\_view(**model**, **to\_file=None**, **color\_map=None**, **node\_size=50**, **background\_fill='white'**, **padding=10**, **layer\_spacing=250**, **node\_spacing=10**, **connector\_fill='gray'**, **connector\_width=1**, **ellipsize\_after=10**, **inout\_as\_tensor=True**, **show\_neurons=True**, **backend=None**, **show\_os\_viewer=False**, **show\_fig=True**, **save\_fig=False**, **save\_fig\_filename=''**, **overwrite=True**, **add\_timestamp=False**, **verbose=False**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/82d02fb/scikitplot/visualkeras/_graph.py#L120)[#](#scikitplot.visualkeras.graph_view "Link to this definition")
