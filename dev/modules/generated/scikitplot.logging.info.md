...
scikitplot.logging.info(**msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7ef1ffb/scikitplot/logging.py#L1521)[#](#scikitplot.logging.info "Link to this definition")
