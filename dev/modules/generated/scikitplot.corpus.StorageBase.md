...
class scikitplot.corpus.StorageBase[[source]](https://github.com/scikit-plots/scikit-plots/blob/8ec94fe1/scikitplot/corpus/_storage/_storage.py#L142)[#](#scikitplot.corpus.StorageBase "Link to this definition")
:   Abstract base class for all corpus storage backends.
    ...
    count()[[source]](https://github.com/scikit-plots/scikit-plots/blob/8ec94fe1/scikitplot/corpus/_storage/_storage.py#L209)[#](#scikitplot.corpus.StorageBase.count "Link to this definition")
    ...
    abstractmethod get(**doc\_id**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/8ec94fe1/scikitplot/corpus/_storage/_storage.py#L178)[#](#scikitplot.corpus.StorageBase.get "Link to this definition")
    ...
    abstractmethod query(**q**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/8ec94fe1/scikitplot/corpus/_storage/_storage.py#L194)[#](#scikitplot.corpus.StorageBase.query "Link to this definition")
    ...
    abstractmethod save(**doc**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/8ec94fe1/scikitplot/corpus/_storage/_storage.py#L156)[#](#scikitplot.corpus.StorageBase.save "Link to this definition")
    ...
    abstractmethod save\_batch(**docs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/8ec94fe1/scikitplot/corpus/_storage/_storage.py#L167)[#](#scikitplot.corpus.StorageBase.save_batch "Link to this definition")
