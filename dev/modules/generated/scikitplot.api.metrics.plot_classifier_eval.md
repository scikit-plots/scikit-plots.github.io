...
scikitplot.api.metrics.plot\_classifier\_eval(**y\_true**, **y\_pred**, **\***, **labels=None**, **normalize=None**, **digits=3**, **title='train'**, **title\_fontsize='large'**, **text\_fontsize='medium'**, **cmap=None**, **x\_tick\_rotation=0**, **figsize=(8, 3)**, **nrows=1**, **ncols=2**, **index=2**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/api/metrics/_classification/_confusion_matrix.py#L265)[#](#scikitplot.api.metrics.plot_classifier_eval "Link to this definition")
