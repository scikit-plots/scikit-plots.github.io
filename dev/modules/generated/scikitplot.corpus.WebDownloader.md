...
class scikitplot.corpus.WebDownloader(**input\_url**, **output\_path=None**, **timeout=30.0**, **max\_bytes=104857600**, **verify\_ssl=True**, **block\_private\_ips=True**, **max\_redirects=5**, **user\_agent='Mozilla/5.0 (compatible; scikitplot-corpus/1.0; +https://github.com/scikit-plots/scikit-plots)'**, **max\_retries=3**, **retry\_backoff=1.0**, **headers=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/ee25698/scikitplot/corpus/_downloader/_web.py#L41)[#](#scikitplot.corpus.WebDownloader "Link to this definition")
:   Generic HTTP/HTTPS file downloader.
    ...
    ****SSL verification:**** Setting `verify_ssl=False` disables certificate
    ...
    cleanup()[[source]](https://github.com/scikit-plots/scikit-plots/blob/ee25698/scikitplot/corpus/_downloader/_base.py#L460)[#](#scikitplot.corpus.WebDownloader.cleanup "Link to this definition")
    ...
    download()[[source]](https://github.com/scikit-plots/scikit-plots/blob/ee25698/scikitplot/corpus/_downloader/_web.py#L138)[#](#scikitplot.corpus.WebDownloader.download "Link to this definition")
    ...
    input\_url: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/ee25698/scikitplot/corpus/_downloader/_web.py#L41)[#](#scikitplot.corpus.WebDownloader.input_url "Link to this definition")
