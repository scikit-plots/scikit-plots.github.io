...
class scikitplot.corpus.CorpusBuilder(**config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L390)[#](#scikitplot.corpus.CorpusBuilder "Link to this definition")
:   Unified corpus builder — end-to-end pipeline orchestrator.
    ...
    ****Developer note:**** The builder is the single orchestration
    ...
    add(**input\_path**, **\***, **source\_title=None**, **source\_author=None**, **source\_type=None**, **collection\_id=None**, **rebuild\_index=True**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L710)[#](#scikitplot.corpus.CorpusBuilder.add "Link to this definition")
    ...
    build(**input\_path**, **\***, **source\_title=None**, **source\_author=None**, **collection\_id=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L547)[#](#scikitplot.corpus.CorpusBuilder.build "Link to this definition")
    ...
    close()[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L515)[#](#scikitplot.corpus.CorpusBuilder.close "Link to this definition")
    ...
    export(**path**, **\***, **format='parquet'**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L1075)[#](#scikitplot.corpus.CorpusBuilder.export "Link to this definition")
    ...
    search(**query**, **\***, **top\_k=10**, **match\_mode='hybrid'**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L842)[#](#scikitplot.corpus.CorpusBuilder.search "Link to this definition")
    ...
    to\_huggingface()[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L1042)[#](#scikitplot.corpus.CorpusBuilder.to_huggingface "Link to this definition")
    ...
    to\_jsonl()[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L1064)[#](#scikitplot.corpus.CorpusBuilder.to_jsonl "Link to this definition")
    ...
    to\_langchain()[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L915)[#](#scikitplot.corpus.CorpusBuilder.to_langchain "Link to this definition")
    ...
    to\_langchain\_retriever()[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L1021)[#](#scikitplot.corpus.CorpusBuilder.to_langchain_retriever "Link to this definition")
    ...
    to\_langgraph\_state(**query=''**, **match\_mode=''**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L926)[#](#scikitplot.corpus.CorpusBuilder.to_langgraph_state "Link to this definition")
    ...
    to\_mcp\_resources(**uri\_prefix='corpus://'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L945)[#](#scikitplot.corpus.CorpusBuilder.to_mcp_resources "Link to this definition")
    ...
    to\_mcp\_server(**server\_name='corpus-search'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L994)[#](#scikitplot.corpus.CorpusBuilder.to_mcp_server "Link to this definition")
    ...
    to\_mcp\_tool\_result(**query**, **\***, **top\_k=10**, **match\_mode='hybrid'**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L962)[#](#scikitplot.corpus.CorpusBuilder.to_mcp_tool_result "Link to this definition")
    ...
    to\_rag\_tuples()[[source]](https://github.com/scikit-plots/scikit-plots/blob/3bacd52/scikitplot/corpus/_corpus_builder.py#L1053)[#](#scikitplot.corpus.CorpusBuilder.to_rag_tuples "Link to this definition")
