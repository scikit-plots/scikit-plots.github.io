...
scikitplot.utils.\_path.make\_path(**prefix=''**, **suffix=''**, **ext=''**, **root=PosixPath('scikitplot-artifacts')**, **\***, **by\_day=False**, **add\_secret=False**, **private=False**, **mkdir=True**, **subdir=None**, **now=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/2eeb508/scikitplot/utils/_path.py#L580)[#](#scikitplot.utils._path.make_path "Link to this definition")
