...
scikitplot.logging.error\_log(**error\_msg**, **\*args**, **level=40**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8f33de/scikitplot/logging.py#L1445)[#](#scikitplot.logging.error_log "Link to this definition")
