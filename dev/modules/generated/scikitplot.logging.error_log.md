...
scikitplot.logging.error\_log(**error\_msg**, **\*args**, **level=40**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/5fb281e/scikitplot/logging.py#L1447)[#](#scikitplot.logging.error_log "Link to this definition")
