...
scikitplot.mlflow.workflow(**\***, **profile='local'**, **open\_ui\_seconds=0.0**, **experiment\_name=None**, **fmt='toml'**, **overwrite=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c2567fd/scikitplot/mlflow/_workflow.py#L373)[#](#scikitplot.mlflow.workflow "Link to this definition")
