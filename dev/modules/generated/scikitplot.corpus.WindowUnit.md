...
class scikitplot.corpus.WindowUnit(**\*values**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/corpus/_chunkers/_fixed_window.py#L87)[#](#scikitplot.corpus.WindowUnit "Link to this definition")
:   Unit of measurement for window size and step.

    CHARS = 'chars'[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/corpus/_chunkers/_fixed_window.py#L)[#](#scikitplot.corpus.WindowUnit.CHARS "Link to this definition")

    TOKENS = 'tokens'[[source]](https://github.com/scikit-plots/scikit-plots/blob/9359828/scikitplot/corpus/_chunkers/_fixed_window.py#L)[#](#scikitplot.corpus.WindowUnit.TOKENS "Link to this definition")
