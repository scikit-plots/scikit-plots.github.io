...
class scikitplot.cexternals.\_annoy.Annoy[[source]](https://github.com/scikit-plots/scikit-plots/blob/8ec94fe1/scikitplot/cexternals/_annoy/__init__.py#L)[#](#scikitplot.cexternals._annoy.Annoy "Link to this definition")
:   Compiled with GCC/Clang. Using 512-bit AVX instructions.
    ...
    :   ****f****int or None, optional, default=None
        ...
        ****metric****{“angular”, “cosine”, “euclidean”, “l2”, “lstsq”, “manhattan”, “l1”, “cityblock”, “taxicab”, “dot”, “@”, “.”, “dotproduct”, “inner”, “innerproduct”, “hamming”} or None, optional, default=None
        :   Distance metric (one of ‘angular’, ‘euclidean’, ‘manhattan’, ‘dot’, ‘hamming’).
            ...
            * If `f == 0`: leaves the metric unset (lazy). You may set
              [`metric`](#scikitplot.cexternals._annoy.Annoy.metric "scikitplot.cexternals._annoy.Annoy.metric") later before construction, or it will default to
              `'angular'` on first [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item").
        ...
        ****on\_disk\_path****str or None, optional, default=None
        :   If provided, configures the path for on-disk building. When the underlying
            ...
            [`on_disk_build`](#scikitplot.cexternals._annoy.Annoy.on_disk_build "scikitplot.cexternals._annoy.Annoy.on_disk_build") with the same filename).
            ...
            [`on_disk_build`](#scikitplot.cexternals._annoy.Annoy.on_disk_build "scikitplot.cexternals._annoy.Annoy.on_disk_build") with the same filename (truncate allowed).
    ...
    Attributes:
    :   [`f`](#scikitplot.cexternals._annoy.Annoy.f "scikitplot.cexternals._annoy.Annoy.f")int, default=0
        :   Vector dimension.

        [`metric`](#scikitplot.cexternals._annoy.Annoy.metric "scikitplot.cexternals._annoy.Annoy.metric"){‘angular’, ‘euclidean’, ‘manhattan’, ‘dot’, ‘hamming’}, default=”angular”
        :   Distance metric for the index.

        [`n_neighbors`](#scikitplot.cexternals._annoy.Annoy.n_neighbors "scikitplot.cexternals._annoy.Annoy.n_neighbors")int, default=5
        :   Number of neighbors returned by transform/fit\_transform (SLEP013; strict schema).

        [`on_disk_path`](#scikitplot.cexternals._annoy.Annoy.on_disk_path "scikitplot.cexternals._annoy.Annoy.on_disk_path")str or None, optional, default=None
        :   Path used for on-disk build/load/save operations.

        [`prefault`](#scikitplot.cexternals._annoy.Annoy.prefault "scikitplot.cexternals._annoy.Annoy.prefault")bool, default=False
        :   Default prefault flag stored on the object.

        [`seed`](#scikitplot.cexternals._annoy.Annoy.seed "scikitplot.cexternals._annoy.Annoy.seed")int or None, optional, default=None
        :   Random seed override (scikit-learn compatible).

        [`verbose`](#scikitplot.cexternals._annoy.Annoy.verbose "scikitplot.cexternals._annoy.Annoy.verbose")int or None, optional, default=None
        :   Verbosity level in [-2, 2] or None (unset).

        [`schema_version`](#scikitplot.cexternals._annoy.Annoy.schema_version "scikitplot.cexternals._annoy.Annoy.schema_version")int, default=0
        :   Serialization/compatibility strategy marker sentinel value.

        [`n_features`](#scikitplot.cexternals._annoy.Annoy.n_features "scikitplot.cexternals._annoy.Annoy.n_features")int
        :   Alias of `f` (dimension), provided for scikit-learn naming parity.

        [`n_features_out_`](#scikitplot.cexternals._annoy.Annoy.n_features_out_ "scikitplot.cexternals._annoy.Annoy.n_features_out_")int
        :   Number of output features produced by transform (SLEP013).

        [`feature_names_in_`](#scikitplot.cexternals._annoy.Annoy.feature_names_in_ "scikitplot.cexternals._annoy.Annoy.feature_names_in_")list-like
        :   Input feature names seen during fit (SLEP007).

        [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y")list-like | None, optional, default=None
        :   y : list[object] | None

        [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map")dict | None, optional, default=None
        :   y\_map : dict[int, object] | None

    > **See also**
    > [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item")
    :   Add a vector to the index.

    [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build")
    :   Build the forest after adding items.

    [`unbuild`](#scikitplot.cexternals._annoy.Annoy.unbuild "scikitplot.cexternals._annoy.Annoy.unbuild")
    :   Remove trees to allow adding more items.

    [`get_nns_by_item`](#scikitplot.cexternals._annoy.Annoy.get_nns_by_item "scikitplot.cexternals._annoy.Annoy.get_nns_by_item"), [`get_nns_by_vector`](#scikitplot.cexternals._annoy.Annoy.get_nns_by_vector "scikitplot.cexternals._annoy.Annoy.get_nns_by_vector")
    :   Query nearest neighbours.

    [`save`](#scikitplot.cexternals._annoy.Annoy.save "scikitplot.cexternals._annoy.Annoy.save"), [`load`](#scikitplot.cexternals._annoy.Annoy.load "scikitplot.cexternals._annoy.Annoy.load")
    :   Persist the index to/from disk.

    [`serialize`](#scikitplot.cexternals._annoy.Annoy.serialize "scikitplot.cexternals._annoy.Annoy.serialize"), [`deserialize`](#scikitplot.cexternals._annoy.Annoy.deserialize "scikitplot.cexternals._annoy.Annoy.deserialize")
    :   Persist the index to/from bytes.

    [`set_seed`](#scikitplot.cexternals._annoy.Annoy.set_seed "scikitplot.cexternals._annoy.Annoy.set_seed")
    :   Set the random seed deterministically.

    [`set_verbose`](#scikitplot.cexternals._annoy.Annoy.set_verbose "scikitplot.cexternals._annoy.Annoy.set_verbose")
    :   Set verbosity level.

    [`info`](#scikitplot.cexternals._annoy.Annoy.info "scikitplot.cexternals._annoy.Annoy.info")
    ...
    * If `f == 0`, the dimensionality is inferred from the first non-empty vector
      passed to [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item") and is then fixed for the lifetime of the index.
    * Assigning `None` to [`f`](#scikitplot.cexternals._annoy.Annoy.f "scikitplot.cexternals._annoy.Annoy.f") is not supported. Use `0` for lazy
    ...
    * Items must be added **before** calling [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build"). After [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build"), the
      index becomes read-only; to add more items, call [`unbuild`](#scikitplot.cexternals._annoy.Annoy.unbuild "scikitplot.cexternals._annoy.Annoy.unbuild"), add items
      again with [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item"), then call [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build") again.
    * Very large indexes can be built directly on disk with [`on_disk_build`](#scikitplot.cexternals._annoy.Annoy.on_disk_build "scikitplot.cexternals._annoy.Annoy.on_disk_build")
      and then memory-mapped with [`load`](#scikitplot.cexternals._annoy.Annoy.load "scikitplot.cexternals._annoy.Annoy.load").
    * [`info`](#scikitplot.cexternals._annoy.Annoy.info "scikitplot.cexternals._annoy.Annoy.info") returns a structured summary (dimension, metric, counts, and
    ...
    * Invariant:
    ...
    call to [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item").
    ...
    After [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build") the index becomes read-only. You can still
    ...
    :   Add a single embedding vector to the index.
        ...
        Returns:
        :   [`Annoy`](#scikitplot.cexternals._annoy.Annoy "scikitplot.cexternals._annoy.Annoy")
        ...
        Items must be added **before** calling [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build"). After building
        the forest, further calls to [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item") are not supported.
    ...
    :   Build a forest of random projection trees.
        ...
        > **See also**
        > [`fit`](#scikitplot.cexternals._annoy.Annoy.fit "scikitplot.cexternals._annoy.Annoy.fit")
        ...
        [`rebuild`](#scikitplot.cexternals._annoy.Annoy.rebuild "scikitplot.cexternals._annoy.Annoy.rebuild")
        :   Return a new Annoy index rebuilt from the current index contents.

        [`on_disk_build`](#scikitplot.cexternals._annoy.Annoy.on_disk_build "scikitplot.cexternals._annoy.Annoy.on_disk_build")
        ...
        After [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build") completes, the index becomes read-only for queries.
        To add more items, call [`unbuild`](#scikitplot.cexternals._annoy.Annoy.unbuild "scikitplot.cexternals._annoy.Annoy.unbuild"), add items, and then rebuild.
    ...
    :   Restore the index from a serialized byte string.
        ...
        Parameters:
        :   ****byte****bytes
            :   Byte string produced by [`serialize`](#scikitplot.cexternals._annoy.Annoy.serialize "scikitplot.cexternals._annoy.Annoy.serialize"). Both native (legacy)
            ...
            ****prefault****bool or None, optional, default=None
            :   Accepted for API symmetry with [`load`](#scikitplot.cexternals._annoy.Annoy.load "scikitplot.cexternals._annoy.Annoy.load"). If None, the stored
                Ignored for canonical blobs.
                [`prefault`](#scikitplot.cexternals._annoy.Annoy.prefault "scikitplot.cexternals._annoy.Annoy.prefault") value is used.
        ...
        > **See also**
        > [`serialize`](#scikitplot.cexternals._annoy.Annoy.serialize "scikitplot.cexternals._annoy.Annoy.serialize")
    ...
    f[#](#scikitplot.cexternals._annoy.Annoy.f "Link to this definition")
    :   Vector dimension.
        ...
        * `0` (or `None`) means “unknown / lazy”: the first call to [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item")
        ...
        all items, trees, and label metadata ([`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") and [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y"))). You must call [`fit`](#scikitplot.cexternals._annoy.Annoy.fit "scikitplot.cexternals._annoy.Annoy.fit") (or
        [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item") + [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build")) again before querying.

    feature\_names\_in\_[#](#scikitplot.cexternals._annoy.Annoy.feature_names_in_ "Link to this definition")
    :   Input feature names seen during fit (SLEP007). Set only when explicitly provided via fit(…, feature\_names=…).

    fit(**X=None**, **y=None**, **\***, **y\_map=None**, **n\_trees=-1**, **n\_jobs=-1**, **reset=True**, **start\_index=None**, **missing\_value=None**, **feature\_names=None**)[#](#scikitplot.cexternals._annoy.Annoy.fit "Link to this definition")
    :   Fit the Annoy index (scikit-learn compatible).
        ...
        > **See also**
        > [`fit_transform`](#scikitplot.cexternals._annoy.Annoy.fit_transform "scikitplot.cexternals._annoy.Annoy.fit_transform")
        :   Estimator-style APIs.

        [`transform`](#scikitplot.cexternals._annoy.Annoy.transform "scikitplot.cexternals._annoy.Annoy.transform")
        ...
        [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map"), [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y")
        :   Stored label metadata (canonical mapping and dense cache).

        [`get_params`](#scikitplot.cexternals._annoy.Annoy.get_params "scikitplot.cexternals._annoy.Annoy.get_params"), [`set_params`](#scikitplot.cexternals._annoy.Annoy.set_params "scikitplot.cexternals._annoy.Annoy.set_params")
    ...
    :   Fit the index and transform X in a single deterministic call.
        ...
        This is equivalent to calling [`fit`](#scikitplot.cexternals._annoy.Annoy.fit "scikitplot.cexternals._annoy.Annoy.fit") followed by [`transform`](#scikitplot.cexternals._annoy.Annoy.transform "scikitplot.cexternals._annoy.Annoy.transform").

        Parameters:
        :   ****X****array-like
            :   Training data / queries. See [`fit`](#scikitplot.cexternals._annoy.Annoy.fit "scikitplot.cexternals._annoy.Annoy.fit") and [`transform`](#scikitplot.cexternals._annoy.Annoy.transform "scikitplot.cexternals._annoy.Annoy.transform").
        ...
        Returns:
        :   ****neighbors****object
            :   The output of [`transform`](#scikitplot.cexternals._annoy.Annoy.transform "scikitplot.cexternals._annoy.Annoy.transform") for `X` under the provided query options.
    ...
    get\_feature\_names\_out(**input\_features=None**)[#](#scikitplot.cexternals._annoy.Annoy.get_feature_names_out "Link to this definition")
    :   Get output feature names for the transformer-style API.
        ...
        Raises:
        :   AttributeError
            :   If called before [`fit`](#scikitplot.cexternals._annoy.Annoy.fit "scikitplot.cexternals._annoy.Annoy.fit")/`build`.

            ValueError
            :   If `input_features` is provided but does not match
                [`feature_names_in_`](#scikitplot.cexternals._annoy.Annoy.feature_names_in_ "scikitplot.cexternals._annoy.Annoy.feature_names_in_").

    get\_item(**i**) → [list](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")[[float](https://docs.python.org/3/library/functions.html#float "(in Python v3.14)")][#](#scikitplot.cexternals._annoy.Annoy.get_item "Link to this definition")
    :   Return the stored embedding vector for a given item id.

        Parameters:
        :   ****i****int
            :   Item id (index) previously passed to [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item").
    ...
    get\_n\_items() → [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")[#](#scikitplot.cexternals._annoy.Annoy.get_n_items "Link to this definition")
    ...
    get\_n\_trees() → [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")[#](#scikitplot.cexternals._annoy.Annoy.get_n_trees "Link to this definition")
    ...
    get\_nns\_by\_item(**i**, **n**, **search\_k=-1**, **include\_distances=False**)[#](#scikitplot.cexternals._annoy.Annoy.get_nns_by_item "Link to this definition")
    :   Return the `n` nearest neighbours for a stored item id.
        ...
        > **See also**
        > [`get_nns_by_vector`](#scikitplot.cexternals._annoy.Annoy.get_nns_by_vector "scikitplot.cexternals._annoy.Annoy.get_nns_by_vector")
        :   Query with an explicit query embedding.

    get\_nns\_by\_vector(**vector**, **n**, **search\_k=-1**, **include\_distances=False**)[#](#scikitplot.cexternals._annoy.Annoy.get_nns_by_vector "Link to this definition")
    :   Return the `n` nearest neighbours for a query embedding.
        ...
        > **See also**
        > [`get_nns_by_item`](#scikitplot.cexternals._annoy.Annoy.get_nns_by_item "scikitplot.cexternals._annoy.Annoy.get_nns_by_item")
        :   Query by stored item id.

    get\_params(**deep=True**) → [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[#](#scikitplot.cexternals._annoy.Annoy.get_params "Link to this definition")
    :   Return estimator-style parameters (scikit-learn compatibility).
        ...
        > **See also**
        > [`set_params`](#scikitplot.cexternals._annoy.Annoy.set_params "scikitplot.cexternals._annoy.Annoy.set_params")
        :   Set estimator-style parameters.

        [`schema_version`](#scikitplot.cexternals._annoy.Annoy.schema_version "scikitplot.cexternals._annoy.Annoy.schema_version")
    ...
    :   Return a structured summary of the index.
            ...
            ****include\_memory****bool or None, optional, default=None
            :   Controls whether memory usage fields are included.
                ...
                * `False`: omit memory usage fields.
                ...
                Memory usage is computed after [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build") and may be expensive for
                very large indexes.
        ...
        [`deserialize`](#scikitplot.cexternals._annoy.Annoy.deserialize "scikitplot.cexternals._annoy.Annoy.deserialize")
        :   Restore from a binary snapshot.

        [`save`](#scikitplot.cexternals._annoy.Annoy.save "scikitplot.cexternals._annoy.Annoy.save")
        :   Persist the index to disk.

        [`load`](#scikitplot.cexternals._annoy.Annoy.load "scikitplot.cexternals._annoy.Annoy.load")
    ...
    :   Load (mmap) an index from disk into the current object.
        ...
        Parameters:
        :   ****fn****str
            :   Path to a file previously created by [`save`](#scikitplot.cexternals._annoy.Annoy.save "scikitplot.cexternals._annoy.Annoy.save") or
                [`on_disk_build`](#scikitplot.cexternals._annoy.Annoy.on_disk_build "scikitplot.cexternals._annoy.Annoy.on_disk_build").

            ****prefault****bool or None, optional, default=None
            :   If True, fault pages into memory when the file is mapped.
                If None, use the stored [`prefault`](#scikitplot.cexternals._annoy.Annoy.prefault "scikitplot.cexternals._annoy.Annoy.prefault") value.
                Primarily useful on some platforms for very large indexes.
        ...
        [`unload`](#scikitplot.cexternals._annoy.Annoy.unload "scikitplot.cexternals._annoy.Annoy.unload")
    ...
    memory\_usage() → [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)")[#](#scikitplot.cexternals._annoy.Annoy.memory_usage "Link to this definition")
    ...
    metric[#](#scikitplot.cexternals._annoy.Annoy.metric "Link to this definition")
    :   Distance metric for the index. Valid values:
        ...
        * hamming : hamming
        ...
        trees, and label metadata ([`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") and [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y")). You must call [`fit`](#scikitplot.cexternals._annoy.Annoy.fit "scikitplot.cexternals._annoy.Annoy.fit") (or [`add_item`](#scikitplot.cexternals._annoy.Annoy.add_item "scikitplot.cexternals._annoy.Annoy.add_item") +
        [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build")) again before querying.

    n\_features[#](#scikitplot.cexternals._annoy.Annoy.n_features "Link to this definition")
    :   Alias of `f` (dimension), provided for scikit-learn naming parity.

    n\_features\_[#](#scikitplot.cexternals._annoy.Annoy.n_features_ "Link to this definition")
    :   Read-only alias of `n_features_in_`.

    n\_features\_in\_[#](#scikitplot.cexternals._annoy.Annoy.n_features_in_ "Link to this definition")
    :   Number of features seen during fit (scikit-learn compatible). Alias of `f` when available.

    n\_features\_out\_[#](#scikitplot.cexternals._annoy.Annoy.n_features_out_ "Link to this definition")
    :   Number of output features produced by transform (SLEP013). Equals n\_neighbors once fitted.

    n\_neighbors[#](#scikitplot.cexternals._annoy.Annoy.n_neighbors "Link to this definition")
    :   Number of neighbors returned by transform/fit\_transform (SLEP013; strict schema).

    on\_disk\_build(**fn**)[#](#scikitplot.cexternals._annoy.Annoy.on_disk_build "Link to this definition")
    ...
    on\_disk\_path[#](#scikitplot.cexternals._annoy.Annoy.on_disk_path "Link to this definition")
    :   Path used for on-disk build/load/save operations.
        ...
        * Assigning a string/PathLike to `on_disk_path` configures on-disk build mode
          (equivalent to calling [`on_disk_build`](#scikitplot.cexternals._annoy.Annoy.on_disk_build "scikitplot.cexternals._annoy.Annoy.on_disk_build") with the same filename).
        * Note: Annoy core truncates the target file when enabling on-disk build.
          `on_disk_path` is strictly equivalent to calling [`on_disk_build`](#scikitplot.cexternals._annoy.Annoy.on_disk_build "scikitplot.cexternals._annoy.Annoy.on_disk_build")
        ...
        * Clearing/changing this while an on-disk index is active is disallowed.
          Call [`unload`](#scikitplot.cexternals._annoy.Annoy.unload "scikitplot.cexternals._annoy.Annoy.unload") first.

    prefault[#](#scikitplot.cexternals._annoy.Annoy.prefault "Link to this definition")
    :   Default prefault flag stored on the object.

        This setting is used as the default for per-call `prefault` arguments when
        `prefault` is omitted or set to `None` in methods like [`load`](#scikitplot.cexternals._annoy.Annoy.load "scikitplot.cexternals._annoy.Annoy.load") and
        [`save`](#scikitplot.cexternals._annoy.Annoy.save "scikitplot.cexternals._annoy.Annoy.save").
    ...
    random\_state[#](#scikitplot.cexternals._annoy.Annoy.random_state "Link to this definition")
    :   Alias of `seed` (scikit-learn convention).

    rebuild(**metric=None**, **\***, **on\_disk\_path=None**, **n\_trees=None**, **n\_jobs=-1**) → [Annoy](#scikitplot.cexternals._annoy.Annoy "scikitplot.cexternals._annoy.Annoy")[#](#scikitplot.cexternals._annoy.Annoy.rebuild "Link to this definition")
    :   Return a new Annoy index rebuilt from the current index contents.
        ...
        [`get_params`](#scikitplot.cexternals._annoy.Annoy.get_params "scikitplot.cexternals._annoy.Annoy.get_params")
    ...
    repr\_info(**include\_n\_items=True**, **include\_n\_trees=True**, **include\_memory=None**) → [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")[#](#scikitplot.cexternals._annoy.Annoy.repr_info "Link to this definition")
    :   Return a dict-like string representation with optional extra fields.
        ...
        Memory is calculated after [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build").

    save(**fn**, **prefault=None**)[#](#scikitplot.cexternals._annoy.Annoy.save "Link to this definition")
    :   Persist the index to a binary file on disk.
        ...
        Use prefault=None to fall back to the stored [`prefault`](#scikitplot.cexternals._annoy.Annoy.prefault "scikitplot.cexternals._annoy.Annoy.prefault") setting.

    schema\_version[#](#scikitplot.cexternals._annoy.Annoy.schema_version "Link to this definition")
    :   Serialization/compatibility strategy marker sentinel value.
    ...
    seed[#](#scikitplot.cexternals._annoy.Annoy.seed "Link to this definition")
    :   Random seed override (scikit-learn compatible). None means use Annoy default seed.

    serialize(**format=None**) → [bytes](https://docs.python.org/3/library/stdtypes.html#bytes "(in Python v3.14)")[#](#scikitplot.cexternals._annoy.Annoy.serialize "Link to this definition")
    ...
    set\_params(**\*\*params**) → [Annoy](#scikitplot.cexternals._annoy.Annoy "scikitplot.cexternals._annoy.Annoy")[#](#scikitplot.cexternals._annoy.Annoy.set_params "Link to this definition")
    :   Set estimator-style parameters (scikit-learn compatibility).
        ...
        trees, and label metadata ([`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") and [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y")). Refit/rebuild is required before querying.
    ...
    set\_seed(**seed=None**)[#](#scikitplot.cexternals._annoy.Annoy.set_seed "Link to this definition")
    :   Set the random seed used for tree construction.
        ...
        > **See also**
        > [`seed`](#scikitplot.cexternals._annoy.Annoy.seed "scikitplot.cexternals._annoy.Annoy.seed")
    ...
    set\_verbose(**verbosity=1**)[#](#scikitplot.cexternals._annoy.Annoy.set_verbose "Link to this definition")
    :   Set the verbosity level (callable setter).
        ...
        > **See also**
        > [`verbose`](#scikitplot.cexternals._annoy.Annoy.verbose "scikitplot.cexternals._annoy.Annoy.verbose")
        :   Parameter attribute (int | None).

        [`set_verbosity`](#scikitplot.cexternals._annoy.Annoy.set_verbosity "scikitplot.cexternals._annoy.Annoy.set_verbosity")
        :   Alias of [`set_verbose`](#scikitplot.cexternals._annoy.Annoy.set_verbose "scikitplot.cexternals._annoy.Annoy.set_verbose").

        [`get_params`](#scikitplot.cexternals._annoy.Annoy.get_params "scikitplot.cexternals._annoy.Annoy.get_params"), [`set_params`](#scikitplot.cexternals._annoy.Annoy.set_params "scikitplot.cexternals._annoy.Annoy.set_params")
        :   Estimator parameter API.

    set\_verbosity(**level=1**)[#](#scikitplot.cexternals._annoy.Annoy.set_verbosity "Link to this definition")
    :   Alias of [`set_verbose`](#scikitplot.cexternals._annoy.Annoy.set_verbose "scikitplot.cexternals._annoy.Annoy.set_verbose").
    ...
    transform(**X**, **\***, **n\_neighbors=5**, **search\_k=-1**, **include\_distances=False**, **return\_labels=False**, **y\_fill\_value=None**, **input\_type='vector'**, **output\_type='vector'**, **exclude\_self=False**, **exclude\_items=None**, **missing\_value=None**)[#](#scikitplot.cexternals._annoy.Annoy.transform "Link to this definition")
    :   Transform queries into nearest-neighbor results (ids or vectors; optional distances / labels).
        ...
        :   ****X****array-like
            ...
            ****return\_labels****bool, default=False
            :   If True, also return per-neighbor labels resolved from [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") (or [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y") cache).
    ...
    :   Discard the current forest, allowing new items to be added.
        ...
        After calling [`unbuild`](#scikitplot.cexternals._annoy.Annoy.unbuild "scikitplot.cexternals._annoy.Annoy.unbuild"), you must call [`build`](#scikitplot.cexternals._annoy.Annoy.build "scikitplot.cexternals._annoy.Annoy.build")
        again before running nearest-neighbour queries.

    unload()[#](#scikitplot.cexternals._annoy.Annoy.unload "Link to this definition")
    ...
    verbose[#](#scikitplot.cexternals._annoy.Annoy.verbose "Link to this definition")
    :   set\_verbose().

        Type:
        :   Verbosity level in [-2, 2] or None (unset). Callable setter

    y[#](#scikitplot.cexternals._annoy.Annoy.y "Link to this definition")
    :   list[object] | None
        ...
        Raises:
        :   TypeError
            :   If assigned a dict. Use [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") for dict mappings.
        ...
        > **See also**
        > [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map")
        :   Canonical sparse mapping of labels by item id.

        [`fit`](#scikitplot.cexternals._annoy.Annoy.fit "scikitplot.cexternals._annoy.Annoy.fit"), [`fit_transform`](#scikitplot.cexternals._annoy.Annoy.fit_transform "scikitplot.cexternals._annoy.Annoy.fit_transform")
        :   Set labels while fitting.

        Notes

        * [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") is the canonical storage. [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y") is a convenience cache
          that may be cleared and materialized from [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") on demand.
        * Setting `y` replaces [`y_map`](#scikitplot.cexternals._annoy.Annoy.y_map "scikitplot.cexternals._annoy.Annoy.y_map") deterministically.

        Type:
        :   [y](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y")

    y\_map[#](#scikitplot.cexternals._annoy.Annoy.y_map "Link to this definition")
    :   dict[int, object] | None
        ...
        * Missing keys imply “no label”; when [`y`](#scikitplot.cexternals._annoy.Annoy.y "scikitplot.cexternals._annoy.Annoy.y") is materialized, missing ids
          become `None`.
