...
scikitplot.logging.error(**msg**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/logging.py#L1429)[#](#scikitplot.logging.error "Link to this definition")
