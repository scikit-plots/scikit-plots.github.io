...
scikitplot.api.decomposition.plot\_pca\_component\_variance(**clf**, **\***, **target\_explained\_variance=0.75**, **model\_type=None**, **title='Cumulative Explained Variance Ratio by Principal Components'**, **title\_fontsize='large'**, **text\_fontsize='medium'**, **x\_tick\_rotation=0**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f800619/scikitplot/api/decomposition/_components.py#L35)[#](#scikitplot.api.decomposition.plot_pca_component_variance "Link to this definition")
