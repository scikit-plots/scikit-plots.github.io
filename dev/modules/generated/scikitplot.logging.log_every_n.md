...
scikitplot.logging.log\_every\_n(**level**, **msg**, **n**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/logging.py#L1630)[#](#scikitplot.logging.log_every_n "Link to this definition")
