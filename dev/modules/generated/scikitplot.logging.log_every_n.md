...
scikitplot.logging.log\_every\_n(**level**, **msg**, **n**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/d0ea3951/scikitplot/logging.py#L1620)[#](#scikitplot.logging.log_every_n "Link to this definition")
