...
scikitplot.logging.log\_every\_n(**level**, **msg**, **n**, **\*args**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/f02632e/scikitplot/logging.py#L1622)[#](#scikitplot.logging.log_every_n "Link to this definition")
