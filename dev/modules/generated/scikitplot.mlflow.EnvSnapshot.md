...
class scikitplot.mlflow.EnvSnapshot(**\_data**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/mlflow/_env.py#L23)[#](#scikitplot.mlflow.EnvSnapshot "Link to this definition")
:   Full snapshot of process environment for strict restoration.
    ...
    classmethod capture()[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/mlflow/_env.py#L45)[#](#scikitplot.mlflow.EnvSnapshot.capture "Link to this definition")
    ...
    restore()[[source]](https://github.com/scikit-plots/scikit-plots/blob/0ee15ed/scikitplot/mlflow/_env.py#L57)[#](#scikitplot.mlflow.EnvSnapshot.restore "Link to this definition")
