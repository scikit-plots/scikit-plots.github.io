...
class scikitplot.corpus.PipelineHooks(**pre\_read\_hook=None**, **post\_read\_hook=None**, **post\_filter\_hook=None**, **post\_embed\_hook=None**, **pre\_export\_hook=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/7ef1ffb/scikitplot/corpus/_custom_hooks.py#L864)[#](#scikitplot.corpus.PipelineHooks "Link to this definition")
