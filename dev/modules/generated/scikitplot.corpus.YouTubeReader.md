...
class scikitplot.corpus.YouTubeReader(**input\_path**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_uri=None**, **source\_provenance=<factory>**, **custom\_extractor=None**, **custom\_extractor\_kwargs=<factory>**, **preferred\_language=None**, **include\_auto\_generated=True**, **merge\_short\_cues=True**, **min\_cue\_chars=20**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_readers/_web.py#L593)[#](#scikitplot.corpus.YouTubeReader "Link to this definition")
:   Extract the transcript of a YouTube video using `youtube-transcript-api`.
    ...
    ****Quota:**** YouTube’s timedtext endpoint is rate-limited. For bulk
    ...
    get\_documents()[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_base.py#L1116)[#](#scikitplot.corpus.YouTubeReader.get_documents "Link to this definition")
    ...
    get\_raw\_chunks()[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_readers/_web.py#L759)[#](#scikitplot.corpus.YouTubeReader.get_raw_chunks "Link to this definition")
    ...
    input\_path: [Path](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_readers/_web.py#L593)[#](#scikitplot.corpus.YouTubeReader.input_path "Link to this definition")
    ...
    source\_provenance: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)")][[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_readers/_web.py#L593)[#](#scikitplot.corpus.YouTubeReader.source_provenance "Link to this definition")
    ...
    classmethod subclass\_by\_type()[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_base.py#L1431)[#](#scikitplot.corpus.YouTubeReader.subclass_by_type "Link to this definition")
    ...
    classmethod supported\_types()[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_base.py#L1413)[#](#scikitplot.corpus.YouTubeReader.supported_types "Link to this definition")
    ...
    validate\_input()[[source]](https://github.com/scikit-plots/scikit-plots/blob/c8953a1/scikitplot/corpus/_readers/_web.py#L716)[#](#scikitplot.corpus.YouTubeReader.validate_input "Link to this definition")
