...
scikitplot.corpus.extract\_archive(**archive\_path**, **output\_path**, **\***, **supported\_extensions=None**, **max\_files=10000**, **max\_total\_bytes=2147483648**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/33a338a/scikitplot/corpus/_archive_handler.py#L156)[#](#scikitplot.corpus.extract_archive "Link to this definition")
