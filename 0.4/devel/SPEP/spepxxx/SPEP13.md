# SEP13: Use properties for Artists[#](#sep13-use-properties-for-artists "Link to this heading")
...
[properties](https://docs.python.org/3/library/functions.html#property), allowing
...
Cases where there are set\_ATTR\_on() and set\_ATTR\_off() methods will be
changed to ATTR\_on properties.

## [Examples](#id7)[#](#examples "Link to this heading")

### [axes.Axes.set\_axis\_off/set\_axis\_on](#id8)[#](#axes-axes-set-axis-off-set-axis-on "Link to this heading")
...
### [axes.Axes.get\_xlim/set\_xlim and get\_autoscalex\_on/set\_autoscalex\_on](#id9)[#](#axes-axes-get-xlim-set-xlim-and-get-autoscalex-on-set-autoscalex-on "Link to this heading")
...
### [axes.Axes.get\_title/set\_title](#id10)[#](#axes-axes-get-title-set-title "Link to this heading")
...
### [axes.Axes.get\_xticklabels/set\_xticklabels](#id11)[#](#axes-axes-get-xticklabels-set-xticklabels "Link to this heading")
...
## [Alternatives](#id12)[#](#alternatives "Link to this heading")
