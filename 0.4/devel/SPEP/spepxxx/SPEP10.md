# SEP10: Docstring consistency[#](#sep10-docstring-consistency "Link to this heading")

> **Template**
> Template for further usage, template belong to matplotlib MEPs.

## [Status](#id2)[#](#status "Link to this heading")

****Progress****

This is still an on-going effort

## [Branches and Pull requests](#id3)[#](#branches-and-pull-requests "Link to this heading")

## [Abstract](#id4)[#](#abstract "Link to this heading")
...
## [Detailed description](#id5)[#](#detailed-description "Link to this heading")
...
### [Numpy docstring format](#id6)[#](#numpy-docstring-format "Link to this heading")

[Numpy docstring format](https://github.com/numpy/numpy/blob/master/doc/HOWTO_DOCUMENT.rst.txt):
...
### [Cross references](#id7)[#](#cross-references "Link to this heading")
...
0.4, there is a “default\_role” that can be set to “obj”, which will
...
### [Overriding signatures](#id8)[#](#overriding-signatures "Link to this heading")
...
### [Linking rather than duplicating](#id9)[#](#linking-rather-than-duplicating "Link to this heading")
...
### [autosummary extension](#id10)[#](#autosummary-extension "Link to this heading")
...
### [Examples linking to relevant documentation](#id11)[#](#examples-linking-to-relevant-documentation "Link to this heading")
...
### [Documentation using help() vs. a browser](#id12)[#](#documentation-using-help-vs-a-browser "Link to this heading")
...
## [Implementation](#id13)[#](#implementation "Link to this heading")
...
## [Backward compatibility](#id14)[#](#backward-compatibility "Link to this heading")

As this mainly involves docstrings, there should be minimal impact on
backward compatibility.

## [Alternatives](#id15)[#](#alternatives "Link to this heading")
