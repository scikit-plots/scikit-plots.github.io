# SEP19: Continuous Integration[#](#sep19-continuous-integration "Link to this heading")
...
## Branches and Pull requests[#](#branches-and-pull-requests "Link to this heading")
...
### Current state-of-the-art[#](#current-state-of-the-art "Link to this heading")
...
### Peculiarities of matplotlib[#](#peculiarities-of-matplotlib "Link to this heading")
...
1. Testing all pull requests by hooking into the GitHub API, as
   Travis-CI does
2. Testing on all major platforms: Linux, Mac OS-X, MS Windows (in
   that order of priority, based on user survey)
3. Retain the last n days worth of build and test products, to aid in
   post-mortem debugging.
4. Automated nightly binary builds, so that users can test the
...
8. Make it easy to test a large but sparse matrix of different
...
9. Nice to have: A decentralized design so that those with more
...
## Hangout Notes[#](#hangout-notes "Link to this heading")

### CI Infrastructure[#](#ci-infrastructure "Link to this heading")
...
### The test framework itself[#](#the-test-framework-itself "Link to this heading")
