# SEP15: Fix axis autoscaling when limits are specified for one axis only[#](#sep15-fix-axis-autoscaling-when-limits-are-specified-for-one-axis-only "Link to this heading")
