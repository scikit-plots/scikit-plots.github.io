# Bug Triaging and Issue Curation Guidelines[#](#bug-triaging-and-issue-curation-guidelines "Link to this heading")
...
resolved. Guidelines on writing a good issue can be found in [here](https://matplotlib.org/devdocs/devel/index.html#submitting-a-bug-report "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)"). The recommendations in this page are adapted from
the [scikit learn](https://scikit-learn.org/stable/developers/bug_triaging.html)
and [Pandas](https://pandas.pydata.org/docs/development/maintaining.html)
contributing guides.

## Improve issue reports[#](#improve-issue-reports "Link to this heading")
...
to change milestones, add labels, or close issue](https://docs.github.com/en/organizations/managing-access-to-your-organizations-repositories/repository-permission-levels-for-an-organization).
...
following article](http://gael-varoquaux.info/programming/technical-discussions-are-hard-a-few-tips.html)
explores how to lead online discussions in the context of open source.

### Maintainers and triage team members[#](#maintainers-and-triage-team-members "Link to this heading")
...
* Triage issues:
  ...
  * ****close usage questions**** and politely point the reporter to use
    [discourse](https://discourse.matplotlib.org) or Stack Overflow
...
## Preparing PRs for review[#](#preparing-prs-for-review "Link to this heading")

Reviewing code is also encouraged. Contributors and users are welcome to
participate to the review process following our [review guidelines](guide_pr.html#pr-guidelines).

## Triage workflow[#](#triage-workflow "Link to this heading")
...
4. Is the issue minimal and reproducible?
   ...
   reproducible example. See [this useful post](https://matthewrocklin.com/blog/work/2018/02/28/minimal-bug-reports)
...
5. Is this a regression?
   ...
   last worked in) or by using [git bisect](https://git-scm.com/docs/git-bisect) to find the first commit
   where it was broken.
...
7. Make sure that the title accurately reflects the issue. If you have the
   necessary permissions edit it yourself if it’s not clear.
8. Add the relevant labels, such as “Documentation” when the issue is
...
## Triage team[#](#triage-team "Link to this heading")
...
the triage team by emailing [matplotlib-steering-council@numfocus.org](mailto:matplotlib-steering-council%40numfocus.org) .