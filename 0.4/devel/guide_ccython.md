# C or Cython Extensions Guidelines[#](#c-or-cython-extensions-guidelines "Link to this heading")
...
by [extension-helpers](https://extension-helpers.readthedocs.io/) and
...
## Using Numpy C headers[#](#using-numpy-c-headers "Link to this heading")
...
## Installing C header files[#](#installing-c-header-files "Link to this heading")
...
## Preventing importing at build time[#](#preventing-importing-at-build-time "Link to this heading")
...
## Speed up your builds with ccache[#](#speed-up-your-builds-with-ccache "Link to this heading")

[ccache](https://en.wikipedia.org/wiki/Ccache) is a tool that caches
