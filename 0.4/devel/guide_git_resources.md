...
First fork Astropy into your account, as from [Create a fork of pandas](https://pandas.pydata.org/docs/dev/development/contributing.html#contributing-forking "(in pandas)").
