...
>
> See the example [Line plot](https://matplotlib.org/devdocs/gallery/lines_bars_and_markers/simple_plot.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)")
...
[Writing mathematical expressions](https://matplotlib.org/devdocs/users/explain/text/mathtext.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)") tutorial.)
...
[matplotlib.sphinxext.plot\_directive](https://matplotlib.org/devdocs/api/sphinxext_plot_directive_api.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)"). A short example is:
...
For instance the example [Line plot](https://matplotlib.org/devdocs/gallery/lines_bars_and_markers/simple_plot.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)")
...
render as comments in [Line plot](https://matplotlib.org/devdocs/gallery/lines_bars_and_markers/simple_plot.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)").
...
The order of the sections of the [Tutorials](https://matplotlib.org/devdocs/tutorials/index.html#tutorials "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)") and the [Examples](https://matplotlib.org/devdocs/gallery/index.html#gallery "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)"), as
...
[Identify whether artists intersect](https://matplotlib.org/devdocs/gallery/misc/bbox_intersect.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)") demonstrates the point of visual examples.
...
[Interactive adjustment of colormap range](https://matplotlib.org/devdocs/gallery/images_contours_and_fields/colormap_interactive_adjustment.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)") is an
...
[Lines with a ticked patheffect](https://matplotlib.org/devdocs/gallery/lines_bars_and_markers/lines_with_ticks_demo.html "(in Matplotlib v3.11.0.dev2286+ge6cab33bb)") is an example of having a
