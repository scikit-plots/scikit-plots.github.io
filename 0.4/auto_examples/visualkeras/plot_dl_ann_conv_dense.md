> **Note**
> [Go to the end](#sphx-glr-download-auto-examples-visualkeras-plot-dl-ann-conv-dense-py)
to download the full example code or to run this example in your browser via JupyterLite or Binder.

# Visualkeras: Spam Classification Conv1D Dense Example[#](#visualkeras-spam-classification-conv1d-dense-example "Link to this heading")

An example showing Spam the [`visualkeras`](../../apis/scikitplot.visualkeras.html#module-scikitplot.visualkeras "scikitplot.visualkeras") function
...
```
![plot dl ann conv dense](../../_images/sphx_glr_plot_dl_ann_conv_dense_001.png)
```
<matplotlib.image.AxesImage object at 0x7cdb1f115a50>
...
```
![plot dl ann conv dense](../../_images/sphx_glr_plot_dl_ann_conv_dense_002.png)
```
<matplotlib.image.AxesImage object at 0x7cdb1f15a850>
...
```
![plot dl ann conv dense](../../_images/sphx_glr_plot_dl_ann_conv_dense_003.png)
```
[INFO] Saving path to: /home/circleci/repo/galleries/examples/visualkeras/result_images/spam_conv_z_20260412_091722Z.png

<matplotlib.image.AxesImage object at 0x7cdb1f1ca850>
...
****Total running time of the script:**** (0 minutes 4.894 seconds)

[![Launch binder](../../_images/binder_badge_logo18.svg)](https://mybinder.org/v2/gh/scikit-plots/scikit-plots/maintenance/0.4.X?urlpath=lab/tree/notebooks/auto_examples/visualkeras/plot_dl_ann_conv_dense.ipynb)[![Launch JupyterLite](../../_images/jupyterlite_badge_logo18.svg)](../../lite/lab/index.html?path=auto_examples/visualkeras/plot_dl_ann_conv_dense.ipynb)

[`Download Jupyter notebook: plot_dl_ann_conv_dense.ipynb`](../../_downloads/ea138cb1789c8386df7cc590b3f1de1d/plot_dl_ann_conv_dense.ipynb)

[`Download Python source code: plot_dl_ann_conv_dense.py`](../../_downloads/8d9a7ee5c60fe36b3c65321438f89d7a/plot_dl_ann_conv_dense.py)

[`Download zipped: plot_dl_ann_conv_dense.zip`](../../_downloads/a02deea991dfb31fa7b6ec92eabe6050/plot_dl_ann_conv_dense.zip)
...
visualkeras: autoencoder example![](../../_images/sphx_glr_plot_dl_cnn_vgg_thumb.png)
