...
```
```
<PIL.ImageFont.FreeTypeFont object at 0x7f532c745490>
...
```
<matplotlib.image.AxesImage object at 0x7f530c2721d0>
...
```
<matplotlib.image.AxesImage object at 0x7f530c2a7690>
...
```
<matplotlib.image.AxesImage object at 0x7f530c10e410>
...
```
<matplotlib.image.AxesImage object at 0x7f530c176410>
...
```
<matplotlib.image.AxesImage object at 0x7f530c1fd190>
...
```
<matplotlib.image.AxesImage object at 0x7f530c068190>
...
```
<matplotlib.image.AxesImage object at 0x7f530c0dc310>
...
****Total running time of the script:**** (0 minutes 13.901 seconds)

[![Launch binder](../../_images/binder_badge_logo18.svg)](https://mybinder.org/v2/gh/scikit-plots/scikit-plots/maintenance/0.4.X?urlpath=lab/tree/notebooks/auto_examples/visualkeras/plot_dl_cnn_custom_vgg16_show_dimension.ipynb)[![Launch JupyterLite](../../_images/jupyterlite_badge_logo18.svg)](../../lite/lab/index.html?path=auto_examples/visualkeras/plot_dl_cnn_custom_vgg16_show_dimension.ipynb)
