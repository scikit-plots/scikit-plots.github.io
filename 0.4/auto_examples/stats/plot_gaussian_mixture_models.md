> **Note**
> [Go to the end](#sphx-glr-download-auto-examples-stats-plot-gaussian-mixture-models-py)
to download the full example code or to run this example in your browser via JupyterLite or Binder.

# Gaussian Mixture Models — AIC, AICc, and BIC Model Selection[#](#gaussian-mixture-models-aic-aicc-and-bic-model-selection "Link to this heading")

## What is a Gaussian Mixture Model?[#](#what-is-a-gaussian-mixture-model "Link to this heading")
...
## The trouble with just maximising log-likelihood[#](#the-trouble-with-just-maximising-log-likelihood "Link to this heading")
...
## The three criteria[#](#the-three-criteria "Link to this heading")
...
We generate a 2-D dataset from K\_true = 5 known Gaussian blobs. Having
...
### Section 1 — Imports[#](#section-1-imports "Link to this heading")
...
### Section 2 — Utility functions[#](#section-2-utility-functions "Link to this heading")
...
### Section 3 — Generate synthetic 2-D data[#](#section-3-generate-synthetic-2-d-data "Link to this heading")

Five blobs with deliberately different spreads (cluster\_std). Varying
the spreads makes the problem slightly harder and more realistic than
equal-variance blobs.

K\_TRUE is used only for validation at the end. The GMM fitting loop
...
### Section 4 — Fit GMMs for K = 1 … 13; collect AIC, AICc, BIC[#](#section-4-fit-gmms-for-k-1-13-collect-aic-aicc-bic "Link to this heading")

We fit all models upfront so Sections 5–10 are just reads — no recomputation.
max\_iter=300 is generous for a 2-D problem; lower values are fine too.
...
### Section 5 — Pick the best model (minimum BIC)[#](#section-5-pick-the-best-model-minimum-bic "Link to this heading")
...
### Section 6 — Build observed density (histogram) and GMM density grid[#](#section-6-build-observed-density-histogram-and-gmm-density-grid "Link to this heading")
...
### Section 7 — Plot: raw observed density (what the data look like)[#](#section-7-plot-raw-observed-density-what-the-data-look-like "Link to this heading")
...
```
![plot gaussian mixture models](../../_images/sphx_glr_plot_gaussian_mixture_models_001.png)

### Section 8 — Plot: AIC, AICc, and BIC curves[#](#section-8-plot-aic-aicc-and-bic-curves "Link to this heading")
...
```
![AIC / AICc / BIC — which K fits best without overfitting? Each dashed vertical line marks that criterion's minimum.](../../_images/sphx_glr_plot_gaussian_mixture_models_002.png)

### Section 9 — Plot: best-fit GMM density + component ellipses[#](#section-9-plot-best-fit-gmm-density-component-ellipses "Link to this heading")
...
```
![plot gaussian mixture models](../../_images/sphx_glr_plot_gaussian_mixture_models_003.png)

### Section 10 — Side-by-side: observed density vs. recovered density[#](#section-10-side-by-side-observed-density-vs-recovered-density "Link to this heading")
...
```
![Observed data (left) vs. GMM recovery (right) K_true = 5,  BIC-selected K = 5](../../_images/sphx_glr_plot_gaussian_mixture_models_004.png)
...
[![Launch binder](../../_images/binder_badge_logo17.svg)](https://mybinder.org/v2/gh/scikit-plots/scikit-plots/maintenance/0.4.X?urlpath=lab/tree/notebooks/auto_examples/stats/plot_gaussian_mixture_models.ipynb)[![Launch JupyterLite](../../_images/jupyterlite_badge_logo17.svg)](../../lite/lab/index.html?path=auto_examples/stats/plot_gaussian_mixture_models.ipynb)

[`Download Jupyter notebook: plot_gaussian_mixture_models.ipynb`](../../_downloads/45b8334103b88d9f720f54e424f7a464/plot_gaussian_mixture_models.ipynb)

[`Download Python source code: plot_gaussian_mixture_models.py`](../../_downloads/1369c5097ec4dcf0ecfa914bcab550b7/plot_gaussian_mixture_models.py)

[`Download zipped: plot_gaussian_mixture_models.zip`](../../_downloads/6c363c9faaf83ac453430a747e8cadab/plot_gaussian_mixture_models.zip)
