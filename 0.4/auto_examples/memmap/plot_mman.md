> **Note**
> [Go to the end](#sphx-glr-download-auto-examples-memmap-plot-mman-py)
to download the full example code or to run this example in your browser via JupyterLite or Binder.

# Memory-Mapping Showcase – Basic / Medium / Advanced[#](#memory-mapping-showcase-basic-medium-advanced "Link to this heading")

This gallery example demonstrates the
[`MemoryMap`](../../modules/generated/scikitplot.memmap.MemoryMap.html#scikitplot.memmap.MemoryMap "scikitplot.memmap.MemoryMap") module at
...
#### BASIC – anonymous mapping: write / read / verify[#](#basic-anonymous-mapping-write-read-verify "Link to this heading")
...
#### MEDIUM – file-backed mapping: write, sync, read back, visualise[#](#medium-file-backed-mapping-write-sync-read-back-visualise "Link to this heading")
...
```
![File-backed mmap – written records, Raw byte layout (hex value = colour)](../../_images/sphx_glr_plot_mman_001.png)
```
...
#### ADVANCED – zero-copy NumPy, mprotect lifecycle, micro-benchmark[#](#advanced-zero-copy-numpy-mprotect-lifecycle-micro-benchmark "Link to this heading")
...
```
![Copy benchmark – 200 x 1 MB, Effective copy throughput](../../_images/sphx_glr_plot_mman_002.png)
```
...
[ADVANCED] 200 iterations over 1.0 MB:
           .read()     : 0.0834 s  (2.52 GB/s)
           arr.copy()  : 0.0358 s  (5.85 GB/s)
[ADVANCED] done.
...
[![Launch binder](../../_images/binder_badge_logo9.svg)](https://mybinder.org/v2/gh/scikit-plots/scikit-plots/maintenance/0.4.X?urlpath=lab/tree/notebooks/auto_examples/memmap/plot_mman.ipynb)[![Launch JupyterLite](../../_images/jupyterlite_badge_logo9.svg)](../../lite/lab/index.html?path=auto_examples/memmap/plot_mman.ipynb)

[`Download Jupyter notebook: plot_mman.ipynb`](../../_downloads/854848fb4d4b8e74b94d2d71304d9827/plot_mman.ipynb)

[`Download Python source code: plot_mman.py`](../../_downloads/2385613e558a3078d872d4badbcc372d/plot_mman.py)

[`Download zipped: plot_mman.zip`](../../_downloads/4ff99f121ee4a595eacc7f3cbe262297/plot_mman.zip)
...
Enhanced KISS Random Generator - Complete Usage Examples![](../../_images/sphx_glr_plot_gaussian_mixture_models_thumb.png)

[Gaussian Mixture Models — AIC, AICc, and BIC Model Selection](../stats/plot_gaussian_mixture_models.html)

Gaussian Mixture Models — AIC, AICc, and BIC Model Selection![](../../_images/sphx_glr_plot_09_workflow_templates_cli_thumb.png)

[Workflow templates (train / hpo / predict) + CLI entry template](../cython/plot_09_workflow_templates_cli.html)

Workflow templates (train / hpo / predict) + CLI entry template![](../../_images/sphx_glr_plot_mmap_script_thumb.png)
