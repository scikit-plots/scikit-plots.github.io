...
scikitplot.corpus.extract\_archive(**archive\_path**, **dest\_dir**, **\***, **supported\_extensions=None**, **max\_files=10000**, **max\_total\_bytes=2147483648**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_archive_handler.py#L156)[#](#scikitplot.corpus.extract_archive "Link to this definition")
:   Extract an archive to a destination directory.
    ...
    ****ZipSlip prevention:**** Every extracted member’s resolved path is
    verified to fall within **dest\_dir**. Members with path-traversal
