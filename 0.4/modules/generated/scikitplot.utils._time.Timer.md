...
class scikitplot.utils.\_time.Timer(**message=''**, **\***, **precision=3**, **logging\_level='info'**, **verbose=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/utils/_time.py#L16)[#](#scikitplot.utils._time.Timer "Link to this definition")
