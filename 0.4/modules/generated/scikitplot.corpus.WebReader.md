...
class scikitplot.corpus.WebReader(**input\_file**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_uri=None**, **source\_provenance=<factory>**, **custom\_extractor=None**, **custom\_extractor\_kwargs=<factory>**, **timeout=30**, **max\_response\_bytes=10485760**, **headers=None**, **extract\_tags=None**, **allow\_private\_networks=False**, **max\_content\_bytes=50000000**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_readers/_web.py#L248)[#](#scikitplot.corpus.WebReader "Link to this definition")
:   Fetch a web page and extract structured text via BeautifulSoup.
    ...
    :   ****input\_file****pathlib.Path
        ...
        ****max\_response\_bytes****int, optional
        ...
        ****extract\_tags****list of str or None, optional
    ...
    :   * ****input\_file**** ([**Path**](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)"))
        ...
        * ****max\_response\_bytes**** ([**int**](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)"))
        * ****headers**** ([**dict**](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")**[**[**str**](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")**,** [**str**](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")**]** **|** **None**)
        * ****extract\_tags**** ([**list**](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")**[**[**str**](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")**]** **|** **None**)
        * ****allow\_private\_networks**** ([**bool**](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)"))
        * ****max\_content\_bytes**** ([**int**](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)"))

    > **See also**
    > `scikitplot.corpus._readers.YouTubeReader`
    ...
    ****JavaScript-rendered pages:**** `requests` fetches only the initial
    ...
    allow\_private\_networks: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.14)") = False[#](#scikitplot.corpus.WebReader.allow_private_networks "Link to this definition")
    :   If False, reject private/loopback/link-local IP addresses.

    chunker: [ChunkerBase](scikitplot.corpus.ChunkerBase.html#scikitplot.corpus.ChunkerBase "scikitplot.corpus._base.ChunkerBase") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.WebReader.chunker "Link to this definition")
    :   Chunker to apply to each raw text block. `None` means each raw chunk
        is used as-is (one CorpusDocument per raw chunk).

    classmethod create(**\*inputs**, **chunker=None**, **filter\_=None**, **filename\_override=None**, **default\_language=None**, **source\_type=None**, **source\_title=None**, **source\_author=None**, **source\_date=None**, **collection\_id=None**, **doi=None**, **isbn=None**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_base.py#L1239)[#](#scikitplot.corpus.WebReader.create "Link to this definition")
    :   Instantiate the appropriate reader for one or more sources.
        ...
        detected and routed to [`from_url`](#scikitplot.corpus.WebReader.from_url "scikitplot.corpus.WebReader.from_url"); everything else is treated
        ...
        :   ****\*inputs****pathlib.Path or str
            :   One or more source paths or URL strings. Each element is
                ...
                * `str` matching `^https?://` (case-insensitive) — treated
                  as a URL and routed to [`from_url`](#scikitplot.corpus.WebReader.from_url "scikitplot.corpus.WebReader.from_url"). ****Must be passed as
        ...
        ****URL auto-detection:**** A `str` element is treated as a URL when
        ...
        paths. This means you no longer need to call [`from_url`](#scikitplot.corpus.WebReader.from_url "scikitplot.corpus.WebReader.from_url")
        explicitly — just pass the URL string to [`create`](#scikitplot.corpus.WebReader.create "scikitplot.corpus.WebReader.create").
    ...
    custom\_extractor: [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.WebReader.custom_extractor "Link to this definition")
    :   User-supplied extraction callable that ****replaces**** [`get_raw_chunks`](#scikitplot.corpus.WebReader.get_raw_chunks "scikitplot.corpus.WebReader.get_raw_chunks")
        ...
        The built-in [`get_raw_chunks`](#scikitplot.corpus.WebReader.get_raw_chunks "scikitplot.corpus.WebReader.get_raw_chunks") implementation is ****not**** called.
    ...
    custom\_extractor\_kwargs: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)")][[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_readers/_web.py#L248)[#](#scikitplot.corpus.WebReader.custom_extractor_kwargs "Link to this definition")
    ...
    default\_language: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.WebReader.default_language "Link to this definition")
    :   ISO 639-1 language code to assign when the source has no language info.

    extract\_tags: [list](https://docs.python.org/3/library/stdtypes.html#list "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")] | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.WebReader.extract_tags "Link to this definition")
    :   HTML tags to extract. `None` uses the built-in defaults.

    property file\_name: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")[#](#scikitplot.corpus.WebReader.file_name "Link to this definition")
    :   Return the URL as the effective file name.

    file\_type: [ClassVar](https://docs.python.org/3/library/typing.html#typing.ClassVar "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)")] = ':url'[#](#scikitplot.corpus.WebReader.file_type "Link to this definition")
    ...
    filename\_override: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.WebReader.filename_override "Link to this definition")
    ...
    classmethod from\_manifest(**manifest\_path**, **\***, **chunker=None**, **filter\_=None**, **default\_language=None**, **source\_type=None**, **source\_title=None**, **source\_author=None**, **source\_date=None**, **collection\_id=None**, **doi=None**, **isbn=None**, **encoding='utf-8'**, **\*\*kwargs**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_base.py#L1556)[#](#scikitplot.corpus.WebReader.from_manifest "Link to this definition")
    ...
    :   Instantiate the appropriate reader for a URL source.
        ...
        ****Prefer :meth:`create` for new code.**** Passing a URL string to
        [`create`](#scikitplot.corpus.WebReader.create "scikitplot.corpus.WebReader.create") automatically calls [`from_url`](#scikitplot.corpus.WebReader.from_url "scikitplot.corpus.WebReader.from_url") — you rarely
        need to call [`from_url`](#scikitplot.corpus.WebReader.from_url "scikitplot.corpus.WebReader.from_url") directly.
    ...
    get\_documents()[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_base.py#L940)[#](#scikitplot.corpus.WebReader.get_documents "Link to this definition")
    :   Yield validated [`CorpusDocument`](scikitplot.corpus.CorpusDocument.html#scikitplot.corpus.CorpusDocument "scikitplot.corpus._schema.CorpusDocument")
        ...
        1. [`validate_input`](#scikitplot.corpus.WebReader.validate_input "scikitplot.corpus.WebReader.validate_input") — fail fast if file is missing.
        2. [`get_raw_chunks`](#scikitplot.corpus.WebReader.get_raw_chunks "scikitplot.corpus.WebReader.get_raw_chunks") — format-specific text extraction.
    ...
    get\_raw\_chunks()[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_readers/_web.py#L435)[#](#scikitplot.corpus.WebReader.get_raw_chunks "Link to this definition")
    :   Fetch the URL and yield one chunk per HTML text element.
        ...
        :   dict
            :   Keys:
                ...
                `"section_type"`
                :   [`SectionType.TITLE`](scikitplot.corpus.SectionType.html#scikitplot.corpus.SectionType.TITLE "scikitplot.corpus.SectionType.TITLE"), [`SectionType.HEADER`](scikitplot.corpus.SectionType.html#scikitplot.corpus.SectionType.HEADER "scikitplot.corpus.SectionType.HEADER"),
                    or [`SectionType.TEXT`](scikitplot.corpus.SectionType.html#scikitplot.corpus.SectionType.TEXT "scikitplot.corpus.SectionType.TEXT").

                `"source_type"`
                :   Always [`SourceType.WEB`](scikitplot.corpus.SourceType.html#scikitplot.corpus.SourceType.WEB "scikitplot.corpus.SourceType.WEB"); promoted to
                ...
                `"url"`
                :   Source URL; promoted to [`CorpusDocument.url`](scikitplot.corpus.CorpusDocument.html#scikitplot.corpus.CorpusDocument.url "scikitplot.corpus.CorpusDocument.url").
    ...
    input\_file: [Path](https://docs.python.org/3/library/pathlib.html#pathlib.Path "(in Python v3.14)")[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_readers/_web.py#L248)[#](#scikitplot.corpus.WebReader.input_file "Link to this definition")
    ...
    max\_content\_bytes: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") = 50000000[#](#scikitplot.corpus.WebReader.max_content_bytes "Link to this definition")
    :   Maximum content size in bytes.

    max\_response\_bytes: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.14)") = 10485760[#](#scikitplot.corpus.WebReader.max_response_bytes "Link to this definition")
    :   10 MB.

        Type:
        :   Maximum response body size. Default

    source\_provenance: [dict](https://docs.python.org/3/library/stdtypes.html#dict "(in Python v3.14)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)"), [Any](https://docs.python.org/3/library/typing.html#typing.Any "(in Python v3.14)")][[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_readers/_web.py#L248)[#](#scikitplot.corpus.WebReader.source_provenance "Link to this definition")
    :   Provenance overrides propagated into every yielded `CorpusDocument`.
        ...
        Populated by [`create`](#scikitplot.corpus.WebReader.create "scikitplot.corpus.WebReader.create") / [`from_url`](#scikitplot.corpus.WebReader.from_url "scikitplot.corpus.WebReader.from_url") from their keyword
        arguments.

    source\_uri: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.14)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.14)") = None[#](#scikitplot.corpus.WebReader.source_uri "Link to this definition")
    ...
    classmethod subclass\_by\_type()[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_base.py#L1128)[#](#scikitplot.corpus.WebReader.subclass_by_type "Link to this definition")
    ...
    classmethod supported\_types()[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_base.py#L1110)[#](#scikitplot.corpus.WebReader.supported_types "Link to this definition")
    ...
    validate\_input()[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_readers/_web.py#L386)[#](#scikitplot.corpus.WebReader.validate_input "Link to this definition")
