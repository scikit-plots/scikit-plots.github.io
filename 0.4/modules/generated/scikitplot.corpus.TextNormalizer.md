...
class scikitplot.corpus.TextNormalizer(**config=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_normalizers/_text_normalizer.py#L296)[#](#scikitplot.corpus.TextNormalizer "Link to this definition")
:   Pipeline component that populates `normalized_text` on
    ...
    ****Developer note:**** This class is stateless and thread-safe.
    ...
    normalize(**text**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_normalizers/_text_normalizer.py#L343)[#](#scikitplot.corpus.TextNormalizer.normalize "Link to this definition")
    ...
    normalize\_documents(**documents**, **\***, **overwrite=False**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_normalizers/_text_normalizer.py#L406)[#](#scikitplot.corpus.TextNormalizer.normalize_documents "Link to this definition")
