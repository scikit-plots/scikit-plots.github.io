...
scikitplot.corpus.create\_corpus(**input\_file**, **output\_path**, **\***, **chunker=None**, **filter\_=None**, **normalizer=None**, **enricher=None**, **filename\_override=None**, **export\_format=ExportFormat.CSV**, **default\_language=None**)[[source]](https://github.com/scikit-plots/scikit-plots/blob/64b40d9/scikitplot/corpus/_pipeline.py#L1052)[#](#scikitplot.corpus.create_corpus "Link to this definition")
